(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 596889, e => {
    ...
    e.s(["default", 0, ({
        ...
        let L, R = -1 !== (L = window.navigator.userAgent).indexOf("Win") ? "Windows" : -1 !== L.indexOf("Mac") ? "Mac" : -1 !== L.indexOf("Linux") ? "Linux" : "Unknown",
            ...
            S = {
                ..._,
                locale: (0, v.default)(A)
            },
            {
                mapFormActions: T
            } = (0, x.useFormModal)(s),
            C = (0, l.useMemo)(() => T(s) || [], [s, T]),
            $ = n?.asset?.url ? {
                src: n.asset.url,
        ...
        let P = c ?? void 0,
            ...
            B = s?.filter(e => !e.operatingSystem || e.operatingSystem === R) || [],
    ...
    e.s(["useMTBanner", 0, function(e, r = []) {
        ...
        return {
            ...
            updatedBlocks: (s = e.blocks ?? [], i = e.machineTranslationDisclaimer, n = s.reduce((e, t, l) => ["hero", "alternateNavigation", "headliner"].includes(t._type) ? l : e, -1), d = [...s], c = d[n + 1]?._type === "alternateNavigationAnchor" || d[n + 1]?._type === "anchorButton" ? d[n + 2] : d[n + 1], o = c?.theme ?? null, u = {
                _type: "alert",
                text: i?.text,
                isContained: !0,
                spacing: {
    ...
    e.s(["hasReducedMotionListener", 0, a, "prefersReducedMotion", 0, l], 309674), e.s(["initPrefersReducedMotion", 0, function() {
    ...
    let m = (0, l.forwardRef)(function({
        ...
        let w = (0, o.useObjectRef)(k),
            ...
            $ = (0, r.clsx)(T, "fill-black dark:fill-white");
        if (g) {
            let e = (0, c.mergeProps)(R, M, A);
    ...
    let b = (0, r.forwardRef)(({
            ...
            let c = (0, s.default)("alternateNavigation relative flex h-12 w-full bg-gray-900", {
                "justify-center": "centered" === i,
                "justify-stretch": "default" === i
            });
            return (0, t.jsx)("div", {
                className: c,
                ref: d,
    ...
    let w = ({
        ...
        let i = (0, f.default)(`(max-width: ${m.default.Large}px)`),
            n = (0, r.useRef)(null),
            ...
            L = () => {
                let e;
                n.current && (n.current.offsetTop < window.scrollY ? j(!0) : j(!1)), w.current > window.scrollY && g ? x(!0) : w.current < window.scrollY && x(!1), w.current = window.scrollY, n.current && (n.current.offsetTop > window.innerHeight && !h ? k(!0) : k(!1)), e = null, o.forEach((t, l) => {
        ...
        }, [y]), (0, r.useLayoutEffect)(() => (N(), window.addEventListener("resize", N), () => {
            window.removeEventListener("resize", N)
        }), []), (0, r.useEffect)(() => (w.current = window.scrollY, window.addEventListener("scroll", L), () => {
            window.removeEventListener("scroll", L)
        }), [h, o, i]), (0, t.jsx)(p.default, {
                ...
                children: (0, t.jsx)("div", {
                    ...
                    children: (0, t.jsxs)("div", {
                        ...
                        children: [r && (0, t.jsx)("div", {
                            ...
                            children: [s.image && s.image.src && (0, t.jsx)("div", {
                                ...
                                children: [s.name && (0, t.jsx)("span", {
                                    className: "loco-text-body-md mt-2 block",
                                    children: s.name
                                }), s.title && (0, t.jsx)("span", {
    ...
    e.s(["default", 0, ({
        ...
        let i = (0, l.useMemo)(() => e?.map(e => e.value?.text ? {
            value: {
                type: "text",
                text: e.value.text
            },
    ...
    let m = {
        types: {
            imageWithAlt: ({
                ...
                return l?.url && a?.width && a?.height ? (0, t.jsx)(r.default, {
                    alt: e?.alt || "",
                    src: l.url,
                    width: a.width,
                    height: a.height,
    ...
    e.s(["default", 0, ({
        ...
        let [f] = (0, l.useContext)(o.FiltersContext), {
            ...
            _id: e
        }) => e === f.selectedSubcategory) : null, g = !c || c.categories?.find(e => e._id === f.selectedCategory) != null && (null == x || !c.subcategories || c.subcategories.some(({
            _id: e
    ...
    let k = (0, s.default)(() => e.A(410979), {
        ...
        N = ({
            ...
            let [i, c] = (0, n.useState)(void 0), [o, u] = (0, n.useState)(void 0), [m, f] = (0, n.useState)(1), [h, g] = (0, n.useState)(0), [p, b] = (0, n.useState)(0), v = (0, n.useRef)(null), k = (0, n.useRef)(null), N = (0, n.useRef)(null), L = (0, r.useReducedMotion)();
            (0, n.useEffect)(() => {
            ...
            let R = (0, n.useCallback)((e, t) => {
                ...
                T = (0, n.useMemo)(() => a.map((e, l) => (0, t.jsx)("div", {
                    children: (0, t.jsxs)("div", {
                        className: "max-w-lg",
                        children: [(0, t.jsx)("h3", {
                            className: "loco-text-heading-xs",
                ...
                C = (0, n.useMemo)(() => a.map((e, l) => (0, t.jsx)(w, {
                    slide: e,
                    index: l,
                    isActive: h === l,
    ...
    let p = ({
            ...
            let M = (0, h.default)(`(min-width: ${u.default.Medium}px)`),
                _ = (0, n.useRef)(null),
                [A, S] = (0, n.useState)(!1),
                T = (0, l.useInView)(_),
                C = (0, a.useReducedMotion)(),
                $ = null;
            "youtube" === g ? $ = (0, c.default)(() => e.A(269100), {
                loadableGenerated: {
                    modules: [346003]
                },
                ssr: !1
            }) : "brandfolder" === g && ($ = (0, c.default)(() => e.A(410979), {
                loadableGenerated: {
                    modules: [942019]
                },
                ssr: !1
            ...
            }), E = (0, s.useTransform)(P, [0, 1], ["60%", "100%"]), O = (0, s.useTransform)(P, [0, 1], [1.75, 1]), B = (0, s.useTransform)(P, [0, 1], ["brightness(50%)", "brightness(100%)"]), I = () => {
                k && "brandfolder" === g && S(!0)
            }, U = () => {
                S(!0)
            }, z = (0, d.default)("top-0 left-0 h-full w-full absolute z-10 transition-opacity duration-500 object-cover", {
                "opacity-0 pointer-events-none": A && !C && T && y?.src
            });
            return (0, t.jsxs)("div", {
                ref: _,
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "64455605-d579-58f0-941f-b7414ca08b03")
    } catch (e) {}
}();
//# debugId=64455605-d579-58f0-941f-b7414ca08b03