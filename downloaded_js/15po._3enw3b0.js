(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 824627, t => {
    ...
    let l = ({
        ...
        let o = (0, i.default)("loco-caption-lg-semibold mb-4", n);
        return (0, e.jsx)(r, {
            className: o,
            children: t
        })
    ...
    let c = ({
        ...
        let o = (0, i.default)("flex gap-2 flex-wrap", {
            "flex-col items-start": "vertical" === n
        }, r);
        return (0, e.jsx)("div", {
            className: o,
            children: t
    ...
    let p = ({
        ...
        let [n, o] = (0, r.useState)(0), a = (0, r.useRef)(null), l = (0, r.useRef)(null), [c, u] = (0, r.useState)(!1), [f, p] = (0, r.useState)(!1), g = (0, r.useRef)(null);
        (0, r.useEffect)(() => {
            t.forEach(t => {
        ...
        }, []), (0, r.useEffect)(() => (a.current && clearTimeout(a.current), c && !f && (a.current = setTimeout(() => {
            o(e => (e + 1) % t.length)
        }, i)), () => {
            ...
            children: (0, e.jsx)("div", {
                ...
                children: t.map((t, r) => {
                    ...
                    return (0, e.jsxs)("div", {
                        ...
                        onClick: () => m(r),
                        onKeyDown: t => y(t, r),
                        children: [t.icon && i && (0, e.jsx)(d.m.div, {
                            initial: {
                                opacity: 0,
                                scale: .8
                            },
    ...
    t.s(["default", 0, ({
        ...
        let T = (0, m.default)(`(max-width: ${g.default.Large}px)`),
            L = (0, r.useRef)(null),
            [H, z] = (0, r.useState)(!1),
            B = (0, x.useInView)(L, {
                once: !0
        ...
        let q = () => {
            ...
            G = (0, i.default)("relative", {
                ...
                "lg:py-14": F,
                "lg:py-24": !F && "default" === A && (!d || "16:9" === d) && "gdc2026" !== U,
                "lg:py-80": !F && "large" === A && (!d || "16:9" === d),
                "lg:py-40": !F && "large" === A && "1:1" === d,
            ...
            X = (0, i.default)("relative col-span-12 px-5 text-center lg:pb-0 lg:text-left", {
                ...
                "lg:col-start-8": "left" === k && "gdc2026" !== U && (!d || "16:9" === d),
                "lg:col-start-1": "right" === k && (!d || "16:9" === d),
                "lg:col-start-2": "right" === k && "1:1" === d,
                "order-first": F && T
            }),
            tt = t => {
                ...
                children: [F ? (0, e.jsx)("div", {
                    ...
                    children: [(0, e.jsxs)("div", {
                        ...
                        children: [B && !V && S?.src && (0, e.jsx)(j, {
                            ...
                            children: [S?.src && !C && (0, e.jsx)(w.default, {
                                ...
                                label: E,
                                "data-link-location": P || o.trackingLocation.fullWidthBlockAction,
                                "data-link-id": `${P||o.trackingLocation.fullWidthBlockAction}-video-play`
                            }), (0, e.jsx)(n.default, {
                                src: _.src,
                                alt: _.alt,
                                placeholder: "blur",
                    ...
                    children: [O && (0, e.jsx)(l, {
                        ...
                        children: t.length > 0 && t.map((t, r) => (0, e.jsx)(s.default, {
                            ...
                            target: t.target,
                            "data-link-location": P ?? o.trackingLocation.fullWidthBlockAction,
                            "data-link-id": `${P??o.trackingLocation.fullWidthBlockAction}-action-${r}`,
                            children: t.label
    ...
    t.s(["default", 0, ({
        ...
        let [N] = (0, r.useContext)(o.FiltersContext);
        if (N.categories && N.categories.length > 0 && 1 === N.categories.findIndex(({
                _id: t
            }) => t === N.selectedCategory) && null != N.selectedSubcategory) return null;
        let {
            subcategories: I,
            productCatalogItems: S
        } = N.categories.find(({
            _id: t
        }) => t === N.selectedCategory) || {}, C = null != N.selectedSubcategory ? (I || []).find(({
            _id: t
        }) => t === N.selectedSubcategory) : null, E = !A || A.categories?.find(t => t._id === N.selectedCategory) != null && (null == C || !A.subcategories || A.subcategories.some(({
            _id: t
        }) => t === N.selectedSubcategory)), P = t?.map(({
            title: t,
            link: e
        }) => {
        ...
        return (0, e.jsx)(e.Fragment, {
            children: !O && E && (0, e.jsx)("section", {
                className: "dark" === y ? "dark" : "",
                children: (0, e.jsx)(n.default, {
                    ...
                    eyebrow: u,
                    image: {
                        src: (0, a.urlForImage)(f?.file?.asset?.url || "")?.auto("format")?.url() || "",
                        placeholder: f?.file?.asset.metadata?.lqip || "",
                        alt: f?.alt || "",
                        caption: f?.caption || ""
                    },
                    ...
                    buttonLabel: v,
                    blockKey: j,
                    blockedMessage: _?.blockedMessage,
                    consentButtonLabel: _?.consentButtonLabel || "",
                    featureList: R
                })
            })
        })
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "651e9a2b-f5c9-5df7-bcdf-a38621818efd")
    } catch (e) {}
}();
//# debugId=651e9a2b-f5c9-5df7-bcdf-a38621818efd