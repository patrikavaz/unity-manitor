                ...
                f = ({
                    ...
                    let _ = (0, s.A)("top-0 left-0 h-full w-full absolute z-10 transition-opacity duration-500 object-cover", {
                        ...
                        I = (0, s.A)("rounded-lg bg-gray-100 p-4 dark:bg-gray-900", {
                            "h-full": "horizontal" !== h,
                            "group h-full relative p-[1px] xl:flex-row xl:gap-6 cursor-pointer": "horizontal" === h && S,
                            "h-full relative p-[1px] xl:flex-row xl:gap-6 cursor-auto": "horizontal" === h && !S
                        }),
                        ...
                        M = (0, s.A)("cover absolute object-cover", {
                            "transition-transform duration-400 group-hover:scale-110": "horizontal" === h && S
                        }),
                        R = (0, l.jsxs)("div", {
                            ref: k,
                            className: I,
                            children: ["horizontal" === h && S && (0, l.jsx)("div", {
