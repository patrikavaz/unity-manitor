(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 27666, 870053, 522455, e => {
    ...
    let y = (0, a.createContext)({}),
        v = n(function(e, r) {
            ...
            }), C = (0, h.useId)(l.id), P = (0, h.useId)(), M = l["aria-labelledby"];
            o && (M ? M = `${M} ${P}` : l["aria-label"] && (M = `${C} ${P}`));
            let A = (0, a.useRef)(o);
            (0, a.useEffect)(() => {
                let e = {
                    "aria-labelledby": M || C
    ...
    let i = new Map([
        ...
        s = l.forwardRef((e, t) => l.createElement(o.w, {
            ref: t,
            ...e,
            weights: i
        }));
    ...
    let d = new Map([
        ...
        u = l.forwardRef((e, t) => l.createElement(o.w, {
            ref: t,
            ...e,
            weights: d
        }));
    ...
    let j = (0, l.createContext)(null),
        k = (0, l.forwardRef)(function(e, t) {
            ...
            let a = e.href && !e.isDisabled ? "a" : "span",
                ...
                m = (0, v.filterDOMProps)(e, {
                    global: !0
                });
            return delete m.onClick, l.default.createElement(o, {
                ref: t,
                slot: e.slot || void 0,
                ...(0, x.mergeProps)(m, g, r, i, d),
    ...
    e.s(["Button", 0, function(e) {
        let {
            ...
            className: u,
            ...g
        } = e, m = !d && !!(o ?? l), p = o && !l ? "left" : l && !o ? "right" : "none";
        if (s) return (0, c.jsx)("span", {
            ...g,
            className: r({
                variant: t,
                size: n,
        ...
        let h = e => a({
                ...
                iconOnly: m,
                iconSide: p,
                className: "function" == typeof u ? u(e) : u
            }),
            y = e => {
                let t = e ?? {};
                return f({
                    label: "function" == typeof d ? d(e) : d,
                    iconLeft: o,
                    iconRight: l,
                    animate: !i && !t.isDisabled && !t.isPending
                })
            };
        return "href" in e && e.href ? (0, c.jsx)(k, {
            ...g,
            className: h,
            children: y
        }) : (0, c.jsx)(b.Button, {
    ...
    let a = t.forwardRef((e, a) => {
        ...
        return t.createElement("svg", {
            ...
            ...u
        }, !!r && t.createElement("title", null, r), s, d.get(l))
    });
    a.displayName = "SSRBase", e.s(["w", 0, a])
}, 837826, e => {
    "use strict";
    let t, a, r, n;
    var o, l = /\s+/g,
