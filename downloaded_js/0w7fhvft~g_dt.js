(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 154038, e => {
    ...
    var c = e.i(815965),
        ...
        u = e.i(369710);
    let f = new WeakMap,
        h = (e, t, l) => (a, i) => i && i[0] ? i[0][e + "Size"] : (0, d.isSVGElement)(a) && "getBBox" in a ? a.getBBox()[t] : a[l],
        g = h("inline", "width", "offsetWidth"),
    ...
    function k(e, t, l, a) {
        let i = l[t],
            ...
            s = i.current,
            o = l.time;
        i.current = e[`scroll${n}`], i.scrollLength = e[`scroll${r}`] - e[`client${r}`], i.offset.length = 0, i.offset[0] = 0, i.offset[1] = i.scrollLength, i.progress = (0, b.progress)(0, i.scrollLength, i.current);
        let c = a - o;
        i.velocity = c > 50 ? 0 : (0, A.velocityPerSecond)(i.current - s, c)
    }
    e.i(788727);
    var w = e.i(279126),
        N = e.i(668617),
    ...
    function W(e, {
        ...
        if (!a) return n.noop;
        let r = S.get(a);
        r || (r = new Set, S.set(a, r));
        let o = function(e, t, l, a = {}) {
            return {
                measure: t => {
                    ! function(e, t = e, l) {
                    ...
                    }(e, a.target, l), k(e, "x", l, t), k(e, "y", l, t), l.time = t, (a.offset || a.target) && function(e, t, l) {
                        let {
                            offset: a = M
                        } = l, {
                            target: i = e,
                            ...
                            let l = {
                                ...
                                a = e;
                            for (; a && a !== t;)
                                if ((0, R.isHTMLElement)(a)) l.x += a.offsetLeft, l.y += a.offsetTop, a = a.offsetParent;
                        ...
                        for (let e = 0; e < u; e++) {
                            let l = function(e, t, l, a) {
                                let i = Array.isArray(e) ? e : C,
                                    r = 0;
                                return "number" == typeof e ? i = [e, e] : "string" == typeof e && (i = (e = e.trim()).includes(" ") ? e.split(" ") : [e, E[e] ? e : "0"]), (r = B(i[0], l, a)) - B(i[1], t)
                            }(a[e], c[n], o[n], s[r]);
                            d || l === t[r].interpolatorOffsets[e] || (d = !0), t[r].offset[e] = l
                        }
                        d && (t[r].interpolate = (0, w.interpolate)(t[r].offset, (0, N.defaultOffset)(a), {
                            clamp: !1
                        }), t[r].interpolatorOffsets = [...t[r].offset]), t[r].progress = (0, L.clamp)(0, 1, t[r].interpolate(t[r].current))
                    }(e, l, a)
                },
                notify: () => t(l)
            }
        ...
        if (r.add(o), !Q.has(a)) {
            let e, i = () => {
                    for (let e of r) e.measure(s.frameData.timestamp);
                    s.frame.preUpdate(n)
                },
                n = () => {
            ...
            window.addEventListener("resize", o, {
                passive: !0
            }), a !== document.documentElement && I.set(a, "function" == typeof a ? (v.add(a), l || (l = () => {
                let e = {
                    get width() {
                ...
                v.delete(a), v.size || "function" != typeof l || (window.removeEventListener("resize", l), l = void 0)
            }) : (!t && "u" > typeof ResizeObserver && (t = new ResizeObserver(p)), (e = (0, u.resolveElements)(a)).forEach(e => {
                let l = f.get(e);
                l || (l = new Set, f.set(e, l)), l.add(o), t?.observe(e)
            }), () => {
                e.forEach(e => {
                    let l = f.get(e);
                    l?.delete(o), l?.size || t?.unobserve(e)
                })
        ...
        let c = Q.get(a);
        return s.frame.read(c, !1, !0), () => {
            (0, s.cancelFrame)(c);
            let e = S.get(a);
            if (!e || (e.delete(o), e.size)) return;
            let t = Q.get(a);
            Q.delete(a), t && (P(a).removeEventListener("scroll", t), I.get(a)?.(), window.removeEventListener("resize", t))
        }
    }
    let $ = new Map;
    ...
    e.s(["useScroll", 0, function({
        ...
        let a = (0, z.useConstant)(K),
            ...
            d = (0, r.useCallback)(() => (s.current = function(e, {
                ...
                return "function" == typeof e ? (i = e, r = c, 2 === i.length ? W(e => {
        ...
        return (0, T.useIsomorphicLayoutEffect)(() => {
            if (c.current = !1, !(_(e) || _(t))) return d();
            c.current = !0
        }, [d]), (0, r.useEffect)(() => c.current ? ((0, i.invariant)(!_(e), "Container ref is defined but not hydrated", "use-scroll-ref"), (0, i.invariant)(!_(t), "Target ref is defined but not hydrated", "use-scroll-ref"), d()) : void 0, [d]), a
    }], 376936);
    var U = e.i(339967);

    function H(e) {
        let t = (0, z.useConstant)(() => (0, a.motionValue)(e)),
            {
                isStatic: l
            } = (0, r.useContext)(U.MotionConfigContext);
        if (l) {
    ...
    function J(e, t) {
        let l = H(t()),
            a = () => l.set(t());
        return a(), (0, T.useIsomorphicLayoutEffect)(() => {
    ...
    e.s(["useMotionValue", 0, H], 997413), e.s(["useTransform", 0, function(e, t, l, i) {
        ...
        let r = "function" == typeof t ? t : function(...e) {
            let t = !Array.isArray(e[0]),
                ...
                r = e[2 + l],
                n = e[3 + l],
                s = (0, w.interpolate)(i, r, n);
            return t ? s(a) : s
        }(t, l, i);
        return Array.isArray(e) ? V(e, r) : V([e], ([e]) => r(e))
    }], 192207)
}, 459923, 570994, e => {
    "use strict";
    var t = e.i(500783),
    ...
    e.s(["default", 0, ({
        ...
        let {
            mapFormActions: g
        } = (0, f.useFormModal)(e), m = g(e), x = (0, l.useMemo)(() => (d?.data ?? []).map(e => e?.value?.text ? {
            value: {
                type: "text",
                text: e.value.text
            },
    ...
    e.s(["default", 0, ({
        ...
        let F = (0, a.default)("top-0 left-0 h-full w-full absolute z-10 transition-opacity duration-500 object-cover", {
                "opacity-0 pointer-events-none": R && !C && B && m?.src
            }),
            Q = "horizontal" === p && x,
            ...
            $ = (0, t.jsxs)("div", {
                ...
                children: ["horizontal" === p && Q && (0, t.jsx)("div", {
                    ...
                    children: [(g?.src || m?.src) && (0, t.jsxs)("div", {
                        className: P,
                        children: [m?.src && (0, t.jsx)(h, {
                            url: m.src,
                            playing: R && B && !C,
                            loop: !!v,
                            muted: v,
                            ...
                            children: [!v && (0, t.jsx)(u.default, {
                                ...
                                src: g.src,
                                placeholder: g.placeholder ? "blur" : "empty",
    ...
    let c = ({
        ...
        let [p, v] = (0, l.useState)(u?.[0]?.value || ""), b = (e, l) => {
            let a = {
                uniteCard: i.default,
                cardSubscription: s
            } [e?.type];
            return (0, t.jsx)("div", {
                ...
                children: (0, t.jsx)(a, {
                    ...e,
                    variant: g,
                    blockKey: m || r.trackingLocation.uniteCards,
                    titleTag: x,
                    index: l
                })
            }, `${e.title}-${l}`)
        ...
        }), j = (0, a.default)("w-full flex flex-wrap justify-center", {
                ...
                children: (0, t.jsxs)("div", {
                    ...
                    children: [(c || d) && (0, t.jsx)(o.default, {
                        ...
                        children: [u.map((e, l) => (0, t.jsx)(n.default, {
                            ...
                            "data-link-location": m || r.trackingLocation.uniteCardsFilter,
                            "data-link-id": `${m||r.trackingLocation.uniteCardsFilter}-filter-${l}`,
                            children: e.title
                            ...
                            outlined: !0,
                            hasArrow: !0,
                            "data-link-location": m || r.trackingLocation.uniteCardsAction,
                            "data-link-id": `${m||r.trackingLocation.uniteCardsAction}-action-${l}`,
                            children: e.title
                        }, `action-${e}-${l}`))]
                    }), (0, t.jsx)("div", {
                        className: j,
                        children: p ? h.filter(e => e.tags?.includes(p)).map(b) : h.map(b)
                    })]
                })
            })
        })
    ...
    let g = ({
        ...
        let [g, m] = (0, l.useState)(0), x = (0, l.useRef)(null), p = (0, f.default)(`(min-width: ${h.default.Large}px)`), v = "gdc2026" === n, b = (0, a.default)({
            dark: "dark" === e
            ...
            return (0, t.jsx)("div", {
                ...
                children: Array.from({
                    length: i
                }).map((l, i) => (0, t.jsx)("button", {
                    className: (0, a.default)("h-2 w-2 rounded-full transition-all", g === i ? "bg-white" : "dark" === e ? "bg-gray-600" : "bg-gray-300"),
                    "aria-label": `Go to slide ${i+1}`,
                    "aria-current": g === i ? "true" : "false"
                }, i))
            })
        }, L = p ? 2 : 1, R = r.length - L + 1, E = 0 === g, B = g >= R - 1, C = p && r.length > 2 || !p && r.length > 1;
    ...
    e.s(["default", 0, ({
        ...
        let {
            mapFormActions: A,
            renderModal: y
        } = (0, x.useFormModal)(o?.map(e => e.action).filter(Boolean)), j = (e, t = 0, l = !1) => {
            let a = !!e?.action?.form,
                i = null;
            e?.action ? i = {
            ...
            if (!o || 0 === o.length) return d?.length && d?.length > 0 ? d?.map((e, t) => j(e, t)) : [];
            let e = 0,
                t = 0;
            return o.map((l, a) => {
        ...
        })() : o?.length && o?.length > 0 ? o?.filter(e => "cardDynamic" !== e._type).map((e, t) => j(e, t)) : d?.length && d?.length > 0 ? d?.map((e, t) => j(e, t)) : [], w = i?.map((e, t) => ({
            title: e.title,
            value: e.value,
            onPress: () => {
                (0, m.default)({
                ...
                children: (0, t.jsxs)("div", {
                    ...
                    children: [(0, t.jsxs)("div", {
                        ...
                        children: [r && (0, t.jsx)("span", {
                            ...
                            className: "mt-8",
                            children: g?.renderModal ? g.renderModal() : (0, t.jsx)(i.default, {
                                href: g.href,
                                rounded: !0,
                                outlined: !0,
                                hasArrow: !0,
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "4c315ee8-5641-5758-8457-84a4ebd4fbf9")
    } catch (e) {}
}();
//# debugId=4c315ee8-5641-5758-8457-84a4ebd4fbf9