(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 274316, e => {
    ...
    j.Block = ({
        ...
        let [w, N] = (0, l.useState)(!1), [L, C] = (0, l.useState)(!1), S = (0, l.useRef)(null), T = (0, m.useInView)(S, {
            once: !0
        }), M = (0, h.useReducedMotion)(), E = 1 / k * y, R = .75 * E, {
            scrollYProgress: D
        } = (0, d.useScroll)({
            target: S
        }), I = (0, c.useTransform)(D, [E, y !== k - 1 ? E + R : 1], [0, 1], {
            ease: u.easeInOut
        }), A = (0, c.useTransform)(D, [E, y !== k - 1 ? E + R : 1], [100, 0], {
            ease: u.easeInOut
        }), H = -((S.current?.offsetHeight || 0) / k) * y;
        f(D, "change", e => {
            N(e >= E)
        });
        let B = (0, i.default)("object-cover transition-opacity duration-1000", {
            ...
            F = (0, t.jsx)("div", {
                ...
                children: Array.from(Array(k), (e, a) => {
                        ...
                        case 5:
                            if (function(e, t, a) {
                                    var l = a[0],
                                        ...
                                        o = e[t + 3],
                                        d = S(o, s, n);
                                    return s ? !!(!o && d || S(e[t], l, n) && S(e[t + 1], r, n) && S(e[t + 2], i, n) && d) : d
                                }(e, t, a)) return !0;
                            break;
                        default:
                            return !1
    ...
    function R(e) {
        return D(e, "defaultColor", [0, 0, 0, 0])
    }
    ...
    function I(e) {
        var t, a, l;
        return (t = e, "u" > typeof HTMLCanvasElement && t instanceof HTMLCanvasElement) ? "canvas" : (a = e, H && a instanceof OffscreenCanvas) ? "offscreencanvas" : B(e) ? "videoframe" : (l = e, "u" > typeof ImageBitmap && l instanceof ImageBitmap) ? "imagebitmap" : e.src
    }
    ...
    var _ = function() {
        ...
        return e.prototype.getColorAsync = function(e, t) {
            if (!e) return Promise.reject($("call .getColorAsync() without resource"));
            if ("string" == typeof e) {
                if ("u" < typeof Image) return Promise.reject($("resource as string is not supported in this environment"));
                var a = new Image;
            ...
            var a, l, r, i, s, n, o, d, c = R(t = t || {});
            if (!e) {
                var u = $("call .getColor() without resource");
                return z(u, t.silent), this.prepareResult(c, u)
            }
            var m = (a = function(e) {
                if (A(e)) {
            ...
            }(e), r = D(l = t, "left", 0), i = D(l, "top", 0), s = D(l, "width", a.width), n = D(l, "height", a.height), o = s, d = n, "precision" === l.mode || (s > n ? d = Math.round((o = 100) / (s / n)) : o = Math.round((d = 100) / (n / s)), (o > s || d > n || o < 10 || d < 10) && (o = s, d = n)), {
                srcLeft: r,
                srcTop: i,
                srcWidth: s,
                srcHeight: n,
            ...
            if (!m.srcWidth || !m.srcHeight || !m.destWidth || !m.destHeight) {
                var u = $('incorrect sizes for resource "'.concat(I(e), '"'));
                return z(u, t.silent), this.prepareResult(c, u)
            }
            if (!this.canvas && (this.canvas = F ? H ? new OffscreenCanvas(1, 1) : null : document.createElement("canvas"), !this.canvas)) {
                var u = $("OffscreenCanvas is not supported in this browser");
                return z(u, t.silent), this.prepareResult(c, u)
            }
            if (!this.ctx) {
                if (this.ctx = this.canvas.getContext("2d", {
                    ...
                    var u = $("Canvas Context 2D is not supported in this browser");
                    return z(u, t.silent), this.prepareResult(c)
                }
            ...
            try {
                ...
                var u = $("security error (CORS) for resource ".concat(I(e), ".\nDetails: https://developer.mozilla.org/en/docs/Web/HTML/CORS_enabled_image"));
                return z(u, t.silent), t.silent || console.error(a), this.prepareResult(c, u)
            }
            ...
            switch (t.algorithm || "sqrt") {
                ...
                case "dominant":
                    ...
                    break;
                default:
                    throw $("".concat(t.algorithm, " is unknown algorithm"))
            }
            return a(e, r - r % 4, {
                defaultColor: i,
            ...
            return new Promise(function(l, r) {
                var i = function() {
                    ...
                    s = function() {
                        o(), r($('Error loading image "'.concat(e.src, '"')))
                    },
                    n = function() {
                        o(), r($('Image "'.concat(e.src, '" loading aborted')))
                    },
                    o = function() {
    ...
    let P = e => [parseInt(e.slice(1, 3), 16), parseInt(e.slice(3, 5), 16), parseInt(e.slice(5, 7), 16)],
        q = (e, t) => {
            let a, l, r, [i, s, n] = P(e),
    ...
    let U = (0, s.default)(() => e.A(969945), {
                ...
                children: [(0, t.jsxs)("div", {
                    ...
                    children: [e.description && (0, t.jsx)("div", {
                        ...
                        children: [e.details && e.details.length > 0 && (0, t.jsx)("ul", {
                            ...
                            className: "flex gap-2",
                            children: [e.description?.readMoreLabel && (0, t.jsx)(k.default, {
                                className: "md:hidden",
                                onClick: () => r(!a),
                                variant: "secondary",
        ...
        G = ({
            ...
            let [r, i] = (0, l.useState)(!1), [s, o] = (0, l.useState)(!1), [d, c] = (0, l.useState)(!1);
            return (0, t.jsxs)("div", {
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "89b0dee2-7aa9-5676-8c8a-6d6b93315b02")
    } catch (e) {}
}();
//# debugId=89b0dee2-7aa9-5676-8c8a-6d6b93315b02