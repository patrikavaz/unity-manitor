(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 132367, r => {
    "use strict";
    let e = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,
        t = /_key\s*==\s*['"](.*)['"]/,
        n = /^\d*:\d*$/;
    ...
    r.s(["createEditUrl", 0, function(r) {
        ...
        return `${p}${e}.${b(r)}`
    }, "isDraftId", 0, h, "isVersionId", 0, d, "studioPath", 0, l], 132367)
    ...
    r.s(["ReplaySubject", 0, l], 659454)
}, 159862, 827540, 949918, 907844, 337902, 450363, 558869, 521879, 448971, 913072, 516165, 602435, 902190, 411844, 939584, 841471, 43533, 990156, 12436, 633482, r => {
    "use strict";
    var e = r.i(824627);
    ...
    r.s(["isArrayLike", 0, F], 602435), r.s(["isPromise", 0, $], 902190), r.s(["isInteropObservable", 0, j], 411844), r.s(["isAsyncIterable", 0, R], 939584), r.s(["createInvalidObservableTypeError", 0, U], 841471);
    ...
    var s = r.i(806298),
        u = r.i(827540);
    r.s(["concatMap", 0, function(r, e) {
        return (0, u.isFunction)(e) ? (0, s.mergeMap)(r, e, 1) : (0, s.mergeMap)(r, 1)
    }], 262940)
}]);