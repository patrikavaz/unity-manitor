(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 584266, 817916, e => {
    ...
    let w = ({
        ...
        let n = (0, h.default)(`(max-width: ${f.default.Large}px)`),
            ...
            A = () => {
                let e;
                s.current && (s.current.offsetTop < window.scrollY ? y(!0) : y(!1)), w.current > window.scrollY && p ? m(!0) : w.current < window.scrollY && m(!1), w.current = window.scrollY, s.current && (s.current.offsetTop > window.innerHeight && !g ? k(!0) : k(!1)), e = null, d.forEach((t, a) => {
        ...
        }, [j]), (0, l.useLayoutEffect)(() => (_(), window.addEventListener("resize", _), () => {
            window.removeEventListener("resize", _)
        }), []), (0, l.useEffect)(() => (w.current = window.scrollY, window.addEventListener("scroll", A), () => {
    ...
    t.exports = function e(t, a, f, h, g, m, p, x, v, b) {
        ...
        function N() {
            ...
            if (w) var S = o(N),
                C = i(R, S);
            if (h && (R = r(R, h, g, w)), m && (R = l(R, m, p, w)), L -= C, w && L < b) {
                var T = d(R, S);
                return s(t, a, e, N.placeholder, f, R, T, x, v, b - L)
            }
            var B = j ? f : this,
                I = k ? B[t] : t;
            return L = R.length, x ? R = c(R, x) : _ && L > 1 && R.reverse(), y && v < L && (R.length = v), this && this !== u && this instanceof N && (I = A || n(I)), I.apply(B, R)
        }
        return N
    }
}, 50962, (e, t, a) => {
    ...
    t.exports = function(e, t, a, g, m, p, x, v) {
        ...
        var w = b ? void 0 : o(e),
            _ = [e, t, a, g, m, j, k, p, x, v];
        if (w && c(_, w), e = _[0], t = _[1], a = _[2], g = _[3], m = _[4], (v = _[9] = void 0 === _[9] ? b ? 0 : e.length : h(_[9] - y, 0)) || !(24 & t) || (t &= -25), t && 1 != t) A = 8 == t || 16 == t ? i(e, t, v) : 32 != t && 33 != t || m.length ? n.apply(void 0, _) : s(e, t, a, g);
        else var A = l(e, t, a);
        return u((w ? r : d)(A, _), e, t)
    }
}, 414462, (e, t, a) => {
    var r = e.r(852580);
    ...
    e.s(["default", 0, ({
        ...
        })() : o?.length && o?.length > 0 ? o?.filter(e => "cardDynamic" !== e._type).map((e, t) => k(e, t)) : d?.length && d?.length > 0 ? d?.map((e, t) => k(e, t)) : [], _ = l?.map((e, t) => ({
            title: e.title,
            value: e.value,
            onPress: () => {
                (0, m.default)({
    ...
    let c = (0, i.default)(() => e.A(104688), {
        ...
        d = ({
            ...
            let x = (0, r.useRef)(null),
                ...
                A = (0, a.default)("absolute left-0 top-0 [&>video]:object-cover", {
