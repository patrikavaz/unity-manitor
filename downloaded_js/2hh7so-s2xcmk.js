(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 740041, t => {
    ...
    t.s(["defaultLocale", 0, "en", "localePrefix", 0, "as-needed", "localeToIETFTag", 0, e, "locales", 0, ["en", "fr", "es", "de", "pt", "ru", "cn", "ja", "kr", "vn"], "oneTrustLocaleOverrides", 0, e])
}, 7075, t => {
    "use strict";
    var e = t.i(603500),
        r = t.i(740041);
    ...
    i.displayName = "XIcon", t.s(["X", 0, i, "XIcon", 0, i], 243306)
}, 501718, (t, e, r) => {
    var n = {
            872: function(t, e) {
                "use strict";
                e.byteLength = function(t) {
                    ...
                    var e, r, o = u(t),
                        ...
                        c = 0,
                        l = f > 0 ? a - 4 : a;
                    for (r = 0; r < l; r += 4) e = n[t.charCodeAt(r)] << 18 | n[t.charCodeAt(r + 1)] << 12 | n[t.charCodeAt(r + 2)] << 6 | n[t.charCodeAt(r + 3)], s[c++] = e >> 16 & 255, s[c++] = e >> 8 & 255, s[c++] = 255 & e;
                    return 2 === f && (e = n[t.charCodeAt(r)] << 2 | n[t.charCodeAt(r + 1)] >> 4, s[c++] = 255 & e), 1 === f && (e = n[t.charCodeAt(r)] << 10 | n[t.charCodeAt(r + 1)] << 4 | n[t.charCodeAt(r + 2)] >> 2, s[c++] = e >> 8 & 255, s[c++] = 255 & e), s
            ...
            230: function(t, e, r) {
                ...
                function u(t, e, r) {
                    ...
                    var c = t.valueOf && t.valueOf();
                    if (null != c && c !== t) return f.from(c, e, r);
                    var d = function(t) {
                        if (f.isBuffer(t)) {
                            var e = 0 | h(t.length),
                                r = a(e);
                        ...
                        return void 0 !== t.length ? "number" != typeof t.length || function(t) {
                            return t != t
                        }(t.length) ? a(0) : l(t) : "Buffer" === t.type && Array.isArray(t.data) ? l(t.data) : void 0
                    }(t);
                    if (d) return d;
                ...
                f.isBuffer = function(t) {
                    ...
                    if (T(t, Uint8Array) && (t = f.from(t, t.offset, t.byteLength)), T(e, Uint8Array) && (e = f.from(e, e.offset, e.byteLength)), !f.isBuffer(t) || !f.isBuffer(e)) throw TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
                    if (t === e) return 0;
                    ...
                    for (r = 0; r < t.length; ++r) {
                        var o = t[r];
                        if (T(o, Uint8Array) && (o = f.from(o)), !f.isBuffer(o)) throw TypeError('"list" argument must be an Array of Buffers');
                    ...
                    if (T(t, Uint8Array) && (t = f.from(t, t.offset, t.byteLength)), !f.isBuffer(t)) throw TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof t);
                    ...
                    for (var o = i - n, a = r - e, u = Math.min(o, a), s = this.slice(n, i), c = t.slice(e, r), l = 0; l < u; ++l)
                        if (s[l] !== c[l]) {
                            o = s[l], a = c[l];
                            break
                        } return o < a ? -1 : +(a < o)
                ...
                function b(t, e, r) {
                    ...
                    for (var n = [], i = e; i < r;) {
                        ...
                        if (i + l <= r) switch (l) {
                            case 1:
                                ...
                                break;
                            case 2:
                                (192 & (o = t[i + 1])) == 128 && (u = (31 & s) << 6 | 63 & o) > 127 && (c = u);
                                break;
                            case 3:
                                o = t[i + 1], a = t[i + 2], (192 & o) == 128 && (192 & a) == 128 && (u = (15 & s) << 12 | (63 & o) << 6 | 63 & a) > 2047 && (u < 55296 || u > 57343) && (c = u);
                                break;
                            case 4:
                                o = t[i + 1], a = t[i + 2], f = t[i + 3], (192 & o) == 128 && (192 & a) == 128 && (192 & f) == 128 && (u = (15 & s) << 18 | (63 & o) << 12 | (63 & a) << 6 | 63 & f) > 65535 && u < 1114112 && (c = u)
                        }
                    ...
                    for (var d = "", g = 0; g < p;) d += String.fromCharCode.apply(String, h.slice(g, g += 4096));
                    return d
                }
                ...
                f.prototype.write = function(t, e, r, n) {
                    ...
                    var i, o, a, f, u, s, c, l, h = this.length - e;
                    ...
                    for (var p = !1;;) switch (n) {
                        ...
                        case "base64":
                            return u = e, s = r, M(k(t), this, u, s);
                        case "ucs2":
                        case "ucs-2":
                        case "utf16le":
                        case "utf-16le":
                            return c = e, l = r, M(function(t, e) {
            ...
            321: function(t, e) {
                e.read = function(t, e, r, n, i) {
                    var o, a, f = 8 * i - n - 1,
                        ...
                        h = r ? -1 : 1,
                        p = t[e + l];
                    for (l += h, o = p & (1 << -c) - 1, p >>= -c, c += f; c > 0; o = 256 * o + t[e + l], l += h, c -= 8);
                    ...
                    var a, f, u, s = 8 * o - i - 1,
                        ...
                        d = n ? 1 : -1,
                        g = +(e < 0 || 0 === e && 1 / e < 0);
                    for (isNaN(e = Math.abs(e)) || e === 1 / 0 ? (f = +!!isNaN(e), a = c) : (a = Math.floor(Math.log(e) / Math.LN2), e * (u = Math.pow(2, -a)) < 1 && (a--, u *= 2), a + l >= 1 ? e += h / u : e += h * Math.pow(2, 1 - l), e * u >= 2 && (a++, u /= 2), a + l >= c ? (f = 0, a = c) : a + l >= 1 ? (f = (e * u - 1) * Math.pow(2, i), a += l) : (f = e * Math.pow(2, l - 1) * Math.pow(2, i), a = 0)); i >= 8; t[r + p] = 255 & f, p += d, f /= 256, i -= 8);
    ...
    t.s(["default", 0, ({
        ...
        let a = n[i],
            f = (0, r.default)("relative mango-text-caption-md rounded-lg px-2 py-1 uppercase animated-border", "text-black dark:text-white", t);
        return (0, e.jsxs)("div", {
            "aria-label": o,
            style: {
                "--color-accent": a.accent,
                "--color-background": a.background,
                "--color-accent-dark": a.accentDark,
                "--color-background-dark": a.backgroundDark
            },
            className: f,
