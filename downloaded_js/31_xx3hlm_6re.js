(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 401861, 841889, e => {
    ...
    "use strict";
    var t, l, a, r, s, i = ((t = {}).en = "en", t.de = "de_de", t.ja = "ja_jp", t.fr = "fr_fr", t.pt = "pt_br", t.cn = "zh_cn", t.es = "es_es", t.ru = "ru_ru", t.kr = "ko_kr", t);
    (l = {}).en = "en", l.de_de = "de", l.ja_jp = "ja", l.fr_fr = "fr", l.pt_br = "pt", l.zh_cn = "cn", l.es_es = "es", l.ru_ru = "ru", l.ko_kr = "kr";
    var n = ((a = {}).en = "en-US", a.de = "de-DE", a.ja = "ja-JP", a.fr = "fr-FR", a.pt = "pt-BR", a.cn = "zh-CN", a.es = "es-ES", a.ru = "ru-RU", a.kr = "ko-KR", a);
    (r = {}).en = "en-US", r.de = "de-DE", r.ja = "ja-JP", r.fr = "fr-FR", r.pt = "pt-BR", r.zh = "zh-CN", r.es = "es-ES", r.ru = "ru-RU", r.ko = "ko-KR", (s = {}).kr = "ko", s.cn = "zh", e.s(["LanguageMap", () => i, "LanguageMapIETFLanguageTag", () => n])
}, 22766, (e, t, l) => {
