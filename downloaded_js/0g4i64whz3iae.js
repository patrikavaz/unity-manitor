(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 637165, 511611, t => {
    "use strict";
    var e = t.i(361979);
    ...
    var i = t.i(538305),
        s = t.i(134026),
        o = t.i(349168);
    t.s(["animateSingleValue", 0, function(t, e, r) {
        let a = (0, i.isMotionValue)(t) ? t : (0, s.motionValue)(t);
        return a.start((0, o.animateMotionValue)("", a, e, r)), a.animation
    }], 511611)
}, 566993, 871726, t => {
    "use strict";
    var e = t.i(141932),
        ...
        return class {
            constructor(t = {}, i = e?.()) {
                this.id = t_++, this.animationId = 0, this.animationCommitId = 0, this.children = new Set, this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = {
                    ...
                    this.projectionUpdateScheduled = !1, tl.statsBuffer.value && (tK.nodes = tK.calculatedTargetDeltas = tK.calculatedProjections = 0), this.nodes.forEach(t3), this.nodes.forEach(t8), this.nodes.forEach(et), this.nodes.forEach(t6), tl.statsBuffer.addProjectionMetrics && tl.statsBuffer.addProjectionMetrics(tK)
            ...
            mount(e) {
                ...
                if (r && !r.current && r.mount(e), this.root.nodes.add(this), this.parent && this.parent.children.add(this), this.root.hasTreeAnimated && (o || i) && (this.isLayoutDirty = !0), t) {
                    ...
                    s.frame.read(() => {
                        ...
                        if (t !== o) {
                            ...
                            }, s.frame.setup(a, !0), i = () => (0, s.cancelFrame)(a), Q.hasAnimatedSinceResize && (Q.hasAnimatedSinceResize = !1, this.nodes.forEach(t2))
                        }
                    })
                }
                i && this.root.registerSharedNode(i, this), !1 !== this.options.animate && r && (i || o) && this.addEventListener("didUpdate", ({
                    ...
                    } else e || t2(this), this.isLead() && this.options.onExitComplete && this.options.onExitComplete();
                    this.targetLayout = s
                })
            }
            unmount() {
            ...
            update() {
                ...
                if (this.animationId <= this.animationCommitId) return void this.nodes.forEach(t9);
                this.animationCommitId = this.animationId, this.isUpdating ? (this.isUpdating = !1, this.nodes.forEach(t4), this.nodes.forEach(t0), this.nodes.forEach(t1)) : this.nodes.forEach(t9), this.clearAllSnapshots();
                let t = tm.time.now();
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "97221753-faee-545f-ac24-65319ceb7ee1")
    } catch (e) {}
}();
//# debugId=97221753-faee-545f-ac24-65319ceb7ee1