(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 675815, 193777, e => {
    "use strict";
    var t = e.i(776050),
        r = e.i(950011);
    class n {
    ...
    e.s(["FocusScope", 0, function(e) {
        ...
        (0, a.useLayoutEffect)(() => {
            let e = G || C.root;
            if (C.getTreeNode(e.scopeRef) && p && !N(p, e.scopeRef)) {
                let t = C.getTreeNode(p);
                t && (e = t)
            }
            e.addChild(V), C.addNode(V)
        }, [V, G]), (0, a.useLayoutEffect)(() => {
            let e = C.getTreeNode(z);
            e && (e.contain = !!H)
        ...
        }, [I]), r = z, n = K, o = H, (0, a.useLayoutEffect)(() => {
            if (n || o) return;
            let e = r.current,
        ...
        }, [x]), O = z, M = K, _ = H, D = (0, d.useRef)("u" > typeof document ? (0, t.getActiveElement)((0, s.getOwnerDocument)(O.current ? O.current[0] : void 0)) : null), (0, a.useLayoutEffect)(() => {
            let e = O.current,
                r = (0, s.getOwnerDocument)(e ? e[0] : void 0);
            if (!M || _) return;
            let n = () => {
                (!p || N(p, O)) && v((0, t.getActiveElement)(r), O.current) && (p = O)
            };
        ...
        }, [O, _]), (0, a.useLayoutEffect)(() => {
            let e = (0, s.getOwnerDocument)(O.current ? O.current[0] : void 0);
            if (!M) return;
            let t = t => {
                if ("Tab" !== t.key || t.altKey || t.ctrlKey || t.metaKey || !E(O) || t.isComposing) return;
                ...
                if (o && o.isConnected && o !== e.body || (o = void 0, n.nodeToRestore = void 0), (!l || !g(l, O)) && o) {
                    i.currentNode = o;
                    do l = t.shiftKey ? i.previousNode() : i.nextNode(); while (g(l, O))(t.preventDefault(), t.stopPropagation(), l) ? b(l, !0): g(o) ? b(o, !0) : r.blur()
                }
            };
            return _ || e.addEventListener("keydown", t, !0), () => {
                _ || e.removeEventListener("keydown", t, !0)
            }
        }, [O, M, _]), (0, a.useLayoutEffect)(() => {
            let e = (0, s.getOwnerDocument)(O.current ? O.current[0] : void 0);
            if (!M) return;
            let r = C.getTreeNode(O);
            if (r) return r.nodeToRestore = D.current ?? void 0, () => {
                let r = C.getTreeNode(O);
                if (!r) return;
                let n = r.nodeToRestore,
                    o = (0, t.getActiveElement)(e);
                if (M && n && (o && g(o, O) || o === e.body && y(O))) {
                    let t = C.clone();
                    requestAnimationFrame(() => {
                        if (e.activeElement === e.body) {
                            let e = t.getTreeNode(O);
                            for (; e;) {
                                if (e.nodeToRestore && e.nodeToRestore.isConnected) return void R(e.nodeToRestore);
                                e = e.parent
                            }
                            for (e = t.getTreeNode(O); e;) {
                                if (e.scopeRef && e.scopeRef.current && C.getTreeNode(e.scopeRef)) return void R(T(e.scopeRef.current, !0));
                                e = e.parent
                            }
                        }
                    })
        ...
        }, [O, M]), k = z, F = W, A = d.default.useRef(F), (0, d.useEffect)(() => {
            if (A.current) {
                p = k;
                let e = (0, s.getOwnerDocument)(k.current ? k.current[0] : void 0);
                !v((0, t.getActiveElement)(e), p.current) && k.current && w(k.current)
            }
            A.current = !1
        }, [k]), (0, d.useEffect)(() => {
            let e = (0, t.getActiveElement)((0, s.getOwnerDocument)(z.current ? z.current[0] : void 0)),
                r = null;
            if (v(e, z.current)) {
                for (let t of C.traverse()) t.scopeRef && v(e, t.scopeRef.current) && (r = t);
                r === C.getTreeNode(z) && (p = r.scopeRef)
            }
        }, [z]), (0, a.useLayoutEffect)(() => () => {
            let e = C.getTreeNode(z)?.parent?.scopeRef ?? null;
            (z === p || N(z, p)) && (!e || C.getTreeNode(e)) && (p = e), C.removeTreeNode(z)
        }, [z]);
        let j = (0, d.useMemo)(() => {
                var e;
                return e = z, {
    ...
    e.s(["usePreventScroll", 0, function(e = {}) {
        ...
        (0, T.useLayoutEffect)(() => {
            if (!r) {
                let e, r, n, i, l, s, c, u;
                return 1 == ++R && (t = (0, N.isIOS)() ? (r = S(document.documentElement, "overflow", "hidden"), n = !1, i = document.createElement("style"), (l = (0, v.getNonce)()) && (i.nonce = l), i.textContent = `
@layer {
  * {
    overscroll-behavior: contain;
                    ...
                    s.call(this, {
                        ...e,
                        preventScroll: !0
                    }), e && e.preventScroll || C(this, r)
                }, c = (0, E.chain)(L(document, "touchstart", t => {
                ...
                }) : (u = window.innerWidth - document.documentElement.clientWidth, (0, E.chain)(u > 0 && ("scrollbarGutter" in document.documentElement.style ? S(document.documentElement, "scrollbarGutter", "stable") : S(document.documentElement, "paddingRight", `${u}px`)), S(document.documentElement, "overflow", "hidden")))), () => {
                    0 == --R && t()
                }
            }
        }, [r])
