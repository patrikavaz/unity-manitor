(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 583796, t => {
    "use strict";
    ...
    function o(t, r, e = "auto") {
        let f;
        return !0 === e || "auto" === e && (!(!Number.isNaN(Number(t)) || /[a-z]/i.test(t) && !/\d+(?:[-:\/]\d+){2}(?:T\d+(?:[-:\/]\d+){1,2}(\.\d+)?Z?)?/.test(t)) && Date.parse(t) || function(t) {
            try {
            ...
            return !0
        }(t)) ? t : `${t}${f=JSON.stringify(r),`${i}${Array.from(f).map(t=>{let r=t.charCodeAt(0);if(r>255)throw Error(`Only ASCII edit info can be encoded. Error attempting to encode ${f} on character ${t} (${r})`);return Array.from(r.toString(4).padStart(4,"0")).map(t=>String.fromCodePoint(n[t])).join("")}).join("")}`}`
    }
    Object.fromEntries(Object.entries(n).map(t => t.reverse())), Object.fromEntries(Object.entries(e).map(t => t.reverse()));
    var f = `${Object.values(e).map(t=>`\\u{${t.toString(16)}}`).join("")}`,
        s = RegExp(`[${f}]{4,}`, "gu");

    function a(t) {
        var r, e;
        return t && JSON.parse({
            cleaned: (r = JSON.stringify(t)).replace(s, ""),
            encoded: (null == (e = r.match(s)) ? void 0 : e[0]) || ""
        }.cleaned)
    }
    t.s(["C", () => o, "isRecord", () => r, "stegaClean", () => a])
}, 542241, (t, r, e) => {
    var n = {
            675: function(t, r) {
                "use strict";
                r.byteLength = function(t) {
                    ...
                    var r, e, o = a(t),
                        ...
                        h = 0,
                        p = s > 0 ? f - 4 : f;
                    for (e = 0; e < p; e += 4) r = n[t.charCodeAt(e)] << 18 | n[t.charCodeAt(e + 1)] << 12 | n[t.charCodeAt(e + 2)] << 6 | n[t.charCodeAt(e + 3)], u[h++] = r >> 16 & 255, u[h++] = r >> 8 & 255, u[h++] = 255 & r;
                    return 2 === s && (r = n[t.charCodeAt(e)] << 2 | n[t.charCodeAt(e + 1)] >> 4, u[h++] = 255 & r), 1 === s && (r = n[t.charCodeAt(e)] << 10 | n[t.charCodeAt(e + 1)] << 4 | n[t.charCodeAt(e + 2)] >> 2, u[h++] = r >> 8 & 255, u[h++] = 255 & r), u
                }, r.fromByteArray = function(t) {
                    for (var r, n = t.length, i = n % 3, o = [], f = 0, s = n - i; f < s; f += 16383) o.push(function(t, r, n) {
                        for (var i, o = [], f = r; f < n; f += 3) i = (t[f] << 16 & 0xff0000) + (t[f + 1] << 8 & 65280) + (255 & t[f + 2]), o.push(e[i >> 18 & 63] + e[i >> 12 & 63] + e[i >> 6 & 63] + e[63 & i]);
                        return o.join("")
                    }(t, f, f + 16383 > s ? s : f + 16383));
                    return 1 === i ? o.push(e[(r = t[n - 1]) >> 2] + e[r << 4 & 63] + "==") : 2 === i && o.push(e[(r = (t[n - 2] << 8) + t[n - 1]) >> 10] + e[r >> 4 & 63] + e[r << 2 & 63] + "="), o.join("")
                };
                for (var e = [], n = [], i = "u" > typeof Uint8Array ? Uint8Array : Array, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", f = 0, s = o.length; f < s; ++f) e[f] = o[f], n[o.charCodeAt(f)] = f;
            ...
            72: function(t, r, e) {
                ...
                function a(t, r, e) {
                    if ("string" == typeof t) {
                        ...
                        var o = 0 | l(n, i),
                            a = f(o),
                            u = a.write(n, i);
                        return u !== o && (a = a.slice(0, u)), a
                    }
                    if (ArrayBuffer.isView(t)) return p(t);
                    if (null == t) throw TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " + typeof t);
                    if (S(t, ArrayBuffer) || t && S(t.buffer, ArrayBuffer) || "u" > typeof SharedArrayBuffer && (S(t, SharedArrayBuffer) || t && S(t.buffer, SharedArrayBuffer))) return function(t, r, e) {
                        var n;
                        ...
                        return Object.setPrototypeOf(n = void 0 === r && void 0 === e ? new Uint8Array(t) : void 0 === e ? new Uint8Array(t, r) : new Uint8Array(t, r, e), s.prototype), n
                    }(t, r, e);
                    ...
                    var g = function(t) {
                        ...
                        return void 0 !== t.length ? "number" != typeof t.length || function(t) {
                            return t != t
                        }(t.length) ? f(0) : p(t) : "Buffer" === t.type && Array.isArray(t.data) ? p(t.data) : void 0
                    }(t);
                    if (g) return g;
                    if ("u" > typeof Symbol && null != Symbol.toPrimitive && "function" == typeof t[Symbol.toPrimitive]) return s.from(t[Symbol.toPrimitive]("string"), r, e);
                ...
                }, r.INSPECT_MAX_BYTES = 50, r.kMaxLength = 0x7fffffff, s.TYPED_ARRAY_SUPPORT = function() {
                    try {
                ...
                }), s.poolSize = 8192, s.from = function(t, r, e) {
                    return a(t, r, e)
                }, Object.setPrototypeOf(s.prototype, Uint8Array.prototype), Object.setPrototypeOf(s, Uint8Array), s.alloc = function(t, r, e) {
                    return (u(t), t <= 0) ? f(t) : void 0 !== r ? "string" == typeof e ? f(t).fill(r, e) : f(t).fill(r) : f(t)
                ...
                function g(t, r, e) {
                    ...
                    for (t || (t = "utf8");;) switch (t) {
                        ...
                        case "base64":
                            return i = this, o = r, f = e, 0 === o && f === i.length ? n.fromByteArray(i) : n.fromByteArray(i.slice(o, f));
                        case "ucs2":
                        case "ucs-2":
                        case "utf16le":
                        case "utf-16le":
                ...
                function d(t, r, e, n, i) {
                    ...
                    if ("string" == typeof e ? (n = e, e = 0) : e > 0x7fffffff ? e = 0x7fffffff : e < -0x80000000 && (e = -0x80000000), (o = e *= 1) != o && (e = i ? 0 : t.length - 1), e < 0 && (e = t.length + e), e >= t.length)
                        if (i) return -1;
                        else e = t.length - 1;
                    else if (e < 0)
                        if (!i) return -1;
                        else e = 0;
                    if ("string" == typeof r && (r = s.from(r, n)), s.isBuffer(r)) return 0 === r.length ? -1 : m(t, r, e, n, i);
                    if ("number" == typeof r) {
                ...
                function m(t, r, e, n, i) {
                    ...
                    if (i) {
                        var h = -1;
                        for (o = e; o < s; o++)
                            if (u(t, o) === u(r, -1 === h ? 0 : o - h)) {
                                if (-1 === h && (h = o), o - h + 1 === a) return h * f
                            } else - 1 !== h && (o -= o - h), h = -1
                    } else
                        for (e + a > s && (e = s - a), o = e; o >= 0; o--) {
                            for (var p = !0, c = 0; c < a; c++)
                                if (u(t, o + c) !== u(r, c)) {
                                    p = !1;
                                    break
                                } if (p) return o
                ...
                s.isBuffer = function(t) {
                    ...
                    if (S(t, Uint8Array) && (t = s.from(t, t.offset, t.byteLength)), S(r, Uint8Array) && (r = s.from(r, r.offset, r.byteLength)), !s.isBuffer(t) || !s.isBuffer(r)) throw TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
                    if (t === r) return 0;
                    ...
                    for (e = 0; e < t.length; ++e) {
                        var o = t[e];
                        if (S(o, Uint8Array) && (o = s.from(o)), !s.isBuffer(o)) throw TypeError('"list" argument must be an Array of Buffers');
                ...
                }, o && (s.prototype[o] = s.prototype.inspect), s.prototype.compare = function(t, r, e, n, i) {
                    if (S(t, Uint8Array) && (t = s.from(t, t.offset, t.byteLength)), !s.isBuffer(t)) throw TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof t);
                    ...
                    for (var o = i - n, f = e - r, a = Math.min(o, f), u = this.slice(n, i), h = t.slice(r, e), p = 0; p < a; ++p)
                        if (u[p] !== h[p]) {
                            o = u[p], f = h[p];
                            break
                        } return o < f ? -1 : +(f < o)
                    ...
                    for (var n = [], i = r; i < e;) {
                        ...
                        if (i + p <= e) switch (p) {
                            case 1:
                                ...
                                break;
                            case 2:
                                (192 & (o = t[i + 1])) == 128 && (a = (31 & u) << 6 | 63 & o) > 127 && (h = a);
                                break;
                            case 3:
                                o = t[i + 1], f = t[i + 2], (192 & o) == 128 && (192 & f) == 128 && (a = (15 & u) << 12 | (63 & o) << 6 | 63 & f) > 2047 && (a < 55296 || a > 57343) && (h = a);
                                break;
                            case 4:
                                o = t[i + 1], f = t[i + 2], s = t[i + 3], (192 & o) == 128 && (192 & f) == 128 && (192 & s) == 128 && (a = (15 & u) << 18 | (63 & o) << 12 | (63 & f) << 6 | 63 & s) > 65535 && a < 1114112 && (h = a)
                        }
                        null === h ? (h = 65533, p = 1) : h > 65535 && (h -= 65536, n.push(h >>> 10 & 1023 | 55296), h = 56320 | 1023 & h), n.push(h), i += p
                    }
                    var c = n,
                        l = c.length;
                    if (l <= 4096) return String.fromCharCode.apply(String, c);
                    for (var g = "", y = 0; y < l;) g += String.fromCharCode.apply(String, c.slice(y, y += 4096));
                    return g
                }
                ...
                function A(t, r, e, n, i, o) {
                    if (e + n > t.length || e < 0) throw RangeError("Index out of range")
                }

                function E(t, r, e, n, o) {
                    return r *= 1, e >>>= 0, o || A(t, r, e, 4, 34028234663852886e22, -34028234663852886e22), i.write(t, r, e, n, 23, 4), e + 4
                }

                function O(t, r, e, n, o) {
                    return r *= 1, e >>>= 0, o || A(t, r, e, 8, 17976931348623157e292, -17976931348623157e292), i.write(t, r, e, n, 52, 8), e + 8
                }
                s.prototype.write = function(t, r, e, n) {
                    ...
                    var i, o, f, s, a, u, h, p, c = this.length - r;
                    ...
                    for (var l = !1;;) switch (n) {
                        case "hex":
                            return function(t, r, e, n) {
                                ...
                                n > o / 2 && (n = o / 2);
                                for (var f = 0; f < n; ++f) {
                                    var s, a = parseInt(r.substr(2 * f, 2), 16);
                                    if ((s = a) != s) break;
                                    t[e + f] = a
                                }
                                return f
                        ...
                        case "utf8":
                        case "utf-8":
                            return i = r, o = e, C(B(t, this.length - i), this, i, o);
                        case "ascii":
                            return f = r, s = e, C(I(t), this, f, s);
                        case "latin1":
                        case "binary":
                            return function(t, r, e, n) {
                                return C(I(r), t, e, n)
                        ...
                        case "base64":
                            return a = r, u = e, C(U(t), this, a, u);
                        case "ucs2":
                        case "ucs-2":
                        case "utf16le":
                        case "utf-16le":
                            return h = r, p = e, C(function(t, r) {
                                for (var e, n, i = [], o = 0; o < t.length && !((r -= 2) < 0); ++o) n = (e = t.charCodeAt(o)) >> 8, i.push(e % 256), i.push(n);
                                return i
                            }(t, this.length - h), this, h, p);
                        default:
                    ...
                    return t >>>= 0, r || w(t, 4, this.length), (this[t] | this[t + 1] << 8 | this[t + 2] << 16) + 0x1000000 * this[t + 3]
                }, s.prototype.readUInt32BE = function(t, r) {
                    return t >>>= 0, r || w(t, 4, this.length), 0x1000000 * this[t] + (this[t + 1] << 16 | this[t + 2] << 8 | this[t + 3])
                    ...
                    return t *= 1, r >>>= 0, e || b(this, t, r, 1, 255, 0), this[r] = 255 & t, r + 1
                }, s.prototype.writeUInt16LE = function(t, r, e) {
                    return t *= 1, r >>>= 0, e || b(this, t, r, 2, 65535, 0), this[r] = 255 & t, this[r + 1] = t >>> 8, r + 2
                }, s.prototype.writeUInt16BE = function(t, r, e) {
                    return t *= 1, r >>>= 0, e || b(this, t, r, 2, 65535, 0), this[r] = t >>> 8, this[r + 1] = 255 & t, r + 2
                }, s.prototype.writeUInt32LE = function(t, r, e) {
                    return t *= 1, r >>>= 0, e || b(this, t, r, 4, 0xffffffff, 0), this[r + 3] = t >>> 24, this[r + 2] = t >>> 16, this[r + 1] = t >>> 8, this[r] = 255 & t, r + 4
                }, s.prototype.writeUInt32BE = function(t, r, e) {
                    return t *= 1, r >>>= 0, e || b(this, t, r, 4, 0xffffffff, 0), this[r] = t >>> 24, this[r + 1] = t >>> 16, this[r + 2] = t >>> 8, this[r + 3] = 255 & t, r + 4
                    ...
                    var o = 0,
                        f = 1,
                        s = 0;
                    for (this[r] = 255 & t; ++o < e && (f *= 256);) t < 0 && 0 === s && 0 !== this[r + o - 1] && (s = 1), this[r + o] = (t / f | 0) - s & 255;
                    return r + e
                    ...
                    var o = e - 1,
                        f = 1,
                        s = 0;
                    for (this[r + o] = 255 & t; --o >= 0 && (f *= 256);) t < 0 && 0 === s && 0 !== this[r + o + 1] && (s = 1), this[r + o] = (t / f | 0) - s & 255;
                    return r + e
                }, s.prototype.writeInt8 = function(t, r, e) {
                    return t *= 1, r >>>= 0, e || b(this, t, r, 1, 127, -128), t < 0 && (t = 255 + t + 1), this[r] = 255 & t, r + 1
                }, s.prototype.writeInt16LE = function(t, r, e) {
                    return t *= 1, r >>>= 0, e || b(this, t, r, 2, 32767, -32768), this[r] = 255 & t, this[r + 1] = t >>> 8, r + 2
                }, s.prototype.writeInt16BE = function(t, r, e) {
                    return t *= 1, r >>>= 0, e || b(this, t, r, 2, 32767, -32768), this[r] = t >>> 8, this[r + 1] = 255 & t, r + 2
                }, s.prototype.writeInt32LE = function(t, r, e) {
                    return t *= 1, r >>>= 0, e || b(this, t, r, 4, 0x7fffffff, -0x80000000), this[r] = 255 & t, this[r + 1] = t >>> 8, this[r + 2] = t >>> 16, this[r + 3] = t >>> 24, r + 4
                }, s.prototype.writeInt32BE = function(t, r, e) {
                    return t *= 1, r >>>= 0, e || b(this, t, r, 4, 0x7fffffff, -0x80000000), t < 0 && (t = 0xffffffff + t + 1), this[r] = t >>> 24, this[r + 1] = t >>> 16, this[r + 2] = t >>> 8, this[r + 3] = 255 & t, r + 4
                    ...
                    if (r >>>= 0, e = void 0 === e ? this.length : e >>> 0, t || (t = 0), "number" == typeof t)
                        ...
                        for (i = 0; i < e - r; ++i) this[i + r] = f[i % a]
                    }
                    return this
                };
                var x = /[^+/0-9A-Za-z-_]/g;
            ...
            783: function(t, r) {
                r.read = function(t, r, e, n, i) {
                    var o, f, s = 8 * i - n - 1,
                        ...
                        c = e ? -1 : 1,
                        l = t[r + p];
                    for (p += c, o = l & (1 << -h) - 1, l >>= -h, h += s; h > 0; o = 256 * o + t[r + p], p += c, h -= 8);
                    for (f = o & (1 << -h) - 1, o >>= -h, h += n; h > 0; f = 256 * f + t[r + p], p += c, h -= 8);
                    if (0 === o) o = 1 - u;
                    else {
                        if (o === a) return f ? NaN : 1 / 0 * (l ? -1 : 1);
                        f += Math.pow(2, n), o -= u
                    }
                    ...
                    var f, s, a, u = 8 * o - i - 1,
                        ...
                        g = n ? 1 : -1,
                        y = +(r < 0 || 0 === r && 1 / r < 0);
                    for (isNaN(r = Math.abs(r)) || r === 1 / 0 ? (s = +!!isNaN(r), f = h) : (f = Math.floor(Math.log(r) / Math.LN2), r * (a = Math.pow(2, -f)) < 1 && (f--, a *= 2), f + p >= 1 ? r += c / a : r += c * Math.pow(2, 1 - p), r * a >= 2 && (f++, a /= 2), f + p >= h ? (s = 0, f = h) : f + p >= 1 ? (s = (r * a - 1) * Math.pow(2, i), f += p) : (s = r * Math.pow(2, p - 1) * Math.pow(2, i), f = 0)); i >= 8; t[e + l] = 255 & s, l += g, s /= 256, i -= 8);
                    for (f = f << i | s, u += i; u > 0; t[e + l] = 255 & f, l += g, f /= 256, u -= 8);
                    t[e + l - g] |= 128 * y
                }
            }
        },
    ...
    function o(t) {
        ...
        var e = i[t] = {
            ...
            f = !0;
        try {
            n[t](e, e.exports, o), f = !1
        } finally {
            f && delete i[t]
        }
        return e.exports
    }
    o.ab = "/ROOT/node_modules/.pnpm/next@16.1.6_@babel+core@7.28.4_@opentelemetry+api@1.9.0_@playwright+test@1.56.1_babel-p_6cb880897f42339be27a7f46c1f472ba/node_modules/next/dist/compiled/buffer/", r.exports = o(72)
}, 477846, (t, r, e) => {
    t.e, r.exports = function() {
        ...
        var i = [
            ...
            f = ["top", "bottom", "left", "right", "center", "focalpoint", "entropy"],
            s = ["format"],
            a = function() {
                function a(t, e) {
                    this.options = void 0, this.options = t ? r({}, t.options || {}, e || {}) : r({}, e || {})
                }
                var u = a.prototype;
                return u.withOptions = function(e) {
                    var n = e.baseUrl || this.options.baseUrl,
                        o = {
                            baseUrl: n
                        };
                    for (var f in e) e.hasOwnProperty(f) && (o[function(r) {
                        for (var e, n = function(r, e) {
                                var n = "u" > typeof Symbol && r[Symbol.iterator] || r["@@iterator"];
                                ...
                                if (Array.isArray(r) || (n = function(r, e) {
                                        if (r) {
                                            ...
                                            return "Object" === n && r.constructor && (n = r.constructor.name), "Map" === n || "Set" === n ? Array.from(r) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? t(r, void 0) : void 0
                                        }
                                    }(r))) {
                                    n && (r = n);
                                    var i = 0;
                    ...
                    if (-1 === f.indexOf(t)) throw Error('Invalid crop mode "' + t + '"');
                    return this.withOptions({
                        crop: t
                    })
                    ...
                    return function(t) {
                        ...
                        var s = function(t) {
                            var e, i;
                            if (!t) return null;
                            if ("string" == typeof t && (i = t, /^https?:\/\//.test("" + i))) e = {
                                asset: {
                                    _ref: n(t)
                                }
                            };
                        ...
                        if (!s) {
                            if (f && "object" == typeof f && null !== f && f._upload && (!f.asset || !f.asset._ref)) return "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8HwQACfsD/QNViZkAAAAASUVORK5CYII=";
                            throw Error("Unable to resolve image URL from source (" + JSON.stringify(f) + ")")
                        }
                        var a = function(t) {
                                var r = t.split("-"),
                                    n = r[1],
                                ...
                                var f = i.split("x"),
                                    ...
                                    u = +s,
                                    h = +a;
                                if (!(isFinite(u) && isFinite(h))) throw Error("Malformed asset _ref '" + t + "'. Expected an id like \"" + e + '".');
                                return {
                                    id: n,
                                    width: u,
                                    height: h,
                            ...
                            u = Math.round(s.crop.left * a.width),
                            h = Math.round(s.crop.top * a.height),
                            p = {
                                left: u,
                                top: h,
                                width: Math.round(a.width - s.crop.right * a.width - u),
                                height: Math.round(a.height - s.crop.bottom * a.height - h)
                            },
                            c = s.hotspot.height * a.height / 2,
                            l = s.hotspot.width * a.width / 2,
                            g = s.hotspot.x * a.width,
                            y = s.hotspot.y * a.height;
                        return o.rect || o.focalPoint || o.ignoreImageParams || o.crop || (o = r({}, o, function(t, r) {
                                var e, n = r.width,
                                    i = r.height;
                                if (!(n && i)) return {
                                    width: n,
                                ...
                                if (o.width / o.height > s) {
                                    var a = Math.round(o.height),
                                        u = Math.round(a * s),
                                        h = Math.max(0, Math.round(o.top)),
                                        p = Math.max(0, Math.round(Math.round((f.right - f.left) / 2 + f.left) - u / 2));
                                    p < o.left ? p = o.left : p + u > o.left + o.width && (p = o.left + o.width - u), e = {
                                        left: p,
                                        top: h,
                                        width: u,
                                        height: a
                                    ...
                                    var c = o.width,
                                        l = Math.round(c / s),
                                        g = Math.max(0, Math.round(o.left)),
                                        y = Math.max(0, Math.round(Math.round((f.bottom - f.top) / 2 + f.top) - l / 2));
                                    y < o.top ? y = o.top : y + l > o.top + o.height && (y = o.top + o.height - l), e = {
                                        left: g,
                                        top: y,
                                        width: c,
                                        height: l
                            ...
                            function(t) {
                                ...
                                if (t.rect) {
                                    var s = t.rect,
                                        ...
                                        h = s.width,
                                        p = s.height;
                                    (0 !== a || 0 !== u || p !== t.asset.height || h !== t.asset.width) && f.push("rect=" + a + "," + u + "," + h + "," + p)
                                }
                                t.bg && f.push("bg=" + t.bg), t.focalPoint && (f.push("fp-x=" + t.focalPoint.x), f.push("fp-y=" + t.focalPoint.y));
                                var c = [t.flipHorizontal && "h", t.flipVertical && "v"].filter(Boolean).join("");
                                return (c && f.push("flip=" + c), i.forEach(function(r) {
                                    var e = r[0],
                                        n = r[1];
                                    void 0 !== t[e] ? f.push(n + "=" + encodeURIComponent(t[e])) : void 0 !== t[n] && f.push(n + "=" + encodeURIComponent(t[n]))
                                }), 0 === f.length) ? o : o + "?" + f.join("&")
                            }(r({}, o, {
                                asset: a
                            }))
                    }(this.options)
        ...
        return function(t) {
            ...
            if (t && "clientConfig" in t && "object" == typeof t.clientConfig) {
                var o = t.clientConfig,
                    ...
                    u = o.dataset;
                return new a(null, {
                    baseUrl: (f || "https://api.sanity.io").replace(/^https:\/\/api\./, "https://cdn."),
                    projectId: s,
                    dataset: u
                })
            }
    ...
    "use strict";
    var r = t.i(591336);
    let e = (0, t.i(477846).default)(r.cdnClient);
    t.s(["urlForImage", 0, t => t ? e.image(t) : null])
}]);
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "0bceb41f-aa30-5826-a88f-bcd2034d5cc9")
    } catch (e) {}
}();
//# debugId=0bceb41f-aa30-5826-a88f-bcd2034d5cc9