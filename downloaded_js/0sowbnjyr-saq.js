(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 185935, e => {
    "use strict";
    ...
    function I({
        ...
        return (0, C.useIsSSR)() ? c.default.createElement(K.Provider, {
            value: t
    ...
    e.s(["Collection", 0, function(e) {
        ...
        return c.default.createElement(c.default.Fragment, null, c.default.createElement(f.Hidden, null, c.default.createElement(S.Provider, {
            value: i
        ...
        let i = ({
            ...
            n = (0, c.forwardRef)((n, l) => {
                let r = (0, c.useContext)(y.FocusableContext);
                if (!(0, c.useContext)(g)) {
                    if (t.length >= 3) throw Error(t.name + " cannot be rendered outside a collection.");
                    return t(n, l)
                }
                return k(e, n, l, "children" in n ? n.children : null, null, e => c.default.createElement(y.FocusableContext.Provider, {
                    value: r
    ...
    e.s(["CollectionRendererContext", 0, M, "SectionContext", 0, D, "usePersistedKeys", 0, function(e) {
    ...
    var t = e.i(897408);
    let i = (0, e.i(409781).createContext)({});
    t.HeaderNode, e.s(["HeaderContext", 0, i])
}, 838123, e => {
    "use strict";
    e.i(467211), e.i(679933);
    var t = e.i(897408);
    e.i(654995), e.i(429305);
    let i = (0, e.i(409781).createContext)({});
    class n extends t.CollectionNode {
        static {
            this.type = "separator"
        }
        filter(e, t) {
    ...
    e.s(["SeparatorContext", 0, i], 838123)
}, 468069, e => {
    "use strict";
    var t = e.i(467211),
        i = e.i(409781);
    ...
    "use strict";
    e.i(913836), t.exports = e.r(120480)
}]);