(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 976989, e => {
    ...
    function h(e, t) {
        ...
        } = e, [b, v] = (0, u.useControlledState)(e.value, e.defaultValue || "", e.onChange), {
            focusableProps: j
        } = (0, n.useFocusable)(e, t), y = (0, m.useFormValidationState)({
            ...e,
            value: b
        }), {
            isInvalid: C,
        ...
        return (0, d.useFormReset)(t, e.defaultValue ?? _, v), (0, c.useFormValidation)(e, y, t), {
            labelProps: N,
            inputProps: (0, i.mergeProps)(T, "input" === a ? M : void 0, {
                disabled: h,
                readOnly: x,
                required: p && "native" === f,
                "aria-required": p && "aria" === f || void 0,
                ...
                value: b,
                onChange: e => v((0, s.getEventTarget)(e).value),
    ...
    e.s(["useTextField", 0, h], 117696);
    var p = e.i(838031);
    let x = l.default.forwardRef((e, l) => {
        let {
            disabled: r,
            hasError: s,
            inputSize: i,
    ...
    function u(e = !0) {
        let t = (0, n.useId)(),
            [l, a] = function(e = !0) {
                let [t, l] = (0, c.useState)(e), a = (0, c.useRef)(!1), r = (0, c.useCallback)(e => {
                    a.current = !0, l(!!e)
                }, []);
    ...
    var m = e.i(251635);
    e.s(["useCheckbox", 0, function(e, n, d) {
        let {
            labelProps: h,
            inputProps: p,
            descriptionProps: x,
            ...
            let {
                ...
                onPressUp: S,
                onClick: T
            } = e, M = (0, m.useFormValidationState)({
                ...e,
                value: n.isSelected
            }), {
                isInvalid: _,
            ...
            let {
                ...
                onPressStart(e) {
                    "keyboard" === e.pointerType || "virtual" === e.pointerType ? e.continuePropagation() : (k?.(e), P?.(!0), B(!0))
                },
                onPressEnd(e) {
                    "keyboard" === e.pointerType || "virtual" === e.pointerType ? e.continuePropagation() : (N?.(e), P?.(!1), B(!1))
                },
                onPressUp(e) {
                    "keyboard" === e.pointerType || "virtual" === e.pointerType ? e.continuePropagation() : S?.(e)
                },
                onClick: T,
                onPress(t) {
                    if ("keyboard" === t.pointerType || "virtual" === t.pointerType) return void t.continuePropagation();
                    L?.(t), n.toggle(), d.current?.focus();
                    let {
                        [m.privateValidationStateProp]: l
                    } = e, {
                        commitValidation: a
                    } = l || M;
                    a()
                ...
                focusableProps: I
            } = (0, r.useFocusable)(e, d), z = (0, a.mergeProps)(R, I), V = (0, t.filterDOMProps)(e, {
                labelable: !0
            });
            (0, s.useFormReset)(d, n.defaultSelected, n.setSelected);
            let F = u(),
                q = u();
            return {
                labelProps: (0, a.mergeProps)(A, {
                    onClick: e => e.preventDefault()
                }),
                inputProps: (0, a.mergeProps)(V, {
                    checked: n.isSelected,
                    "aria-required": v && "aria" === j || void 0,
                    required: v && "native" === j,
                    "aria-invalid": _ || "invalid" === e.validationState || void 0,
                    "aria-errormessage": e["aria-errormessage"],
                    "aria-controls": e["aria-controls"],
                    "aria-readonly": p || void 0,
                    "aria-describedby": [F.id, q.id, w].filter(Boolean).join(" ") || void 0,
                    onChange: e => {
                        e.stopPropagation(), n.setSelected((0, l.getEventTarget)(e).checked)
                    },
                    disabled: h,
                    ...null == x ? {} : {
                        value: x
        ...
        return (0, c.useEffect)(() => {
            d.current && (d.current.indeterminate = !!k)
        }), {
            labelProps: (0, a.mergeProps)(h, (0, c.useMemo)(() => ({
    ...
    e.s(["useToggleState", 0, function(e = {}) {
        let {
            isReadOnly: t
        } = e, [l, a] = (0, h.useControlledState)(e.isSelected, e.defaultSelected || !1, e.onChange), [r] = (0, c.useState)(l);
        return {
            isSelected: l,
            defaultSelected: e.defaultSelected ?? r,
        ...
        return (0, t.jsx)("section", {
            ...
            children: (0, t.jsxs)("div", {
                ...
                children: [e && (0, t.jsx)("h2", {
                    ...
                    className: p,
                    children: n?.map((n, m) => {
                        let p = (0, l.clsx)("flex flex-wrap flex-row", !u && ({
    ...
    e.s(["default", 0, ({
        ...
        let k = j || n.trackingLocation.uniteCard,
            N = void 0 !== w ? `${k}-${w}` : k,
            P = (0, l.useRef)(null),
            [L, S] = (0, l.useState)(!1),
            T = (0, r.useInView)(P),
        ...
        let $ = (0, a.default)("top-0 left-0 h-full w-full absolute z-10 transition-opacity duration-500 object-cover", {
                "opacity-0 pointer-events-none": L && !M && T && x?.src
            }),
            E = "horizontal" === f && g,
            ...
            D = (0, a.default)("rounded-lg bg-gray-100 p-4 dark:bg-gray-900", {
                "h-full": "horizontal" !== f,
                "group h-full relative p-[1px] xl:flex-row xl:gap-6 cursor-pointer": "horizontal" === f && E,
                "h-full relative p-[1px] xl:flex-row xl:gap-6 cursor-auto": "horizontal" === f && !E
            }),
            O = (0, a.default)("relative overflow-hidden rounded-lg", {
                "aspect-video w-full": "horizontal" !== f,
                "aspect-video w-full xl:flex-shrink-0 xl:self-start xl:max-w-1/2": "horizontal" === f
            }),
            B = (0, a.default)("cover absolute object-cover", {
                "transition-transform duration-400 group-hover:scale-110": "horizontal" === f && E
            }),
            A = (0, t.jsxs)("div", {
                ref: P,
                className: D,
                children: ["horizontal" === f && E && (0, t.jsx)("div", {
                    ...
                    children: [(p?.src || x?.src) && (0, t.jsxs)("div", {
                        className: O,
                        children: [x?.src && (0, t.jsx)(h, {
                            url: x.src,
                            playing: L && T && !M,
                            loop: !!b,
                            muted: b,
                            ...
                            children: [!b && (0, t.jsx)(u, {
                                ...
                                src: p.src,
                                placeholder: p.placeholder ? "blur" : "empty",
    ...
    let f = ({
        ...
        v = ({
            ...
            let [n, d] = (0, l.useState)(!1), [u, m] = (0, l.useState)(!1), h = (0, l.useRef)(null), v = (0, p.default)({
            ...
            return (0, t.jsxs)(t.Fragment, {
                children: [(0, t.jsxs)("td", {
                    ...
                    ...C,
                    children: [o ? e : (0, t.jsx)(x.default, {
                        className: j,
                        ref: h,
                        children: e
                    }), r && n && (0, t.jsx)(f, {
    ...
    e.s(["default", 0, ({
        ...
        let [i, ...o] = e.rows.map(e => ({
        ...
        })), n = `align-top text-heading-sm md:text-small-bold rounded-md bg-gray-100 text-gray-800 bg-gray-100 dark:bg-gray-700 md:dark:bg-gray-800 dark:text-gray-200 border-none ${r}`, d = "align-top rounded-md text-sm text-gray-800 dark:text-gray-200 border-none", g = (0, p.default)("w-full table-fixed border-separate border-spacing-2 break-words", a), f = (0, p.default)("h-full table-fixed border-separate border-spacing-1 break-words", a), b = (0, l.useCallback)(e => {
            ...
            return (0, t.jsxs)("div", {
                ...
                children: [(0, t.jsx)("div", {
                    ...
                    children: l.split("|").filter(e => e).map((e, l) => (0, t.jsx)(h.default, {
        ...
        }, []), j = (0, l.useMemo)(() => o.map(e => e.cells.reduce((e, l, a) => ({
            ...e,
            [`col${a+1}`]: {
                component: l.startsWith("|") ? b(l) : (0, t.jsx)(h.default, {
                    options: {
                        overrides: {
                            Button: {
                                component: c.default
        ...
        }), {})), [o, b]), y = (0, l.useMemo)(() => i.cells.map((e, l) => (0, t.jsx)("th", {
            scope: "col",
        ...
        }, `${l}-${e}`)), [i.cells]), C = (0, l.useMemo)(() => j.map((l, a) => {
            let r = Object.values(l),
                s = r[0];
            return (0, t.jsx)("tr", {
                className: "border-separate border-spacing-1",
                children: r.map((l, r) => (0, t.jsx)(v, {
        ...
        }), [y, j, n, e.tableTruncation]), w = (0, l.useMemo)(() => i.cells.map((e, l) => (0, t.jsx)("th", {
            scope: "col",
        ...
        }, `${l}-${e}`)), [i]), k = (0, l.useMemo)(() => j.map((e, l) => (0, t.jsx)("div", {
            ...
            children: (0, t.jsxs)("table", {
                ...
                children: [i && i.cells.length > 0 && (0, t.jsx)("thead", {
                    ...
                    children: Object.values(e).map((e, a) => e ? (0, t.jsx)("tr", {
                        ...
                        children: (0, t.jsxs)("td", {
                            className: 0 === a ? n : d,
                            children: [0 !== a && i && i.cells[a] && (0, t.jsx)(h.default, {
                                options: {
                                    overrides: {
                                        Button: {
                                            component: c.default
    ...
    e.s(["useMTBanner", 0, function(e, r = []) {
        var s, i;
        let o, n, d, c, u, m = (0, t.usePathname)(),
            h = (0, l.useLocale)(),
            p = h !== a.defaultLocale ? m.replace(`/${h}`, "") : m;
        return {
            shouldDisplayMTBanner: h !== a.defaultLocale && e?.translationType === "MT" && !r.includes(p),
            updatedBlocks: (s = e.blocks ?? [], i = e.machineTranslationDisclaimer, o = s.reduce((e, t, l) => ["hero", "alternateNavigation", "headliner"].includes(t._type) ? l : e, -1), n = [...s], d = n[o + 1]?._type === "alternateNavigationAnchor" || n[o + 1]?._type === "anchorButton" ? n[o + 2] : n[o + 1], c = d?.theme ?? null, u = {
                ...
                action: {
                    ...
                    fieldLink: {
                        linkReference: {
                            href: {
                                current: `${window.location.origin}${p}`
                            },
                            target: "_self"
                        }
                    }
                ...
                children: (0, t.jsxs)("div", {
                    ...
                    children: [(0, t.jsx)(r.Info, {
                        ...
                        children: [e && (0, t.jsx)("div", {
                            ...
                            children: [(0, t.jsx)("div", {
                                className: (0, l.clsx)({
                                    "line-clamp-4 sm:line-clamp-2": n?.enabled && h
                                }),
                                children: i
                                ...
                                children: h ? n.seeMoreLabel : n.seeLessLabel
                            })]
                        })]
