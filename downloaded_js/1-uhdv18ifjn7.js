(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 694983, e => {
    ...
    let n = {
            none: "pt-0",
            xs: "mango-md:pt-[2rem] pt-[1.5rem]",
            sm: "mango-md:pt-[5rem] pt-[2.75rem]",
            md: "mango-md:pt-[9.25rem] pt-[4rem]",
            lg: "mango-md:pt-[11.25rem] pt-[6rem]"
        },
        r = {
            none: "pb-0",
            xs: "mango-md:pb-[2rem] pb-[1.5rem]",
            sm: "mango-md:pb-[5rem] pb-[2.75rem]",
            md: "mango-md:pb-[9.25rem] pb-[4rem]",
            lg: "mango-md:pb-[11.25rem] pb-[6rem]"
        },
        s = {
        ...
        i = ({
            ...
            let d = l(o?.top && n[o.top], o?.bottom && r[o.bottom]),
                u = c ? (0, a.jsx)("div", {
                    className: s[c],
                    children: e
                }) : e;
    ...
    e.s(["ThemeContainer", 0, i], 541289), e.s(["MANGO_DEFAULT_BLOCK_PADDING", 0, {
        ...
        padding: s,
        container: c,
        className: (0, t.default)(l, !s?.top && m.top, !s?.bottom && m.bottom),
        style: n,
        children: e
    })], 690019)
}, 651235, e => {
