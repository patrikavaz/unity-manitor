(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 474610, e => {
    ...
    e.s(["camelToDash", 0, t], 969722);
    let r = "data-" + t("framerAppearId");
    e.s(["optimizedAppearDataAttribute", 0, r], 248957)
}, 407093, e => {
    "use strict";
    ...
    "use strict";
    let t = (0, e.i(999721).createContext)(null);
    ...
    e.s(["createMotionComponent", 0, S], 713790);
    let w = function() {
        if ("u" < typeof Proxy) return S;
        let e = new Map,
            t = (e, t) => S(e, t, void 0, void 0);
        return new Proxy((e, r) => t(e, r), {
            get: (r, i) => "create" === i ? t : (e.has(i) || e.set(i, S(i, void 0, void 0, void 0)), e.get(i))
        })
    }();
    ...
    e.s(["m", 0, w], 526826), e.s(["LazyMotion", 0, function({
        children: e,
        features: i,
        strict: o = !1
    }) {
        let [, a] = (0, r.useState)(!M(i)), s = (0, r.useRef)(void 0);
        if (!M(i)) {
            let {
                renderer: e,
                ...t
            } = i;
            s.current = e, (0, m.loadFeatures)(t)
        }
        return (0, r.useEffect)(() => {
            M(i) && i().then(({
                ...
                (0, m.loadFeatures)(t), s.current = e, a(!0)
            })
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "e0025a41-8f17-5243-840b-785a9bea573e")
    } catch (e) {}
}();
//# debugId=e0025a41-8f17-5243-840b-785a9bea573e