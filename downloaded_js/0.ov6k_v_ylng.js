(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 825610, t => {
    "use strict";
    ...
    t.s(["isObject", 0, r], 264250), t.s(["isHTMLElement", 0, function(t) {
        return r(t) && "offsetHeight" in t
    }], 812064)
}, 386376, t => {
    "use strict";
    var r = t.i(3931),
    ...
    t.s(["usePresence", 0, function(t = !0) {
        let n = (0, r.useContext)(e.PresenceContext);
        ...
        let s = (0, r.useCallback)(() => t && o && o(a), [a, o, t]);
        return !i && o ? [!1, s] : [!0]
    }])
}, 583796, t => {
    "use strict";
    ...
    var n = {
            675: function(t, r) {
                ...
                r.byteLength = function(t) {
                    ...
                    var r, e, o = s(t),
                        ...
                        h = 0,
                        c = a > 0 ? f - 4 : f;
                    for (e = 0; e < c; e += 4) r = n[t.charCodeAt(e)] << 18 | n[t.charCodeAt(e + 1)] << 12 | n[t.charCodeAt(e + 2)] << 6 | n[t.charCodeAt(e + 3)], u[h++] = r >> 16 & 255, u[h++] = r >> 8 & 255, u[h++] = 255 & r;
                    return 2 === a && (r = n[t.charCodeAt(e)] << 2 | n[t.charCodeAt(e + 1)] >> 4, u[h++] = 255 & r), 1 === a && (r = n[t.charCodeAt(e)] << 10 | n[t.charCodeAt(e + 1)] << 4 | n[t.charCodeAt(e + 2)] >> 2, u[h++] = r >> 8 & 255, u[h++] = 255 & r), u
                }, r.fromByteArray = function(t) {
                    for (var r, n = t.length, i = n % 3, o = [], f = 0, a = n - i; f < a; f += 16383) o.push(function(t, r, n) {
                ...
                for (var e = [], n = [], i = "u" > typeof Uint8Array ? Uint8Array : Array, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", f = 0, a = o.length; f < a; ++f) e[f] = o[f], n[o.charCodeAt(f)] = f;
            ...
            72: function(t, r, e) {
                ...
                function s(t, r, e) {
                    ...
                    if (null != h && h !== t) return a.from(h, r, e);
                    var d = function(t) {
                        if (a.isBuffer(t)) {
                            var r = 0 | p(t.length),
                                e = f(r);
                    ...
                    if (d) return d;
                    if ("u" > typeof Symbol && null != Symbol.toPrimitive && "function" == typeof t[Symbol.toPrimitive]) return a.from(t[Symbol.toPrimitive]("string"), r, e);
                ...
                }, r.INSPECT_MAX_BYTES = 50, r.kMaxLength = 0x7fffffff, a.TYPED_ARRAY_SUPPORT = function() {
                    try {
                ...
                function y(t, r, e, n, i) {
                    ...
                    if ("string" == typeof r && (r = a.from(r, n)), a.isBuffer(r)) return 0 === r.length ? -1 : v(t, r, e, n, i);
                    if ("number" == typeof r) {
                ...
                a.isBuffer = function(t) {
                    ...
                    if (S(t, Uint8Array) && (t = a.from(t, t.offset, t.byteLength)), S(r, Uint8Array) && (r = a.from(r, r.offset, r.byteLength)), !a.isBuffer(t) || !a.isBuffer(r)) throw TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
                    if (t === r) return 0;
                    ...
                    if (S(t, Uint8Array) && (t = a.from(t, t.offset, t.byteLength)), !a.isBuffer(t)) throw TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof t);
                    ...
                    for (var o = i - n, f = e - r, s = Math.min(o, f), u = this.slice(n, i), h = t.slice(r, e), c = 0; c < s; ++c)
                        if (u[c] !== h[c]) {
                            o = u[c], f = h[c];
                            break
                        } return o < f ? -1 : +(f < o)
                ...
                function m(t, r, e) {
                    ...
                    for (var n = [], i = r; i < e;) {
                        ...
                        if (i + c <= e) switch (c) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                o = t[i + 1], f = t[i + 2], (192 & o) == 128 && (192 & f) == 128 && (s = (15 & u) << 12 | (63 & o) << 6 | 63 & f) > 2047 && (s < 55296 || s > 57343) && (h = s);
                                break;
                            case 4:
                                o = t[i + 1], f = t[i + 2], a = t[i + 3], (192 & o) == 128 && (192 & f) == 128 && (192 & a) == 128 && (s = (15 & u) << 18 | (63 & o) << 12 | (63 & f) << 6 | 63 & a) > 65535 && s < 1114112 && (h = s)
                        }
                    ...
                    for (var d = "", g = 0; g < l;) d += String.fromCharCode.apply(String, p.slice(g, g += 4096));
                    return d
                }
                ...
                a.prototype.write = function(t, r, e, n) {
                    ...
                    var i, o, f, a, s, u, h, c, p = this.length - r;
                    if ((void 0 === e || e > p) && (e = p), t.length > 0 && (e < 0 || r < 0) || r > this.length) throw RangeError("Attempt to write outside buffer bounds");
                    n || (n = "utf8");
                    for (var l = !1;;) switch (n) {
                        case "hex":
                            return function(t, r, e, n) {
                                ...
                                n > o / 2 && (n = o / 2);
                                for (var f = 0; f < n; ++f) {
                                    var a, s = parseInt(r.substr(2 * f, 2), 16);
                                    if ((a = s) != a) break;
                                    t[e + f] = s
                                }
                                return f
                        ...
                        case "utf8":
                        case "utf-8":
                            return i = r, o = e, I(x(t, this.length - i), this, i, o);
                        case "ascii":
                            return f = r, a = e, I(C(t), this, f, a);
                        case "latin1":
                        case "binary":
                            return function(t, r, e, n) {
                                return I(C(r), t, e, n)
                        ...
                        case "base64":
                            return s = r, u = e, I(U(t), this, s, u);
                        case "ucs2":
                        case "ucs-2":
                        case "utf16le":
                        case "utf-16le":
                            return h = r, c = e, I(function(t, r) {
                    ...
                    var o = 0,
                        f = 1,
                        a = 0;
                    for (this[r] = 255 & t; ++o < e && (f *= 256);) t < 0 && 0 === a && 0 !== this[r + o - 1] && (a = 1), this[r + o] = (t / f | 0) - a & 255;
                    return r + e
                    ...
                    var o = e - 1,
                        f = 1,
                        a = 0;
                    for (this[r + o] = 255 & t; --o >= 0 && (f *= 256);) t < 0 && 0 === a && 0 !== this[r + o + 1] && (a = 1), this[r + o] = (t / f | 0) - a & 255;
                    return r + e
                    ...
                    if (r >>>= 0, e = void 0 === e ? this.length : e >>> 0, t || (t = 0), "number" == typeof t)
                        ...
                        var f = a.isBuffer(t) ? t : a.from(t, n),
                            s = f.length;
            ...
            783: function(t, r) {
                r.read = function(t, r, e, n, i) {
                    var o, f, a = 8 * i - n - 1,
                        ...
                        p = e ? -1 : 1,
                        l = t[r + c];
                    for (c += p, o = l & (1 << -h) - 1, l >>= -h, h += a; h > 0; o = 256 * o + t[r + c], c += p, h -= 8);
                    ...
                    var f, a, s, u = 8 * o - i - 1,
                        ...
                        d = n ? 1 : -1,
                        g = +(r < 0 || 0 === r && 1 / r < 0);
                    for (isNaN(r = Math.abs(r)) || r === 1 / 0 ? (a = +!!isNaN(r), f = h) : (f = Math.floor(Math.log(r) / Math.LN2), r * (s = Math.pow(2, -f)) < 1 && (f--, s *= 2), f + c >= 1 ? r += p / s : r += p * Math.pow(2, 1 - c), r * s >= 2 && (f++, s /= 2), f + c >= h ? (a = 0, f = h) : f + c >= 1 ? (a = (r * s - 1) * Math.pow(2, i), f += c) : (a = r * Math.pow(2, c - 1) * Math.pow(2, i), f = 0)); i >= 8; t[e + l] = 255 & a, l += d, a /= 256, i -= 8);
                    for (f = f << i | a, u += i; u > 0; t[e + l] = 255 & f, l += d, f /= 256, u -= 8);
                    t[e + l - d] |= 128 * g
                }
            }
        },
                ...
                return u.withOptions = function(e) {
                    ...
                    return function(t) {
                        ...
                        var s = function(t) {
                            ...
                            u = Math.round(a.crop.left * s.width),
                            h = Math.round(a.crop.top * s.height),
                            c = {
                                left: u,
                                top: h,
                                width: Math.round(s.width - a.crop.right * s.width - u),
                                height: Math.round(s.height - a.crop.bottom * s.height - h)
                            },
                            p = a.hotspot.height * s.height / 2,
                            l = a.hotspot.width * s.width / 2,
                            d = a.hotspot.x * s.width,
                            g = a.hotspot.y * s.height;
                        return o.rect || o.focalPoint || o.ignoreImageParams || o.crop || (o = r({}, o, function(t, r) {
                                ...
                                if (o.width / o.height > a) {
                                    var s = Math.round(o.height),
                                        ...
                                        c = Math.max(0, Math.round(Math.round((f.right - f.left) / 2 + f.left) - u / 2));
                                    c < o.left ? c = o.left : c + u > o.left + o.width && (c = o.left + o.width - u), e = {
                                        left: c,
                                        top: h,
                                        width: u,
                                        height: s
                                    ...
                                    var p = o.width,
                                        ...
                                        g = Math.max(0, Math.round(Math.round((f.bottom - f.top) / 2 + f.top) - l / 2));
                                    g < o.top ? g = o.top : g + l > o.top + o.height && (g = o.top + o.height - l), e = {
                                        left: d,
                                        top: g,
                                        width: p,
                                        height: l
                            ...
                            function(t) {
                                ...
                                if (t.rect) {
                                    var a = t.rect,
                                        ...
                                        h = a.width,
                                        c = a.height;
                                    (0 !== s || 0 !== u || c !== t.asset.height || h !== t.asset.width) && f.push("rect=" + s + "," + u + "," + h + "," + c)
                                }
                                ...
                                return (p && f.push("flip=" + p), i.forEach(function(r) {
                                    var e = r[0],
                                        n = r[1];
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "23b36a2f-9fb6-50b8-9444-16094c15c741")
    } catch (e) {}
}();
//# debugId=23b36a2f-9fb6-50b8-9444-16094c15c741