(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 583877, e => {
    "use strict";
    var t = e.i(785328),
        l = e.i(833200),
        a = e.i(722978),
    ...
    e.s(["default", 0, ({
        ...
        let N, L = -1 !== (N = window.navigator.userAgent).indexOf("Win") ? "Windows" : -1 !== N.indexOf("Mac") ? "Mac" : -1 !== N.indexOf("Linux") ? "Linux" : "Unknown",
            ...
            F = (0, l.useMemo)(() => (b?.data ?? []).map(e => e?.value?.text ? {
                value: {
                    type: "text",
                    text: e.value.text
                },
        ...
        let B = p ?? void 0,
            ...
            A = e => {
                let t = e.link?.linkReference?.href?.current,
                    l = t ? (0, d.default)(t, M, e.extendLink) : t,
            ...
            P = m?.filter(e => !e.operatingSystem || e.operatingSystem === L) || [],
            z = m?.filter(e => !!e.operatingSystem && "Unknown" !== e.operatingSystem) || [];
        return (0, t.jsx)(t.Fragment, {
            children: !y && (0, t.jsx)("section", {
                ...
                children: (0, t.jsx)("div", {
                    ...
                    children: (0, t.jsxs)(a.default, {
                        ...
                        variant: B,
                        keyFigures: F,
                        children: [g && (0, t.jsx)(a.default.Media, {
                            media: g,
                            variant: B
                        }), !g && j && (0, t.jsx)(a.default.YouTubeVideo, {
                            autoplay: !0,
                            url: j?.url,
                            title: j?.title,
                                ...
                                children: (0, t.jsx)(a.default.Actions, {
                                    ...
                                    children: P.map((e, a) => {
                                        let i = S[a],
                                            ...
                                            c = (0, d.default)(n, M, e.extendLink),
                                            o = 0 === a,
                                            u = n.endsWith(".exe") || n.endsWith(".dmg"),
                                            f = !!e.secondaryLink?.linkReference?.href?.current,
                                            m = c && !u && !f;
                                        return i?.form ? I(e, i, a) : (0, t.jsxs)(l.default.Fragment, {
    ...
    let p = ({
            ...
            let _ = (0, g.default)(`(min-width: ${u.default.Medium}px)`),
                ...
                F = null;
            "youtube" === h ? F = (0, c.default)(() => e.A(574228), {
                loadableGenerated: {
                    modules: [10770]
                },
                ssr: !1
            }) : "brandfolder" === h && (F = (0, c.default)(() => e.A(104688), {
                loadableGenerated: {
                    modules: [425687]
                },
                ssr: !1
            ...
            return (0, t.jsxs)("div", {
                ...
                children: [_ && (0, t.jsx)("div", {
                    ...
                    children: (0, t.jsxs)(s.m.div, {
                        ...
                        }), ["youtube.com", "youtu.be"].some(e => y?.src?.includes(e)) && (0, t.jsx)(x.default, {
                            blockedMessage: N,
                            consentButtonLabel: L
                        })]
                    })
