    ...
    var e$ = function() {
        ...
        return e.prototype.getColorAsync = function(e, t) {
            ...
            if ("string" == typeof e) {
                ...
                var l = this.bindImageEvents(a, t);
                return a.src = e, l
            }
            ...
            return new Promise(function(l, r) {
                var n = function() {
                        e.removeEventListener("load", i), e.removeEventListener("error", s), e.removeEventListener("abort", o)
                    },
                    i = function() {
                        n();
                    ...
                    s = function() {
                        n(), r(ez('Error loading image "'.concat(e.src, '"')))
                    },
                    o = function() {
                        n(), r(ez('Image "'.concat(e.src, '" loading aborted')))
                    };
                e.addEventListener("load", i), e.addEventListener("error", s), e.addEventListener("abort", o), e.src && e.complete && i()
            })
        }, e
    }();
