(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 480880, e => {
    ...
    e.s(["useMTBanner", 0, function(e, r = []) {
        var s, i;
        let n, d, o, c, u, f = (0, t.usePathname)(),
            m = (0, l.useLocale)(),
            h = m !== a.defaultLocale ? f.replace(`/${m}`, "") : f;
        return {
            shouldDisplayMTBanner: m !== a.defaultLocale && e?.translationType === "MT" && !r.includes(h),
    ...
    let i = ({
            ...
            let f = (0, a.useMemo)(() => `unity-alert-${i?.substring(0,30).replaceAll(" ","_")}`, [i]),
                [m, h] = (0, a.useState)(!0),
                [x, g] = (0, a.useState)(!1);
    ...
    f.Actions = ({
        ...
        let {
            image: c,
            video: u
        } = e || {}, [f, m] = (0, l.useState)(!1), h = (0, l.useRef)(null), x = "gdc2026" === i ? "object-cover" : "object-contain", g = (0, r.default)("relative flex grow", {
    ...
    e.s(["default", 0, ({
        ...
        let P = o ?? void 0,
            ...
            B = s?.filter(e => !e.operatingSystem || e.operatingSystem === L) || [],
            E = s?.filter(e => !!e.operatingSystem && "Unknown" !== e.operatingSystem) || [];
        return (0, t.jsx)(t.Fragment, {
    ...
    let k = (0, s.default)(() => e.A(410979), {
        ...
        N = ({
            ...
            let [i, o] = (0, n.useState)(void 0), [c, u] = (0, n.useState)(void 0), [f, m] = (0, n.useState)(1), [h, g] = (0, n.useState)(0), [p, v] = (0, n.useState)(0), b = (0, n.useRef)(null), k = (0, n.useRef)(null), N = (0, n.useRef)(null), _ = (0, r.useReducedMotion)();
            (0, n.useEffect)(() => {
            ...
            let L = (0, n.useCallback)((e, t) => {
                ...
                S = (0, n.useMemo)(() => a.map((e, l) => (0, t.jsx)("div", {
                    children: (0, t.jsxs)("div", {
                        className: "max-w-lg",
                        children: [(0, t.jsx)("h3", {
                ...
                $ = (0, n.useMemo)(() => a.map((e, l) => (0, t.jsx)(w, {
                    slide: e,
                    index: l,
                    isActive: h === l,
    ...
    let p = ({
            ...
            let R = (0, h.default)(`(min-width: ${u.default.Medium}px)`),
                ...
                T = null;
            "youtube" === g ? T = (0, o.default)(() => e.A(269100), {
                loadableGenerated: {
                    modules: [346003]
                },
                ssr: !1
            }) : "brandfolder" === g && (T = (0, o.default)(() => e.A(410979), {
                loadableGenerated: {
                    modules: [942019]
                },
                ssr: !1
            ...
            }), z = (0, s.useTransform)(P, [0, 1], ["60%", "100%"]), O = (0, s.useTransform)(P, [0, 1], [1.75, 1]), B = (0, s.useTransform)(P, [0, 1], ["brightness(50%)", "brightness(100%)"]), E = () => {
                k && "brandfolder" === g && A(!0)
            }, I = () => {
                A(!0)
            }, U = (0, d.default)("top-0 left-0 h-full w-full absolute z-10 transition-opacity duration-500 object-cover", {
                "opacity-0 pointer-events-none": C && !$ && S && y?.src
            });
            return (0, t.jsxs)("div", {
                ref: M,
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "35920b2b-9491-58d5-9c48-aae6a114e68d")
    } catch (e) {}
}();
//# debugId=35920b2b-9491-58d5-9c48-aae6a114e68d