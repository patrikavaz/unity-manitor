(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 998569, e => {
    ...
    let f = (0, r.forwardRef)(function({
        ...
        let k = (0, u.useObjectRef)(O),
            ...
            }),
            {
                ...
                onFocusChange(e) {
                    j(e && (0, l.isFocusVisible)() || !1)
                }
            }),
            C = (0, o.clsx)("btn-outlined cursor-pointer flex justify-start items-center outline-hidden border-solid border-2 rounded-full overflow-hidden", {
                primary: "btn-primary",
            ...
            L = (0, o.clsx)("w-full transition-all duration-300 shrink-0 ", {
                "fill-gray-400": g
            }),
            M = (0, o.clsx)(L, {
            ...
            R = (0, o.clsx)(L, "fill-black dark:fill-white");
        if (v) {
            let e = (0, c.mergeProps)(T, E, _);
            return (0, t.jsxs)(n.Link, {
                ...e,
                ref: k,
                "aria-label": f,
                className: C,
        ...
        function n() {
            for (var e = "", t = 0; t < arguments.length; t++) {
                ...
                i && (e = o(e, function(e) {
                    ...
                    var t = "";
                    for (var i in e) r.call(e, i) && e[i] && (t = o(t, i));
                    return t
                }(i)))
            }
            return e
    ...
    Object.defineProperty(r, "__esModule", {
        value: !0
    }), r.checkSpecKeys = r.checkNavigable = r.changeSlide = r.canUseDOM = r.canGoNext = void 0, r.clamp = s, r.swipeStart = r.swipeMove = r.swipeEnd = r.slidesOnRight = r.slidesOnLeft = r.slideHandler = r.siblingDirection = r.safePreventDefault = r.lazyStartIndex = r.lazySlidesOnRight = r.lazySlidesOnLeft = r.lazyEndIndex = r.keyHandler = r.initializedState = r.getWidth = r.getTrackLeft = r.getTrackCSS = r.getTrackAnimateCSS = r.getTotalSlides = r.getSwipeDirection = r.getSlideCount = r.getRequiredLazySlides = r.getPreClones = r.getPostClones = r.getOnDemandLazySlides = r.getNavigableIndexes = r.getHeight = r.extractObject = void 0;
    var n, o = (n = e.r(999721)) && n.__esModule ? n : {
        default: n
    };
    ...
    r.safePreventDefault = l;
    var c = function(e) {
        for (var t = [], r = u(e), n = d(e), o = r; o < n; o++) 0 > e.lazyLoadedList.indexOf(o) && t.push(o);
        return t
    };
    r.getOnDemandLazySlides = c, r.getRequiredLazySlides = function(e) {
    ...
    var v = function(e) {
        ...
        if (t = e.startX - e.curX, (r = Math.round(180 * Math.atan2(e.startY - e.curY, t) / Math.PI)) < 0 && (r = 360 - Math.abs(r)), r <= 45 && r >= 0 || r <= 360 && r >= 315) return "left";
        if (r >= 135 && r <= 225) return "right";
        if (!0 === n)
            if (r >= 35 && r <= 135) return "up";
            else return "down";
        return "vertical"
    };
    r.getSwipeDirection = v;
    var b = function(e) {
        var t = !0;
        return !e.infinite && (e.centerMode && e.currentSlide >= e.slideCount - 1 ? t = !1 : (e.slideCount <= e.slidesToShow || e.currentSlide >= e.slideCount - e.slidesToShow) && (t = !1)), t
    };
    r.canGoNext = b, r.extractObject = function(e, t) {
        var r = {};
        return t.forEach(function(t) {
            return r[t] = e[t]
        }), r
    }, r.initializedState = function(e) {
        ...
        if (n) {
            if (!o && (i < 0 || i >= l)) return {};
            i < 0 ? S = i + l : i >= l && (S = i - l), u && 0 > v.indexOf(S) && (v = v.concat(S)), j = {
                animating: !0,
                currentSlide: S,
                lazyLoadedList: v,
                targetSlide: S
        ...
        } else g = S, S < 0 ? (g = S + l, o ? l % p != 0 && (g = l - l % p) : g = 0) : !b(e) && S > d ? S = g = d : f && S >= l ? (S = o ? l : l - 1, g = o ? 0 : l - 1) : S >= l && (g = S - l, o ? l % p != 0 && (g = 0) : g = l - h), !o && S + h >= l && (g = l - h), m = x(a(a({}, e), {}, {
            slideIndex: S
        })), w = x(a(a({}, e), {}, {
            slideIndex: g
        ...
        if (!r) {
            ...
            var M = Math.ceil(g / m),
                R = v(t.touchObject, s),
                z = S.swipeLength;
            return !w && (0 === u && ("right" === R || "down" === R) || u + 1 >= M && ("left" === R || "up" === R) || !b(t) && ("left" === R || "up" === R)) && (z = S.swipeLength * d, !1 === f && p && (p(R), P.edgeDragged = !0)), !h && k && (k(R), P.swiped = !0), E = o ? _ + j / T * z * L : c ? _ - z * L : _ + z * L, s && (E = _ + z * L), P = a(a({}, P), {}, {
                touchObject: S,
                swipeLeft: E,
                trackStyle: O(a(a({}, t), {}, {
                    left: E
                }))
            }), Math.abs(S.curX - S.startX) < .8 * Math.abs(S.curY - S.startY) || S.swipeLength > 10 && (P.swiping = !0, l(e)), P
        }
    }, r.swipeEnd = function(e, t) {
        var r = t.dragging,
            n = t.swipe,
            o = t.touchObject,
            i = t.listWidth,
        ...
        if (o.swipeLength > g) {
            ...
            switch (S) {
                case "left":
                case "up":
                    T = E + w(t), j = d ? m(t, T) : T, O.currentDirection = 0;
                    break;
                case "right":
                case "down":
                    T = E - w(t), j = d ? m(t, T) : T, O.currentDirection = 1;
                    break;
                default:
                    j = E
            }
            O.triggerSlideHandler = j
        } else {
            var P = x(t);
    ...
    var O = function(e) {
        ...
        e.vertical ? r = n * e.slideHeight : t = E(e) * e.slideWidth;
        var o = {
            opacity: 1,
            transition: "",
            WebkitTransition: ""
    ...
    var x = function(e) {
        ...
        var v = 0;
        if (n ? (v = -j(e), i % s != 0 && t + s > i && (v = -(t > i ? a - (t - i) : i % s)), o && (v += parseInt(a / 2))) : (i % s != 0 && t + s > i && (v = a - i % s), o && (v = parseInt(a / 2))), h = v * l, y = v * d, b = p ? -(t * d * 1) + y : -(t * l * 1) + h, !0 === u) {
            var b, g, m, w = r && r.node;
            if (m = t + j(e), b = (g = w && w.childNodes[m]) ? -1 * g.offsetLeft : 0, !0 === o) {
                m = n ? t + j(e) : t, g = w && w.children[m], b = 0;
    ...
    r.slidesOnLeft = C, r.canUseDOM = function() {
    ...
    var y = function(e) {
        ...
        g = function(e) {
            ...
            return (o.default.Children.forEach(e.children, function(d, f) {
                ...
                h = !e.lazyLoad || e.lazyLoad && e.lazyLoadedList.indexOf(f) >= 0 ? d : o.default.createElement("div", null);
                var m = v(p(p({}, e), {}, {
                        index: f
                    })),
                    w = h.props.className || "",
                ...
                if (r.push(o.default.cloneElement(h, {
                        key: "original" + b(h, f),
                        "data-index": f,
                        ...
                        onClick: function(t) {
                            h.props && h.props.onClick && h.props.onClick(t), e.focusOnSelect && e.focusOnSelect(g)
                        }
                    })), e.infinite && !1 === e.fade) {
                    var O = l - f;
                    O <= (0, a.getPreClones)(e) && l !== e.slidesToShow && ((t = -O) >= c && (h = d), S = y(p(p({}, e), {}, {
                        index: t
                    })), n.push(o.default.cloneElement(h, {
                        key: "precloned" + b(h, t),
                        "data-index": t,
                        tabIndex: "-1",
                        className: (0, i.default)(S, w),
                        "aria-hidden": !S["slick-active"],
                        style: p(p({}, h.props.style || {}), m),
                        onClick: function(t) {
                            h.props && h.props.onClick && h.props.onClick(t), e.focusOnSelect && e.focusOnSelect(g)
                        }
                    }))), l !== e.slidesToShow && ((t = l + f) < u && (h = d), S = y(p(p({}, e), {}, {
                        index: t
                    })), s.push(o.default.cloneElement(h, {
    ...
    r.Track = function(e) {
        ...
        var t, r, i = (t = function() {
            ...
            var e, r = d(a);
            return e = t ? Reflect.construct(r, arguments, d(this).constructor) : r.apply(this, arguments),
                function(e, t) {
        ...
        function a() {
            ...
            return h(u(e = i.call.apply(i, [this].concat(r))), "node", null), h(u(e), "handleRef", function(t) {
                e.node = t
            }), e
        }
        return r = [{
            ...
            }(a.prototype, r), Object.defineProperty(a, "prototype", {
                writable: !1
            }), a
    ...
    r.Dots = function(e) {
        ...
        var t, r, s = (t = function() {
            ...
            var e, r = u(f);
            return e = t ? Reflect.construct(r, arguments, u(this).constructor) : r.apply(this, arguments),
                function(e, t) {
                    if (t && ("object" === n(t) || "function" == typeof t)) return t;
                    if (void 0 !== t) throw TypeError("Derived constructors may only return object or undefined");
                    var r = e;
        ...
        return r = [{
                ...
                key: "render",
                value: function() {
                    for (var e = this.props, t = e.onMouseEnter, r = e.onMouseOver, n = e.onMouseLeave, s = e.infinite, c = e.slidesToScroll, u = e.slidesToShow, f = e.slideCount, p = e.currentSlide, h = d({
                            slideCount: f,
                            slidesToScroll: c,
                            slidesToShow: u,
                            infinite: s
                        ...
                        var b = (v + 1) * c - 1,
                            g = s ? b : (0, a.clamp)(b, 0, f - 1),
                            m = g - (c - 1),
                            w = s ? m : (0, a.clamp)(m, 0, f - 1),
                            S = (0, i.default)({
                                "slick-active": s ? p >= w && p <= g : p === w
                            }),
                            O = {
                                message: "dots",
                                index: v,
            ...
            }(f.prototype, r), Object.defineProperty(f, "prototype", {
                writable: !1
            }), f
    }(o.default.PureComponent)
}, 563220, (e, t, r) => {
    ...
    function v(e) {
        ...
        return function() {
            var r, o = b(e);
            return r = t ? Reflect.construct(o, arguments, b(this).constructor) : o.apply(this, arguments),
                function(e, t) {
                    if (t && ("object" === n(t) || "function" == typeof t)) return t;
                    if (void 0 !== t) throw TypeError("Derived constructors may only return object or undefined");
                    var r = e;
    ...
    }(o.default.PureComponent), r.NextArrow = function(e) {
        h(r, e);
        var t = v(r);
    ...
    var t = function() {
        ...
        r = "u" > typeof window && "u" > typeof document && window.document === document,
        n = e.g.Math === Math ? e.g : "u" > typeof self && self.Math === Math ? self : "u" > typeof window && window.Math === Math ? window : Function("return this")(),
    ...
    var p = "u" > typeof SVGGraphicsElement ? function(e) {
    ...
    var y = function() {
            ...
            return e.prototype.isActive = function() {
                var e = function(e) {
                    ...
                    if (p(e)) {
                        var t;
                        return h(0, 0, (t = e.getBBox()).width, t.height)
                    }
                    return function(e) {
                        var t, r = e.clientWidth,
                            n = e.clientHeight;
                        if (!r && !n) return u;
                        var o = c(e).getComputedStyle(e),
                            ...
                            l = d(o.width),
                            p = d(o.height);
                        if ("border-box" === o.boxSizing && (Math.round(l + a) !== r && (l -= f(o, "left", "right") + a), Math.round(p + s) !== n && (p -= f(o, "top", "bottom") + s)), (t = e) !== c(t).document.documentElement) {
                            var y = Math.round(l + a) - r,
                                v = Math.round(p + s) - n;
                            1 !== Math.abs(y) && (l -= y), 1 !== Math.abs(v) && (p -= v)
                        }
                        return h(i.left, i.top, l, p)
                    }(e)
                }(this.target);
        ...
        v = function(e, t) {
            var r, n, o, i, a, s = (r = t.x, n = t.y, o = t.width, i = t.height, l(a = Object.create(("u" > typeof DOMRectReadOnly ? DOMRectReadOnly : Object).prototype), {
                x: r,
                y: n,
                width: o,
                height: i,
        ...
        b = function() {
            function e(e, r, n) {
                if (this.activeObservations_ = [], this.observations_ = new t, "function" != typeof e) throw TypeError("The callback provided as parameter 1 is not a function.");
            ...
            return e.prototype.observe = function(e) {
                ...
                if (!("u" < typeof Element) && Element instanceof Object) {
                    if (!(e instanceof c(e).Element)) throw TypeError('parameter 1 is not of type "Element".');
        ...
        g = "u" > typeof WeakMap ? new WeakMap : new t,
        m = function e(t) {
            if (!(this instanceof e)) throw TypeError("Cannot call a class as a function.");
            if (!arguments.length) throw TypeError("1 argument required, but only 0 present.");
            var r = new b(t, s.getInstance(), this);
            g.set(this, r)
        };
    ...
    var w = void 0 !== n.ResizeObserver ? n.ResizeObserver : m;
    e.s(["default", 0, w])
}, 286986, (e, t, r) => {
    "use strict";
    Object.defineProperty(r, "__esModule", {
        value: !0
    }), r.InnerSlider = void 0;
    var n = f(e.r(999721)),
        o = f(e.r(543768)),
        i = f(e.r(351853)),
        a = f(e.r(264458)),
    ...
    r.InnerSlider = function(e) {
        ...
        var t, r, f = (t = function() {
            ...
            var e, r = m(y);
            return e = t ? Reflect.construct(r, arguments, m(this).constructor) : r.apply(this, arguments),
                function(e, t) {
        ...
        function y(e) {
            if (!(this instanceof y)) throw TypeError("Cannot call a class as a function");
            w(g(t = f.call(this, e)), "listRefHandler", function(e) {
            ...
            }), w(g(t), "updateState", function(e, r, o) {
                ...
                return t.props.unslick && (k = {
                    ...
                    className: i
                }), n.default.createElement("div", x, t.props.unslick ? "" : r, n.default.createElement("div", h({
        ...
        return r = [{
            ...
            }(y.prototype, r), Object.defineProperty(y, "prototype", {
                writable: !1
            }), y
    }(n.default.Component)
}, 103449, (e, t, r) => {
    ...
    var b = (0, l.canUseDOM)() && e.r(659188);
    r.default = function(e) {
        ...
        var t, r, c = (t = function() {
            ...
            var e, r = y(d);
            return e = t ? Reflect.construct(r, arguments, y(this).constructor) : r.apply(this, arguments),
                function(e, t) {
                    if (t && ("object" === n(t) || "function" == typeof t)) return t;
                    if (void 0 !== t) throw TypeError("Derived constructors may only return object or undefined");
                    return h(e)
        ...
        function d(e) {
            ...
            return v(h(t = c.call(this, e)), "innerSliderRefHandler", function(e) {
                return t.innerSlider = e
            }), v(h(t), "slickPrev", function() {
                return t.innerSlider.slickPrev()
            }), v(h(t), "slickNext", function() {
                return t.innerSlider.slickNext()
            }), v(h(t), "slickGoTo", function(e) {
                var r = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                return t.innerSlider.slickGoTo(e, r)
            }), v(h(t), "slickPause", function() {
                return t.innerSlider.pause("paused")
            }), v(h(t), "slickPlay", function() {
        ...
        return r = [{
            ...
            }(d.prototype, r), Object.defineProperty(d, "prototype", {
                writable: !1
            }), d
    }(o.default.Component)
}, 803695, (e, t, r) => {
    ...
    Object.defineProperty(r, "__esModule", {
        value: !0
    }), r.default = void 0, r.default = ((n = e.r(906786)) && n.__esModule ? n : {
        default: n
    }).default
}, 387660, e => {
    "use strict";
    ...
    var t = e.i(999721),
        ...
        n = t.forwardRef(function(e, n) {
            var o = t.useState(!1),
                ...
                b = e.webp ? "webp" : "jpg",
                g = e.webp ? "vi_webp" : "vi",
                m = e.thumbnail || (e.playlist ? "https://i.ytimg.com/".concat(g, "/").concat(d, "/").concat(p, ".").concat(b) : "https://i.ytimg.com/".concat(g, "/").concat(u, "/").concat(p, ".").concat(b)),
                w = e.noCookie ? "https://www.youtube-nocookie.com" : "https://www.youtube.com";
            w = e.cookie ? "https://www.youtube.com" : "https://www.youtube-nocookie.com";
            var S = e.playlist ? "".concat(w, "/embed/videoseries?autoplay=1").concat(y, "&list=").concat(u).concat(h) : "".concat(w, "/embed/").concat(u, "?autoplay=1&state=1").concat(y).concat(h),
                O = e.activatedClass || "lyt-activated",
                k = e.adNetwork || !1,
                x = e.aspectHeight || 9,
                j = e.aspectWidth || 16,
                T = e.iframeClass || "",
            ...
            return t.useEffect(function() {
                ...
                href: m,
                as: "image"
            }), t.createElement(t.Fragment, null, i && t.createElement(t.Fragment, null, t.createElement("link", {
                rel: "preconnect",
                href: w
                ...
                className: "".concat(P, " ").concat(l ? O : ""),
                "data-title": f,
                style: r({
                    backgroundImage: "url(".concat(m, ")")
                }, {
                    "--aspect-ratio": "".concat(x / j * 100, "%")
                })
            }, t.createElement("button", {
                type: "button",
                className: E,
                "aria-label": "".concat(v, " ").concat(f)
    ...
    e.s(["default", 0, ({
        ...
        return (0, t.jsx)(t.Fragment, {
            children: !(() => {
                let [e] = (0, o.default)("OptanonConsent") || "", t = {};
    ...
    var t = e.i(210139),
        ...
        d = e.i(387660);
    let f = (e, t = !0) => {
        let [n, o] = (0, r.useState)(null);
        return (0, r.useEffect)(() => {
            let r;
            return t && e.current && (r = setInterval(() => {
                let t = window.YT;
                t && e.current && (o(new t.Player(e.current)), clearInterval(r))
            }, 500)), () => {
                o(null), clearInterval(r)
            }
        }, [t, e]), {
            player: n
        }
    ...
    e.s(["useYoutubeAPI", 0, f], 934172), e.s(["default", 0, ({
        ...
        return (0, r.useEffect)(() => {
            O && (S.current = O.addEventListener("onStateChange", e => {
                if ([1, 2].includes(e.data)) {
                    let t = "function" == typeof O.getDuration && O.getDuration() || 0,
                        r = Number((("function" == typeof O.getCurrentTime && O.getCurrentTime() || 0) / t * 100).toFixed(2)),
            ...
            if (!g && O?.playerInfo?.playerState === 1) {
                let e = "function" == typeof O.getDuration && O.getDuration() || 0,
                    t = Number((("function" == typeof O.getCurrentTime && O.getCurrentTime() || 0) / e * 100).toFixed(2));
                (0, d.pushVideoEvent)({
                    name: "video_pause",
                    videoDuration: e,
    ...
    let o = ({
            ...
            } [e], l = (0, r.default)("inline-block", "rounded-full overflow-hidden relative shrink-0 mr-3 hidden lg:block md:block");
            return (0, t.jsx)("div", {
                className: l,
                children: (0, t.jsx)(n.default, {
                    src: o,
        ...
        i = ({
            ...
            let l = (0, r.default)("text-gray-900 dark:text-gray-100 pb-1", {
                    "loco-caption-lg-semibold": "m" === s,
                    "loco-caption-sm-semibold": "s" === s || "xs" === s || "xxs" === s
                }),
                c = (0, r.default)("text-gray-700 dark:text-gray-300 tracking-normal", {
                    "loco-text-body-xs-semibold": "m" === s,
                    "loco-text-body-sm-medium": "s" === s || "xs" === s || "xxs" === s
                });
            return (0, t.jsxs)("div", {
                className: "flex items-center",
                children: [e && (0, t.jsx)(o, {
                    url: e,
                    size: s,
                    alt: n
                }), (0, t.jsxs)("div", {
                    ...
                    children: [(0, t.jsxs)("span", {
                        className: l,
                        children: [n?.toUpperCase(), " ", i && n && "/" || "", " ", i?.toUpperCase()]
                    }), (0, t.jsx)("span", {
                        className: c,
                        children: a
                    })]
    ...
    let a = ({
            ...
            let s = (0, r.default)("p-6 rounded-xl", o),
                l = (0, r.default)("mb-6 text-gray-800 dark:text-gray-200", a);
            return (0, t.jsxs)("div", {
                className: s,
                children: [(0, t.jsx)("div", {
                    className: l,
        ...
        s = ({
            ...
            let l = (0, r.default)({
                ...
                c = (0, r.default)("one-layout" !== o && "flex flex-col justify-between w-full", {
                    "bg-gray-100 dark:bg-gray-900": "default" === i
                }, {
                    "border border-gray-200 dark:border-gray-700": "outlined" === i && !e
                }),
                u = (0, r.default)({
                    "auto-rows-fr": "one-layout" !== o
                }, "grid grid-cols-12 gap-4", s),
                ...
                f = (0, r.default)({
                    "loco-text-body-sm-medium": "two-layout" === o || "three-layout" === o,
                    "loco-text-body-lg-medium": "one-layout" === o
                });
            return (0, t.jsxs)("div", {
                className: d,
            ...
            children: !l && (0, t.jsx)("section", {
                ...
                children: (0, t.jsx)("div", {
                    ...
                    children: (0, t.jsx)(s, {
                        ...
                        testimonialVariant: "outlined" === n ? "outlined" : "default"
                    })
                })
            })
        })
                ...
                children: (0, t.jsx)("div", {
                    ...
                    children: (0, t.jsxs)("div", {
                        ...
                        children: [(0, t.jsx)("iframe", {
                            ...
                            src: `${p}?#view=fit&navpanes=0${i?"&toolbar=0":""}`,
                            title: l ?? ""
                        }), v && (0, t.jsx)("div", {
    ...
    e.s(["default", 0, ({
        ...
        } = (0, o.default)(), u = (0, r.useCallback)(e => {
            let t = c(e, s);
            return t || e
        }, [s, c]), d = (0, r.useMemo)(() => {
            let e = l.rows.map(e => (e.cells = e.cells.map(e => u(e)), e));
            return {
                ...l,
                rows: e
            }
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "cffc17bf-5f71-5ff8-9886-137d55e4968e")
    } catch (e) {}
}();
//# debugId=cffc17bf-5f71-5ff8-9886-137d55e4968e