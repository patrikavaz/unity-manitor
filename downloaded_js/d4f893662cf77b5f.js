(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 274316, e => {
    ...
    let x = (0, h.default)(() => e.A(969945), {
        ...
        v = ({
            ...
            let i = (0, s.useRef)(null),
                ...
                L = (0, m.useTransform)(y, [0, 1], ["-10vh", "-47.5vh"]),
                C = (0, m.useTransform)(y, [0, .9], [1, 0]),
    ...
    let V = {
        ...
        G = ({
            ...
            let [v, b] = (0, s.useState)(o), j = u ? V[u.toUpperCase()] || u : void 0, y = new Intl.DateTimeFormat(p, {
                month: "short",
                day: "numeric",
                timeZone: j
    ...
    var t = e.i(615167),
        ...
        n = e.i(291158),
        o = e.i(78070);
    let d = (0, e.i(614909).default)(() => e.A(969945), {
            loadableGenerated: {
                modules: [170438]
            },
            ssr: !1
        ...
        f = ({
            ...
            let c = (0, r.default)("absolute inset-0 transition-opacity duration-500", i ? "opacity-100 z-10" : "pointer-events-none opacity-0"),
                u = (0, t.jsxs)(t.Fragment, {
                    children: [(0, t.jsx)(l.default, {
                        ...
                        fill: !0,
                        sizes: a,
                        className: (0, r.default)("object-cover", d && "brightness-75"),
                        ...e.placeholder ? {
                            placeholder: "blur",
            ...
            return s ? (0, t.jsx)("button", {
                ...
                className: `group block w-full ${c}`,
                onClick: s,
                children: u
            }) : (0, t.jsx)("div", {
                className: c,
    ...
    e.s(["default", 0, ({
        ...
        let g = (0, a.useRef)(null),
            ...
            S = v ? j : p && !x,
            T = !!r?.src && !(w && N),
            M = o ? "string" == typeof o ? o : j ? o.playing : o.paused : "none",
            R = v ? () => C(!0) : void 0;
        return (0, t.jsxs)("div", {
            ref: g,
            className: m ?? "relative aspect-video w-full overflow-hidden rounded-2xl bg-mango-black",
    ...
    e.s(["useMotionValueEvent", () => f], 268961);
    var g = e.i(749583),
        p = e.i(2062),
        x = e.i(954936),
        v = e.i(14452);
    let b = (0, s.default)(() => e.A(969945), {
            loadableGenerated: {
                modules: [170438]
            },
            ssr: !1
    ...
    j.Block = ({
        ...
        let [k, N] = (0, l.useState)(!1), [L, C] = (0, l.useState)(!1), S = (0, l.useRef)(null), T = (0, m.useInView)(S, {
            once: !0
        }), M = (0, h.useReducedMotion)(), R = 1 / w * y, E = .75 * R, {
            scrollYProgress: D
        } = (0, d.useScroll)({
            target: S
        }), I = (0, c.useTransform)(D, [R, y !== w - 1 ? R + E : 1], [0, 1], {
            ease: u.easeInOut
        }), z = (0, c.useTransform)(D, [R, y !== w - 1 ? R + E : 1], [100, 0], {
            ease: u.easeInOut
        }), A = -((S.current?.offsetHeight || 0) / w) * y;
        f(D, "change", e => {
            N(e >= R)
        });
        let H = (0, i.default)("object-cover transition-opacity duration-1000", {
                "opacity-0": L
            }),
            P = (0, t.jsx)("div", {
                        ...
                        case 5:
                            if (function(e, t, a) {
                                    var l = a[0],
                                        ...
                                        o = e[t + 3],
                                        d = T(o, s, n);
                                    return s ? !!(!o && d || T(e[t], l, n) && T(e[t + 1], r, n) && T(e[t + 2], i, n) && d) : d
                                }(e, t, a)) return !0;
                            break;
                        default:
                            return !1
    ...
    function z(e) {
        var t, a, l;
        return (t = e, "u" > typeof HTMLCanvasElement && t instanceof HTMLCanvasElement) ? "canvas" : (a = e, H && a instanceof OffscreenCanvas) ? "offscreencanvas" : P(e) ? "videoframe" : (l = e, "u" > typeof ImageBitmap && l instanceof ImageBitmap) ? "imagebitmap" : e.src
    }

    function A(e) {
        return "u" > typeof HTMLImageElement && e instanceof HTMLImageElement
    }
    var H = "u" > typeof OffscreenCanvas;
    ...
    var _ = function() {
        ...
        return e.prototype.getColorAsync = function(e, t) {
            if (!e) return Promise.reject(B("call .getColorAsync() without resource"));
            if ("string" == typeof e) {
                if ("u" < typeof Image) return Promise.reject(B("resource as string is not supported in this environment"));
                var a = new Image;
                return a.crossOrigin = t && t.crossOrigin || "", a.src = e, this.bindImageEvents(a, t)
            }
            if (A(e) && !e.complete) return this.bindImageEvents(e, t);
            var l = this.getColor(e, t);
            return l.error ? Promise.reject(l.error) : Promise.resolve(l)
        }, e.prototype.getColor = function(e, t) {
            var a, l, r, i, s, n, o, d, c = D(t = t || {});
            if (!e) {
                var u = B("call .getColor() without resource");
            ...
            }(e), r = I(l = t, "left", 0), i = I(l, "top", 0), s = I(l, "width", a.width), n = I(l, "height", a.height), o = s, d = n, "precision" === l.mode || (s > n ? d = Math.round((o = 100) / (s / n)) : o = Math.round((d = 100) / (n / s)), (o > s || d > n || o < 10 || d < 10) && (o = s, d = n)), {
                srcLeft: r,
                srcTop: i,
                srcWidth: s,
                srcHeight: n,
            ...
            if (!m.srcWidth || !m.srcHeight || !m.destWidth || !m.destHeight) {
                var u = B('incorrect sizes for resource "'.concat(z(e), '"'));
                return F(u, t.silent), this.prepareResult(c, u)
            }
            if (!this.canvas && (this.canvas = $ ? H ? new OffscreenCanvas(1, 1) : null : document.createElement("canvas"), !this.canvas)) {
                var u = B("OffscreenCanvas is not supported in this browser");
                return F(u, t.silent), this.prepareResult(c, u)
            }
            if (!this.ctx) {
                if (this.ctx = this.canvas.getContext("2d", {
                    ...
                    var u = B("Canvas Context 2D is not supported in this browser");
            ...
            try {
                ...
                var u = B("security error (CORS) for resource ".concat(z(e), ".\nDetails: https://developer.mozilla.org/en/docs/Web/HTML/CORS_enabled_image"));
            ...
            switch (t.algorithm || "sqrt") {
                ...
                case "dominant":
                    ...
                    break;
                default:
                    throw B("".concat(t.algorithm, " is unknown algorithm"))
            }
            return a(e, r - r % 4, {
                defaultColor: i,
            ...
            return new Promise(function(l, r) {
                var i = function() {
                    ...
                    s = function() {
                        o(), r(B('Error loading image "'.concat(e.src, '"')))
                    },
                    n = function() {
                        o(), r(B('Image "'.concat(e.src, '" loading aborted')))
                    },
                    o = function() {
    ...
    let W = e => [parseInt(e.slice(1, 3), 16), parseInt(e.slice(3, 5), 16), parseInt(e.slice(5, 7), 16)],
        q = (e, t) => {
            let a, l, r, [i, s, n] = W(e),
                        ...
                        children: [e.details && e.details.length > 0 && (0, t.jsx)("ul", {
                            ...
                            children: [e.description?.readMoreLabel && (0, t.jsx)(w.default, {
                                ...
                                children: (0, t.jsx)(w.default, {
                                    ...
                                    variant: "primary",
                                    icon: "arrow-right",
                                    "data-link-location": U.trackingLocation.deluxeAnnouncementBannerAction,
    ...
    e.s(["default", 0, ({
        ...
        return ((0, l.useEffect)(() => {
            ...
            children: c && (0, t.jsx)(K, {
                ...
                image: {
                    src: n ? (0, Z.urlForImage)(n)?.fit("crop").width(1200).height(750).dpr(2).url() ?? "" : "",
                    alt: n?.alt ?? "",
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "f29f9ce5-1b4c-52f4-9285-da38c8a3425f")
    } catch (e) {}
}();
//# debugId=f29f9ce5-1b4c-52f4-9285-da38c8a3425f