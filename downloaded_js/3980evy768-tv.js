(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 188571, (e, t, n) => {
    ...
    function r(e, t, n) {
        ...
        }(t, "string"), (t = "symbol" == a(r) ? r : r + "") in e) ? Object.defineProperty(e, t, {
            value: n,
            enumerable: !0,
            configurable: !0,
            writable: !0
    ...
    function v(e) {
        var t = e.children,
            ...
            d = e.wrapLongLines,
            f = e.wrapLines,
            b = void 0 !== f && f ? h({}, "function" == typeof s ? s(a) : s) : {};
        if (b.className = b.className ? [].concat(n(b.className.trim().split(/\s+/)), n(u)) : u, a && o) {
            var m = y(r, a, i);
            t.unshift(p(a, m))
        }
        return d & g && (b.style = h({
            display: "flex"
        }, b.style)), {
            type: "element",
            tagName: "span",
        ...
        return t.map(function(e, t) {
            return function e(t) {
                ...
                if (f) {
                    ...
                    var N = p(n.children);
                    return c.default.createElement(f, s({
                        key: o
                    }, m), N)
                }
            }({
    ...
    var _ = e.i(911214),
        w = (i = _.default, o = {}, function(e) {
            var t, a, r = e.language,
                s = e.children,
                l = e.style,
                u = void 0 === l ? o : l,
                g = e.customStyle,
                ...
                w = void 0 === _ ? {
                    ...
                    style: h(h({}, u['code[class*="language-"]']), u['code[class*="language-'.concat(r, '"]')])
                } : _,
                O = e.useInlineStyles,
                x = void 0 === O || O,
                M = e.showLineNumbers,
                ...
                H = void 0 === K ? "code" : K,
                G = e.code,
                F = void 0 === G ? (Array.isArray(s) ? s[0] : s) || "" : G,
                Z = e.astGenerator,
                q = function(e, t) {
                    if (null == e) return {};
            ...
            Z = Z || i;
            var X = S ? c.default.createElement(m, {
                    containerStyle: A,
                    codeStyle: w.style || {},
                    numberStyle: C,
                ...
                Q = x ? Object.assign({}, q, {
                    ...
                    className: q.className ? "".concat(V, " ").concat(q.className) : V,
            ...
            if (P ? w.style = h({
                    ...
                    whiteSpace: "pre"
                }, w.style), !Z) return c.default.createElement(z, Q, X, c.default.createElement(H, w, F));
            (void 0 === j && U || P) && (j = !0), U = U || E;
            var J = [{
                    type: "text",
                    value: F
                }],
            ...
            var ee = I + (null != (t = null == (a = F.match(/\n/g)) ? void 0 : a.length) ? t : 0),
                et = function(e, t, a, r, i, o, c, s, l) {
                    var u, g = function e(t) {
                            for (var a = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [], i = 0; i < t.length; i++) {
                                var o = t[i];
                                if ("text" === o.type) r.push(v({
                                    children: [o],
                                    className: n(new Set(a))
                                }));
                                else if (o.children) {
                                    var c = a.concat(o.properties.className);
                                    e(o.children, c).forEach(function(e) {
                                        return r.push(e)
                                    })
                                }
                            }
                    ...
                    function m(e, n) {
                        ...
                        return t || o.length > 0 ? function(e, n) {
                            var o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [];
                            return v({
                                children: e,
                                lineNumber: n,
                    ...
                    for (; h < g.length;) ! function() {
                        ...
                        if (t.match(b)) {
                            ...
                            n.forEach(function(t, a) {
                                ...
                                if (0 === a) {
                                    var s = m(g.slice(f + 1, h).concat(v({
                                        children: [c],
                                        className: e.properties.className
                                    })), i);
                                    d.push(s)
                                } else if (a === n.length - 1) {
                                    var l = g[h + 1] && g[h + 1].children && g[h + 1].children[0],
                                        u = {
                                            type: "text",
                                            value: "".concat(t)
                                        };
                ...
                }(Y, j, void 0 === B ? {} : B, S, R, I, ee, C, P);
            return c.default.createElement(z, Q, c.default.createElement(H, w, !R && X, U({
                rows: et,
                stylesheet: u,
                useInlineStyles: x
            })))
        });
    w.registerLanguage = _.default.registerLanguage, e.s(["Light", 0, w], 537655)
}, 854858, (e, t, n) => {
    t.exports = function(e) {
        let t = {
