(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 27666, 870053, 522455, e => {
    ...
    e.s(["default", 0, e => {
        let {
            ...
            "data-link-id": P
        } = e, M = "string" == typeof l ? l ? (0, t.jsx)(b.default, {
            icon: l,
            size: "0.75rem",
            weight: i
        }) : null : l ?? null, A = !!M, O = h ?? (r ? void 0 : "string" == typeof l && l ? `${n} button with ${l} icon` : A ? `${n} button with icon` : `${n} button`), L = {
            iconLeft: "left" === s ? M ?? void 0 : void 0,
            iconRight: "right" === s ? M ?? void 0 : void 0
        }, H = {
            ...k && {
                "data-link-location": k
            },
