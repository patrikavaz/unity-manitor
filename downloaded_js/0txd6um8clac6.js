(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 584266, 817916, e => {
    ...
    let _ = ({
        ...
        let n = (0, h.default)(`(max-width: ${f.default.Large}px)`),
            ...
            N = () => {
                let e;
                s.current && (s.current.offsetTop < window.scrollY ? y(!0) : y(!1)), _.current > window.scrollY && x ? g(!0) : _.current < window.scrollY && g(!1), _.current = window.scrollY, s.current && (s.current.offsetTop > window.innerHeight && !m ? k(!0) : k(!1)), e = null, d.forEach((t, a) => {
        ...
        }), []), (0, l.useEffect)(() => (_.current = window.scrollY, window.addEventListener("scroll", N), () => {
            window.removeEventListener("scroll", N)
        }), [m, d, n]), (0, t.jsx)(p.default, {
    ...
    t.exports = function(e, t, a, n, s, o, c, d, u, f) {
        ...
        var m = [e, t, s, h ? o : void 0, h ? c : void 0, h ? void 0 : o, h ? void 0 : c, d, u, f],
            g = a.apply(void 0, m);
    ...
    t.exports = function e(t, a, f, h, m, g, x, p, v, b) {
        ...
        function L() {
            for (var S = arguments.length, E = Array(S), R = S; R--;) E[R] = arguments[R];
            if (_) var C = o(L),
                T = i(E, C);
            if (h && (E = r(E, h, m, _)), g && (E = l(E, g, x, _)), S -= T, _ && S < b) {
                var A = d(E, C);
                return s(t, a, e, L.placeholder, f, E, A, p, v, b - S)
            }
            var $ = j ? f : this,
                M = k ? $[t] : t;
            return S = E.length, p ? E = c(E, p) : w && S > 1 && E.reverse(), y && v < S && (E.length = v), this && this !== u && this instanceof L && (M = N || n(M)), M.apply($, E)
        }
        return L
    }
}, 50962, (e, t, a) => {
    ...
    t.exports = function(e, t, a) {
        ...
        function u() {
            ...
            return (l -= g.length) < a ? n(e, t, i, u.placeholder, void 0, f, g, void 0, void 0, a - l) : r(this && this !== c && this instanceof u ? d : e, this, f)
        }
        return u
    }
}, 890892, (e, t, a) => {
    ...
    t.exports = function(e, t, a, m, g, x, p, v) {
        ...
        var y = m ? m.length : 0;
        if (y || (t &= -97, m = g = void 0), p = void 0 === p ? p : h(f(p), 0), v = void 0 === v ? v : f(v), y -= g ? g.length : 0, 64 & t) {
            var j = m,
                k = g;
            m = g = void 0
        }
        ...
        if (_ && c(w, _), e = w[0], t = w[1], a = w[2], m = w[3], g = w[4], (v = w[9] = void 0 === w[9] ? b ? 0 : e.length : h(w[9] - y, 0)) || !(24 & t) || (t &= -25), t && 1 != t) N = 8 == t || 16 == t ? i(e, t, v) : 32 != t && 33 != t || g.length ? n.apply(void 0, w) : s(e, t, a, m);
        else var N = l(e, t, a);
        return u((_ ? r : d)(N, w), e, t)
    }
}, 414462, (e, t, a) => {
    var r = e.r(852580);
    ...
    let c = ({
        ...
        let [p, v] = (0, a.useState)(u?.[0]?.value || ""), b = (e, a) => {
            let r = {
                uniteCard: l.default,
                cardSubscription: s
            } [e?.type];
            return (0, t.jsx)("div", {
                ...
                children: (0, t.jsx)(r, {
                    ...e,
                    variant: m,
                    blockKey: g || i.trackingLocation.uniteCards,
                    titleTag: x,
                    index: a
                })
            }, `${e.title}-${a}`)
                ...
                children: (0, t.jsxs)("div", {
                    ...
                    children: [(c || d) && (0, t.jsx)(o.default, {
                        ...
                        children: [u.map((e, a) => (0, t.jsx)(n.default, {
                            ...
                            "data-link-location": g || i.trackingLocation.uniteCardsFilter,
                            "data-link-id": `${g||i.trackingLocation.uniteCardsFilter}-filter-${a}`,
                            children: e.title
                            ...
                            outlined: !0,
                            hasArrow: !0,
                            "data-link-location": g || i.trackingLocation.uniteCardsAction,
                            "data-link-id": `${g||i.trackingLocation.uniteCardsAction}-action-${a}`,
                            children: e.title
                        }, `action-${e}-${a}`))]
                    }), (0, t.jsx)("div", {
                        className: k,
    ...
    let m = ({
        ...
        let [m, g] = (0, a.useState)(0), x = (0, a.useRef)(null), p = (0, f.default)(`(min-width: ${h.default.Large}px)`), v = "gdc2026" === n, b = (0, r.default)({
            dark: "dark" === e
        ...
        }, L = p ? 2 : 1, S = i.length - L + 1, E = 0 === m, R = m >= S - 1, C = p && i.length > 2 || !p && i.length > 1;
    ...
    var g = e.i(869324),
        ...
        v = e.i(23439),
        b = e.i(271357);
    let y = [p.default, v.default, b.default];
    e.s(["default", 0, ({
        theme: e,
        title: a,
        description: r,
        ...
        let {
            mapFormActions: b,
            renderModal: j
        } = (0, x.useFormModal)(o?.map(e => e.action).filter(Boolean)), k = (e, t = 0, a = !1) => {
            let r = !!e?.action?.form,
                l = null;
            e?.action ? l = {
        ...
        return s ? (0, t.jsx)(m, {
            ...
            children: !p && (0, t.jsx)(c, {
                ...
                cards: _,
                blockKey: h,
                cardsHeading: "div" === v || "h2" === v || "h3" === v || "h4" === v ? v : a ? "h3" : "h2"
            })
        })
    }], 913890)
}, 4390, e => {
    ...
    e.s(["default", 0, ({
        ...
        let [h] = (0, a.useContext)(d.FiltersContext), {
            ...
            _id: e
        }) => e === h.selectedSubcategory) : null, x = !c || c.categories?.find(e => e._id === h.selectedCategory) != null && (null == g || !c.subcategories || c.subcategories.some(({
            _id: e
