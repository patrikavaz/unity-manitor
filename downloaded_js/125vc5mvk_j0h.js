(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 7075, t => {
    ...
    function u({
        ...
        let f = (0, s.getAssetTokenQuery)();
        return (0, n.jsx)(n.Fragment, {
            children: r.map(t => {
                let r = `${e.assetPrefix}/_next/${(0,a.encodeURIPath)(t)}${f}`;
    ...
    t.s(["useRender", 0, function(t, e, n, {
        ...
        let y = (u ?? (0, v.isSVGComponent)(t) ? function(t, e, n, i) {
            ...
            E = (0, r.useMemo)(() => (0, s.isMotionValue)(x) ? x.get() : x, [x]);
    ...
    function E(t, {
        ...
        let M = A ? "svg" === A : (0, l.isSVGComponent)(t),
        ...
        function k(l, c) {
            let h, d = {
                ...
                E = (0, u.useCreateMotionContext)(l),
                A = T(l, y);
            if (!y && "u" > typeof window) {
                ...
                h = e.MeasureLayout, E.visualElement = function(t, e, r, i, u, f) {
                    let {
                        visualElement: l
                    } = (0, n.useContext)(s.MotionContext), c = (0, n.useContext)(o.LazyContext), h = (0, n.useContext)(v.PresenceContext), p = (0, n.useContext)(a.MotionConfigContext), d = p.reducedMotion, y = p.skipAnimations, g = (0, n.useRef)(null), E = (0, n.useRef)(!1);
                    i = i || c.renderer, !g.current && i && (g.current = i(t, {
                        ...
                        skipAnimations: y,
                        isSVG: f
                    }), E.current && g.current && (g.current.manuallyAnimateOnMount = !0));
                    let A = g.current,
                        C = (0, n.useContext)(b.SwitchLayoutGroupContext);
                    A && !A.projection && u && ("html" === A.type || "svg" === A.type) && function(t, e, r, n) {
                        let {
                            layoutId: i,
                            layout: o,
                            drag: a,
                    ...
                    return (0, x.useIsomorphicLayoutEffect)(() => {
                        E.current = !0, A && (S.current = !0, window.MotionIsMounted = !0, A.updateFeatures(), A.scheduleRenderMicrotask(), T.current && A.animationState && A.animationState.animateChanges())
                    }), (0, n.useEffect)(() => {
                        A && (!T.current && A.animationState && A.animationState.animateChanges(), T.current && (queueMicrotask(() => {
                            window.MotionHandoffMarkAsComplete?.(M)
                        }), T.current = !1), A.enteringChildren = void 0)
                    }), A
                }(t, A, d, S, e.ProjectionNode, M)
            }
            return (0, r.jsxs)(s.MotionContext.Provider, {
                value: E,
                children: [h && E.visualElement ? (0, r.jsx)(h, {
                    visualElement: E.visualElement,
                    ...d
                }) : null, (0, f.useRender)(t, l, (0, g.useMotionRef)(A, E.visualElement, c), A, y, e, M)]
            })
        }
    ...
    function A(t, e) {
        ...
        return new Proxy((t, e) => n(t, e), {
            get: (i, o) => "create" === o ? n : (r.has(o) || r.set(o, E(o, void 0, t, e)), r.get(o))
        })
    }
    t.s(["createMotionComponent", 0, E], 319623);
    var C = t.i(263422),
        S = t.i(948395),
        M = t.i(159313),
        T = t.i(596995);
