(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 925511, 310954, 685099, 884580, t => {
    ...
    t.s(["GLOBAL_OBJ", 0, n], 685099), t.s(["getGlobalSingleton", 0, function(t, r, i = n) {
        let s = i.__SENTRY__ = i.__SENTRY__ || {},
            a = s[e] = s[e] || {};
        return a[t] || (a[t] = r())
    }, "getMainCarrier", 0, function() {
        return r(n), n
    }, "getSentryCarrier", 0, r], 925511);
    let i = "u" < typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__;
    t.s(["DEBUG_BUILD", 0, i], 884580)
}, 809538, t => {
    "use strict";
    var e = t.i(925511),
        n = t.i(884580),
    ...
    let o = t.i(685099).GLOBAL_OBJ;
    t.s(["getComponentName", 0, function(t) {
...
}, 677278, 353649, 545268, 743959, 437946, 303197, 521581, 445257, 81211, 93763, 761391, 434362, 788879, 765158, 403316, 399116, 528951, 158186, 856040, 323795, 251287, 7837, 706365, 280166, 784863, 806861, 361277, 69164, 822691, 51229, 166154, 587791, 94412, 539218, 529956, t => {
    "use strict";
    let e, n, r, i, s, a, o;
    var c = t.i(925511),
        u = t.i(884580),
    ...
    function h(t) {
        ...
        if (!(0, d.isEvent)(t)) return t;
        {
            let e = {
                type: t.type,
                target: g(t.target),
                currentTarget: g(t.currentTarget),
                ...m(t)
            };
    ...
    t.s(["addNonEnumerableProperty", 0, f, "convertToPlainObject", 0, h, "extractExceptionKeysForMessage", 0, function(t) {
    ...
    }, "markFunctionWrapped", 0, _], 353649);
    var S = t.i(685099);
    ...
    t.s(["safeDateNow", 0, E, "safeMathRandom", 0, b, "withRandomSafeContext", 0, y], 545268);
    let v = /\(error: (.*)\)/,
        T = /captureMessage|captureException/;
    ...
    function I(...t) {
        ...
        return (t, n = 0, r = 0) => {
            ...
            if (!a.length) return [];
            let o = Array.from(a);
            return /sentryWrapped/.test(x(o).function || "") && o.pop(), o.reverse(), T.test(x(o).function || "") && (o.pop(), T.test(x(o).function || "") && o.pop()), o.slice(0, 50).map(t => ({
                ...t,
    ...
    function N(t = function() {
        ...
        try {
            if (t?.randomUUID) return y(() => t.randomUUID()).replace(/-/g, "")
        } catch {}
        return n || (n = "10000000100040008000100000000000"), n.replace(/[018]/g, t => (t ^ (15 & 16 * b()) >> t / 4).toString(16))
    }
    ...
    function B() {
        return (r ?? (r = function() {
            ...
            if (!t?.now || !t.timeOrigin) return R;
            let e = t.timeOrigin;
            return () => (e + y(() => t.now())) / 1e3
        }()))()
    }
    t.s(["UNKNOWN_FUNCTION", 0, "?", "createStackParser", 0, I, "getFramesFromEvent", 0, function(t) {
        let e = t.exception;
        if (e) {
            let t = [];
            try {
    ...
    }, "getFunctionName", 0, C, "getVueInternalName", 0, D, "stackParserFromStackParserOptions", 0, function(t) {
        return Array.isArray(t) ? I(...t) : t
    }], 743959), t.s(["isMatchingPattern", 0, k, "safeJoin", 0, function(t, e) {
        if (!Array.isArray(t)) return "";
        let n = [];
        for (let e = 0; e < t.length; e++) {
            let r = t[e];
            try {
                (0, d.isVueViewModel)(r) ? n.push(D(r)): n.push(String(r))
            } catch {
    ...
    }, "truncate", 0, O], 437946), t.s(["addExceptionMechanism", 0, L, "addExceptionTypeValue", 0, function(t, e, n) {
    ...
    function P(t, e = {}) {
        if (e.user && (!t.ipAddress && e.user.ip_address && (t.ipAddress = e.user.ip_address), t.did || e.did || (t.did = e.user.id || e.user.email || e.user.username)), t.timestamp = e.timestamp || B(), e.abnormal_mechanism && (t.abnormal_mechanism = e.abnormal_mechanism), e.ignoreDuration && (t.ignoreDuration = e.ignoreDuration), e.sid && (t.sid = 32 === e.sid.length ? e.sid : N()), void 0 !== e.init && (t.init = e.init), !t.did && e.did && (t.did = `${e.did}`), "number" == typeof e.started && (t.started = e.started), t.ignoreDuration) t.duration = void 0;
    ...
    function j(t, e, n = 2) {
        ...
        for (let t in e) Object.prototype.hasOwnProperty.call(e, t) && (r[t] = j(r[t], e[t], n - 1));
        return r
    }
    ...
    }, "dateTimestampInSeconds", 0, R, "timestampInSeconds", 0, B], 521581), t.s(["closeSession", 0, $, "makeSession", 0, M, "updateSession", 0, P], 445257), t.s(["merge", 0, j], 81211), t.s(["generateSpanId", 0, F, "generateTraceId", 0, G], 93763);
    let J = "_sentrySpan";

    function H(t, e) {
        e ? f(t, J, e) : delete t[J]
    }

    function V(t) {
        return t[J]
    }
    t.s(["_getSpanForScope", 0, V, "_setSpanForScope", 0, H], 761391);
    class Y {
        constructor() {
        ...
        clone() {
            ...
            }, t._client = this._client, t._lastEventId = this._lastEventId, H(t, V(this)), t
        }
        setClient(t) {
            this._client = t
        }
        ...
        update(t) {
            ...
            let e = "function" == typeof t ? t(this) : t,
                ...
                } = (e instanceof Y ? e.getScopeData() : (0, d.isPlainObject)(e) ? t : void 0) || {};
            return this._tags = {
                ...this._tags,
                ...n
            }, this._attributes = {
        ...
        clear() {
            return this._breadcrumbs = [], this._tags = {}, this._attributes = {}, this._extra = {}, this._user = {}, this._contexts = {}, this._level = void 0, this._transactionName = void 0, this._fingerprint = void 0, this._session = void 0, H(this, void 0), this._attachments = [], this.setPropagationContext({
                traceId: G(),
                sampleRand: b()
            }), this._notifyScopeListeners(), this
        }
        ...
        setSDKProcessingMetadata(t) {
            return this._sdkProcessingMetadata = j(this._sdkProcessingMetadata, t, 2), this
        }
    ...
    class z {
        constructor(t, e) {
            let n, r;
            n = t || new Y, r = e || new Y, this._stack = [{
                scope: n
    ...
    function K() {
        ...
        return e.stack = e.stack || new z((0, c.getGlobalSingleton)("defaultCurrentScope", () => new Y), (0, c.getGlobalSingleton)("defaultIsolationScope", () => new Y))
    }
    ...
    function Z() {
        return Q((0, c.getMainCarrier)()).getCurrentScope()
    }

    function tt() {
        return Q((0, c.getMainCarrier)()).getIsolationScope()
    }

    function te() {
        return (0, c.getGlobalSingleton)("globalScope", () => new Y)
    }

    function tn(...t) {
        let e = Q((0, c.getMainCarrier)());
        if (2 === t.length) {
            let [n, r] = t;
    ...
    t.s(["getAsyncContextStrategy", 0, Q], 434362), t.s(["getClient", 0, tr, "getCurrentScope", 0, Z, "getGlobalScope", 0, te, "getIsolationScope", 0, tt, "getTraceContextFromScope", 0, function(t) {
        let {
            traceId: e,
            parentSpanId: n,
            propagationSpanId: r
    ...
    function tg(t) {
        let e = tm(t);
        if (!e) return;
        let n = Object.entries(e).reduce((t, [e, n]) => (e.match(th) && (t[e.slice(t_.length)] = n), t), {});
        return Object.keys(n).length > 0 ? n : void 0
    }

    function tm(t) {
        if (t && ((0, d.isString)(t) || Array.isArray(t))) return Array.isArray(t) ? t.reduce((t, e) => (Object.entries(tS(e)).forEach(([e, n]) => {
            t[e] = n
        }), t), {}) : tS(t)
    }
    ...
    t.s(["SENTRY_BAGGAGE_KEY_PREFIX", 0, t_, "baggageHeaderToDynamicSamplingContext", 0, tg, "dynamicSamplingContextToSentryBaggageHeader", 0, function(t) {
        if (t) {
            var e = Object.entries(t).reduce((t, [e, n]) => (n && (t[`${t_}${e}`] = n), t), {});
    ...
    }, "parseBaggageHeader", 0, tm], 403316), t.s(["hasSpansEnabled", 0, ty], 399116), t.s(["parseSampleRate", 0, tb], 528951), t.s(["SPAN_STATUS_ERROR", 0, 2, "SPAN_STATUS_OK", 0, 1, "SPAN_STATUS_UNSET", 0, 0, "setHttpStatus", 0, function(t, e) {
    ...
    function tO(t) {
        ...
        if (n.orgId) e = String(n.orgId);
            ...
            let t;
            r && (t = r.match(tI), e = t?.[1])
        }
        return e
    }
    t.s(["dsnFromString", 0, tC, "dsnToString", 0, tA, "extractOrgIdFromClient", 0, tO, "makeDsn", 0, function(t) {
        let e = "string" == typeof t ? tC(t) : tD(t);
        if (e && function(t) {
    ...
    let tk = RegExp("^[ \\t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \\t]*$");

    function tN(t = G(), e = F(), n) {
        let r = "";
        return void 0 !== n && (r = n ? "-1" : "-0"), `${t}-${e}${r}`
    }

    function tw(t = G(), e = F(), n) {
        return `00-${t}-${e}-${n?"01":"00"}`
    }
    t.s(["TRACEPARENT_REGEXP", 0, tk, "generateSentryTraceHeader", 0, tN, "generateTraceparentHeader", 0, tw, "propagationContextFromHeaders", 0, function(t, e) {
        let n = function(t) {
                let e;
                if (!t) return;
                let n = t.match(tk);
        ...
        let i = function(t, e) {
            ...
            return r && t?.parentSampled !== void 0 ? t.parentSampled ? b() * r : r + b() * (1 - r) : b()
        }(n, r);
    ...
    function tB(t) {
        let {
            ...
            traceId: n,
            isRemote: r
        } = t.spanContext(), i = r ? e : t$(t).parent_span_id, s = tT(t).scope;
        return {
            parent_span_id: i,
            span_id: r ? s?.getPropagationContext().propagationSpanId || F() : e,
            trace_id: n
        }
    }
    ...
    function tM(t) {
        return "number" == typeof t ? tP(t) : Array.isArray(t) ? t[0] + t[1] / 1e9 : t instanceof Date ? tP(t.getTime()) : B()
    }
    ...
    function t$(t) {
        ...
        if ((e = t).attributes && e.startTime && e.name && e.endTime && e.status) {
            ...
            return {
                ...
                start_timestamp: tM(i),
                timestamp: tM(a) || void 0,
                status: tG(o),
                op: e[to],
                origin: e[tc],
                links: tU(c)
    ...
    function tH(t, e) {
        let n = t[tJ] || t;
        f(e, tJ, n), t[tF] ? t[tF].add(e) : f(t, tF, new Set([e]))
    }
    ...
    function tV(t) {
        ...
        return ! function t(n) {
            if (!e.has(n) && tj(n))
                for (let r of (e.add(n), n[tF] ? Array.from(n[tF]) : [])) t(r)
        }(t), Array.from(e)
    }
    ...
    function tz() {
        let t = Q((0, c.getMainCarrier)());
        return t.getActiveSpan ? t.getActiveSpan() : V(Z())
    }

    function tK() {
        tL || ((0, p.consoleSandbox)(() => {
            console.warn("[Sentry] Returning null from `beforeSendSpan` is disallowed. To drop certain spans, configure the respective integrations directly or use `ignoreSpans`.")
        }), tL = !0)
    }
    t.s(["TRACE_FLAG_NONE", 0, 0, "TRACE_FLAG_SAMPLED", 0, 1, "addChildSpanToSpan", 0, tH, "convertSpanLinksForEnvelope", 0, tU, "getActiveSpan", 0, tz, "getRootSpan", 0, tY, "getSpanDescendants", 0, tV, "getStatusMessage", 0, tG, "removeChildSpanFromSpan", 0, function(t, e) {
        t[tF] && t[tF].delete(e)
    }, "showSpanDropWarning", 0, tK, "spanIsSampled", 0, tj, "spanTimeInputToSeconds", 0, tM, "spanToJSON", 0, t$, "spanToTraceContext", 0, tB, "spanToTraceHeader", 0, function(t) {
        let {
            traceId: e,
            spanId: n
        } = t.spanContext();
        ...
        return tw(e, n, tj(t))
    }, "spanToTransactionTraceContext", 0, tR], 251287);
    let tW = "production";
    t.s(["DEFAULT_ENVIRONMENT", 0, tW], 7837);
    let tq = "_frozenDsc";
    ...
    function tZ(t) {
        ...
        let n = tY(t),
            ...
            a = s?.get("sentry.sample_rate") ?? i[ts] ?? i[ta];
        ...
        let u = s?.get("sentry.dsc"),
            l = u && tg(u);
        if (l) return o(l);
        let p = tQ(t.spanContext().traceId, e),
            d = i[ti],
            f = r.description;
        return "url" !== d && f && (p.transaction = f), ty() && (p.sampled = String(tj(n)), p.sample_rand = s?.get("sentry.sample_rand") ?? tT(n).scope?.getPropagationContext().sampleRand.toString()), o(p), e.emit("createDsc", p, n), p
    }
    t.s(["freezeDscOnSpan", 0, tX, "getDynamicSamplingContextFromScope", 0, function(t, e) {
        let n = e.getPropagationContext();
        return n.dsc || tQ(n.traceId, t)
    }, "getDynamicSamplingContextFromSpan", 0, tZ], 706365);
    class t0 {
        constructor(t = {}) {
            this._traceId = t.traceId || G(), this._spanId = t.spanId || F()
        }
        spanContext() {
            return {
                spanId: this._spanId,
    ...
    function t1(e, n = 100, r = Infinity) {
        try {
            return function e(n, r, i = Infinity, s = Infinity, a = function() {
                ...
                let u = function(e, n) {
                    try {
                        ...
                        if ((0, d.isVueViewModel)(n)) return D(n);
    ...
    function t3(t) {
        let e = (0, c.getSentryCarrier)(S.GLOBAL_OBJ);
    ...
    t.s(["SentryNonRecordingSpan", 0, t0], 280166), t.s(["normalize", 0, t1, "normalizeToSize", 0, function t(e, n = 3, r = 102400) {
        let i = t1(e, n);
    ...
    function et(t, e) {
        ...
        for (let r of e) {
            ...
            if ("string" == typeof(n = r) || n instanceof RegExp) {
                if (k(t.description, r)) return u.DEBUG_BUILD && t7(t), !0;
                continue
            }
            if (!r.name && !r.op) continue;
            let e = !r.name || k(t.description, r.name),
                i = !r.op || t.op && k(t.op, r.op);
            if (e && i) return u.DEBUG_BUILD && t7(t), !0
        }
        return !1
    }
    ...
    function ee(t, e) {
        let n = tZ(t[0]),
            ...
            c = o?.length ? t.filter(t => !et(t$(t), o)) : t,
            u = t.length - c.length;
    ...
    t.s(["addItemToEnvelope", 0, function(t, e) {
        ...
        let e = "string" == typeof t.data ? t3(t.data) : t.data;
        return [{
            type: "attachment",
            length: e.length,
            filename: t.filename,
    ...
    }, "createEnvelope", 0, t5, "createEventEnvelopeHeaders", 0, t9, "createSpanEnvelopeItem", 0, t8, "envelopeContainsItemType", 0, function(t, e) {
        return t2(t, (t, n) => e.includes(n))
    }, "envelopeItemTypeToDataCategory", 0, function(t) {
        return t4[t]
    }, "forEachEnvelopeItem", 0, t2, "getSdkMetadataForEnvelopeHeader", 0, t6, "serializeEnvelope", 0, function(t) {
        let [e, n] = t, r = JSON.stringify(e);

        function i(t) {
            "string" == typeof r ? r = "string" == typeof t ? r + t : [t3(r), t] : r.push("string" == typeof t ? t3(t) : t)
        }
        for (let t of n) {
            let [e, n] = t;
            if (i(`
...
`), "string" == typeof n || n instanceof Uint8Array) i(n);
    ...
    }], 806861), t.s(["reparentChildSpans", 0, function(t, e) {
        let n = e.parent_span_id,
            r = e.span_id;
        if (n)
            for (let e of t) e.parent_span_id === r && (e.parent_span_id = n)
    }, "shouldIgnoreSpan", 0, et], 361277), t.s(["createEventEnvelope", 0, function(t, e, n, r) {
        let i = t6(n),
        ...
        let a = t9(t, i, r, e);
        return delete t.sdkProcessingMetadata, t5(a, [
            [{
                type: s
            }, t]
        ])
    ...
    }, "createSpanEnvelope", 0, ee], 69164), t.s(["setMeasurement", 0, function(t, e, n, r = tz()) {
        let i = r && tY(r);
        i && (u.DEBUG_BUILD && p.debug.log(`[Measurement] Setting measurement on root span: ${t} = ${e} ${n}`), i.addEvent(t, {
            [tl]: e,
            [tu]: n
        }))
    }, "timedEventsToMeasurements", 0, en], 822691);
    class er {
        constructor(t = {}) {
            this._traceId = t.traceId || G(), this._spanId = t.spanId || F(), this._startTime = t.startTimestamp || B(), this._links = t.links, this._attributes = {}, this.setAttributes({
                [tc]: "manual",
                [to]: t.op,
                ...t.attributes
        ...
        updateStartTime(t) {
            this._startTime = tM(t)
        }
        setStatus(t) {
            return this._status = t, this
        }
        updateName(t) {
            return this._name = t, this.setAttribute(ti, "custom"), this
        }
        end(t) {
            this._endTime || (this._endTime = tM(t), function(t) {
                ...
                let {
                    ...
                    spanId: r
                } = t.spanContext(), i = tY(t) === t, s = `[Tracing] Finishing "${n}" ${i?"root ":""}span "${e}" with ID ${r}`;
                p.debug.log(s)
        ...
        getSpanJSON() {
            return {
                ...
                op: this._attributes[to],
                parent_span_id: this._parentSpanId,
                span_id: this._spanId,
                start_timestamp: this._startTime,
                status: tG(this._status),
                timestamp: this._endTime,
                trace_id: this._traceId,
                origin: this._attributes[tc],
                profile_id: this._attributes[td],
                exclusive_time: this._attributes[tf],
                measurements: en(this._events),
                is_segment: this._isStandaloneSpan && tY(this) === this || void 0,
                segment_id: this._isStandaloneSpan ? tY(this).spanContext().spanId : void 0,
                links: tU(this._links)
            }
        }
        isRecording() {
        ...
        _onSpanEnded() {
            let t = tr();
            if (t && t.emit("spanEnd", this), !(this._isStandaloneSpan || this === tY(this))) return;
            ...
            }(ee([this], t)) : (u.DEBUG_BUILD && p.debug.log("[Tracing] Discarding standalone span because its trace was not chosen to be sampled."), t && t.recordDroppedEvent("sample_rate", "span")));
            let e = this._convertSpanToTransaction();
            e && (tT(this).scope || Z()).captureEvent(e)
        }
        _convertSpanToTransaction() {
            ...
            let {
                scope: t,
                isolationScope: e
            } = tT(this), n = t?.getScopeData().sdkProcessingMetadata?.normalizedRequest;
            if (!0 !== this._sampled) return;
            let r = tV(this).filter(t => {
                    var e;
                    return t !== this && !((e = t) instanceof er && e.isStandaloneSpan())
                }).map(t => t$(t)).filter(es),
                i = this._attributes[ti];
            delete this._attributes[tp], r.forEach(t => {
                delete t.data[tp]
            });
            let s = {
                    contexts: {
    ...
    t.s(["SentrySpan", 0, er], 51229);
    let ea = "__SENTRY_SUPPRESS_TRACING__";

    function eo(t, e) {
        let n = el();
        return n.withActiveSpan ? n.withActiveSpan(t, e) : tn(n => (H(n, t || void 0), e(n)))
    }
    ...
    function ec({
        ...
        if (t && !n) s = function(t, e, n) {
            let {
                spanId: r,
                traceId: i
            } = t.spanContext(), s = !e.getScopeData().sdkProcessingMetadata[ea] && tj(t), a = s ? new er({
                ...n,
                parentSpanId: r,
                traceId: i,
                sampled: s
        ...
        return ! function(t) {
            ...
            let {
                ...
                spanId: i
            } = t.spanContext(), s = tj(t), a = tY(t), o = a === t, c = `[Tracing] Starting ${s?"sampled":"unsampled"} ${o?"root ":""}span`, l = [`op: ${n}`, `name: ${e}`, `ID: ${i}`];
            ...
            p.debug.log(`${c}
  ${l.join("\n  ")}`)
        }(s), (i = s) && (f(i, tv, function(t) {
            try {
                let e = S.GLOBAL_OBJ.WeakRef;
    ...
    function eu(t) {
        ...
        if (t.startTime) {
            ...
            return n.startTimestamp = tM(t.startTime), delete n.startTime, n
        }
        return e
    }

    function el() {
        return Q((0, c.getMainCarrier)())
    }
    ...
    function ep(t, e, n) {
        ...
        let o = a.parentSampled ?? n,
            ...
            [d, f, _] = e.getScopeData().sdkProcessingMetadata[ea] ? [!1] : function(t, e, n) {
                let r, i;
                if (!ty(t)) return [!1];
    ...
    function ed(t, e) {
        ...
        if (!n) return;
        let r = tr();
        return (r ? r.getOptions() : {}).parentSpanIsAlwaysRootSpan ? tY(n) : n
    }
    ...
    t.s(["startInactiveSpan", 0, function(t) {
        ...
        return (t.scope ? e => tn(t.scope, e) : void 0 !== i ? t => eo(i, t) : t => t())(() => {
            let e = Z(),
                s = ed(e, i);
            return t.onlyIfParent && !s ? new t0 : ec({
                parentSpan: s,
                spanArguments: n,
                forceTransaction: r,
                scope: e
        ...
        return tn(e => (e.setPropagationContext({
            traceId: G(),
            sampleRand: b()
        }), u.DEBUG_BUILD && p.debug.log(`Starting a new trace with id ${e.getPropagationContext().traceId}`), eo(null, t)))
        ...
        return tn(a?.clone(), () => {
            var n;
            return (void 0 !== (n = s) ? t => eo(n, t) : t => t())(() => {
                let n = Z(),
                    a = ed(n, s),
                    o = t.onlyIfParent && !a ? new t0 : ec({
                        parentSpan: a,
                        spanArguments: r,
                        forceTransaction: i,
                        scope: n
    ...
    function eg(t) {
        let e = S.GLOBAL_OBJ._sentryDebugIds,
            n = S.GLOBAL_OBJ._debugIds;
        if (!e && !n) return {};
    ...
    function em(t, e) {
        ...
        (function(t, e) {
            ...
            dynamicSamplingContext: tZ(r),
            ...n.sdkProcessingMetadata
        }, (l = t$(tY(r)).description) && !n.transaction && "transaction" === n.type && (n.transaction = l)), i = t, s = d, i.fingerprint = i.fingerprint ? Array.isArray(i.fingerprint) ? i.fingerprint : [i.fingerprint] : [], s && (i.fingerprint = i.fingerprint.concat(s)), i.fingerprint.length || delete i.fingerprint, a = t, o = _, p = [...a.breadcrumbs || [], ...o], a.breadcrumbs = p.length ? p : void 0, c = t, u = h, c.sdkProcessingMetadata = {
    ...
    function eS(t, e) {
        ...
        ey(t, "extra", n), ey(t, "tags", r), ey(t, "attributes", i), ey(t, "user", s), ey(t, "contexts", a), t.sdkProcessingMetadata = j(t.sdkProcessingMetadata, c, 2), o && (t.level = o), _ && (t.transactionName = _), h && (t.span = h), u.length && (t.breadcrumbs = [...t.breadcrumbs, ...u]), l.length && (t.fingerprint = [...t.fingerprint, ...l]), p.length && (t.eventProcessors = [...t.eventProcessors, ...p]), d.length && (t.attachments = [...t.attachments, ...d]), t.propagationContext = {
    ...
    function eb(t, e) {
        let n = te().getScopeData();
        return t && eS(n, t.getScopeData()), e && eS(n, e.getScopeData()), n
    }

    function eE(t) {
        if (t) {
            var e;
            return (e = t) instanceof Y || "function" == typeof e || Object.keys(t).some(t => ev.includes(t)) ? {
                captureContext: t
            } : t
        }
    }
    t.s(["rejectedSyncPromise", 0, e_, "resolvedSyncPromise", 0, ef], 587791), t.s(["getDebugImagesForResources", 0, function(t, e) {
        let n = eg(t);
        if (!n) return [];
        let r = [];
        ...
        return r
    }, "getFilenameToDebugIdMap", 0, eg], 94412), t.s(["applyScopeDataToEvent", 0, em, "getCombinedScopeData", 0, eb], 539218);
    let ev = ["user", "level", "extra", "contexts", "tags", "fingerprint", "propagationContext"];

    function eT() {
        let t = tt(),
            e = Z().getSession() || t.getSession();
        e && $(e), eI(), t.setSession()
    }
    ...
    t.s(["parseEventHintOrCaptureContext", 0, eE, "prepareEvent", 0, function(t, e, n, r, i, s) {
        var a, o, c;
        let l, {
                normalizeDepth: f = 3,
        ...
        (function(t, e) {
            ...
            t.environment = t.environment || n || tW, !t.release && r && (t.release = r), !t.dist && i && (t.dist = i);
            let a = t.request;
            a?.url && s && (a.url = O(a.url, s)), s && t.exception?.values?.forEach(t => {
                t.value && (t.value = O(t.value, s))
            })
        })(h, t), a = h, (o = g).length > 0 && (a.sdk = a.sdk || {}, a.sdk.integrations = [...a.sdk.integrations || [], ...o]), i && i.emit("applyFrameMetadata", e), void 0 === e.type && (c = h, l = eg(t.stackParser), c.exception?.values?.forEach(t => {
        ...
        let m = function(t, e) {
            if (!e) return t;
            let n = t ? t.clone() : new Y;
            return n.update(e), n
        }(r, n.captureContext);
        n.mechanism && L(h, n.mechanism);
        let S = i ? i.getEventProcessors() : [],
            y = eb(s, m),
            b = [...n.attachments || [], ...y.attachments];
        return b.length && (n.attachments = b), em(h, y), (function(t, e, n, r = 0) {
            try {
                ...
                return (0, d.isThenable)(i) ? i : ef(i)
            } catch (t) {
                return e_(t)
            }
            ...
            let r = {
                ...
                ...t.contexts && {
                    contexts: t1(t.contexts, e, n)
                },
                ...t.extra && {
                    extra: t1(t.extra, e, n)
                }
            };
            return t.contexts?.trace && r.contexts && (r.contexts.trace = t.contexts.trace, t.contexts.trace.data && (r.contexts.trace.data = t1(t.contexts.trace.data, e, n))), t.spans && (r.spans = t.spans.map(t => ({
                ...t,
                ...t.data && {
                    data: t1(t.data, e, n)
                }
            }))), t.contexts?.flags && r.contexts && (r.contexts.flags = t1(t.contexts.flags, 3, n)), r
        }(t, f, _) : t)
    }], 529956), t.s(["addEventProcessor", 0, function(t) {
        tt().addEventProcessor(t)
    }, "captureEvent", 0, function(t, e) {
        return Z().captureEvent(t, e)
    }, "captureException", 0, function(t, e) {
        return Z().captureException(t, eE(e))
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "cc8877d0-feaf-51f9-83ba-7237ca6397d2")
    } catch (e) {}
}();
//# debugId=cc8877d0-feaf-51f9-83ba-7237ca6397d2