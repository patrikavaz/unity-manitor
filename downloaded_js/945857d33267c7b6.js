(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 925511, 310954, 685099, 884580, t => {
...
}, 677278, 353649, 545268, 743959, 437946, 303197, 521581, 445257, 81211, 93763, 761391, 434362, 788879, 765158, 403316, 399116, 528951, 158186, 856040, 323795, 251287, 7837, 706365, 280166, 784863, 806861, 742327, 69164, 822691, 51229, 166154, 587791, 94412, 539218, 529956, t => {
    "use strict";
    let e, n, r, i, s, a, o;
    var c = t.i(925511),
        u = t.i(884580),
    ...
    function t3(t) {
        return "number" == typeof t ? t8(t) : Array.isArray(t) ? t[0] + t[1] / 1e9 : t instanceof Date ? t8(t.getTime()) : Y()
    }
    ...
    t.s(["TRACE_FLAG_NONE", () => 0, "TRACE_FLAG_SAMPLED", () => 1, "addChildSpanToSpan", () => ee, "convertSpanLinksForEnvelope", () => t2, "getActiveSpan", () => es, "getRootSpan", () => ei, "getSpanDescendants", () => er, "getStatusMessage", () => t6, "removeChildSpanFromSpan", () => en, "showSpanDropWarning", () => ea, "spanIsSampled", () => t9, "spanTimeInputToSeconds", () => t3, "spanToJSON", () => t4, "spanToTraceContext", () => t0, "spanToTraceHeader", () => t1, "spanToTraceparentHeader", () => t5, "spanToTransactionTraceContext", () => tZ], 251287);
    let eo = "production";
...
`), "string" == typeof n || n instanceof Uint8Array) i(n);
  ...
  ${l.join("\n  ")}`)
    ...
    function e3(t) {
        if (t) {
            var e;
            return (e = t) instanceof ti || "function" == typeof e || Object.keys(t).some(t => e8.includes(t)) ? {
                captureContext: t
            } : t
        }
    }
    ...
    let e8 = ["user", "level", "extra", "contexts", "tags", "fingerprint", "propagationContext"];
    ...
    t.s(["parseEventHintOrCaptureContext", () => e3, "prepareEvent", () => e2], 529956), t.s(["addEventProcessor", () => nt, "captureEvent", () => e9, "captureException", () => e4, "captureSession", () => ni, "isEnabled", () => e7, "setContext", () => e6, "startSession", () => ne], 677278)
}]);
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "a76faf3d-9706-564d-8982-8235421ace03")
    } catch (e) {}
}();
//# debugId=a76faf3d-9706-564d-8982-8235421ace03