(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 787213, 422664, 883027, e => {
    "use strict";
    var t = e.i(785328),
        r = e.i(722978),
        n = e.i(833449);
    ...
    e.s(["default", 0, ({
        ...
        let f = (0, c.default)(),
            ...
            h = (0, r.default)("mb-8 md:mb-12", {
                "bg-black py-16": s?.container && "dark" === u,
                "bg-white py-16": s?.container && "light" === u
            }),
            y = (0, r.default)({
                ...
                children: (0, t.jsx)("div", {
                    ...
                    children: (0, t.jsxs)("div", {
                        ...
                        children: [(0, t.jsx)("iframe", {
                            ...
                            src: `${p}?#view=fit&navpanes=0${n?"&toolbar=0":""}`,
                            title: a ?? ""
                        }), v && (0, t.jsx)("div", {
    ...
    r.canGoNext = b, r.extractObject = function(e, t) {
        ...
        if (!r) {
            ...
            var M = Math.ceil(g / m),
                R = v(t.touchObject, s),
                z = S.swipeLength;
            return !w && (0 === u && ("right" === R || "down" === R) || u + 1 >= M && ("left" === R || "up" === R) || !b(t) && ("left" === R || "up" === R)) && (z = S.swipeLength * d, !1 === f && p && (p(R), _.edgeDragged = !0)), !h && k && (k(R), _.swiped = !0), P = o ? E + j / T * z * C : c ? E - z * C : E + z * C, s && (P = E + z * C), _ = a(a({}, _), {}, {
                touchObject: S,
                swipeLeft: P,
                trackStyle: O(a(a({}, t), {}, {
                    left: P
                }))
            }), Math.abs(S.curX - S.startX) < .8 * Math.abs(S.curY - S.startY) || S.swipeLength > 10 && (_.swiping = !0, l(e)), _
        }
        ...
        if (o.swipeLength > g) {
            ...
            switch (S) {
                case "left":
                case "up":
                    T = P + w(t), j = d ? m(t, T) : T, O.currentDirection = 0;
                    break;
                case "right":
                case "down":
                    T = P - w(t), j = d ? m(t, T) : T, O.currentDirection = 1;
                    break;
                default:
                    j = P
            }
    ...
    r.slidesOnLeft = L, r.canUseDOM = function() {
    ...
    let f = (0, r.forwardRef)(function({
        ...
        let k = (0, u.useObjectRef)(O),
            ...
            L = (0, o.clsx)("btn-outlined cursor-pointer flex justify-start items-center outline-hidden border-solid border-2 rounded-full overflow-hidden", {
                primary: "btn-primary",
            ...
            C = (0, o.clsx)("w-full transition-all duration-300 shrink-0 ", {
                "fill-gray-400": g
            }),
            M = (0, o.clsx)(C, {
            ...
            R = (0, o.clsx)(C, "fill-black dark:fill-white");
        if (v) {
            let e = (0, c.mergeProps)(T, P, E);
