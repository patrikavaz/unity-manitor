(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 740041, t => {
    ...
    var n = {
            872: function(t, e) {
                ...
                e.byteLength = function(t) {
                    ...
                    return 2 === a && (e = n[t.charCodeAt(r)] << 2 | n[t.charCodeAt(r + 1)] >> 4, s[l++] = 255 & e), 1 === a && (e = n[t.charCodeAt(r)] << 10 | n[t.charCodeAt(r + 1)] << 4 | n[t.charCodeAt(r + 2)] >> 2, s[l++] = e >> 8 & 255, s[l++] = 255 & e), s
                }, e.fromByteArray = function(t) {
                    for (var e, n = t.length, i = n % 3, o = [], f = 0, a = n - i; f < a; f += 16383) o.push(function(t, e, n) {
                ...
                for (var r = [], n = [], i = "u" > typeof Uint8Array ? Uint8Array : Array, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", f = 0, a = o.length; f < a; ++f) r[f] = o[f], n[o.charCodeAt(f)] = f;
            ...
            230: function(t, e, r) {
                ...
                a.isBuffer = function(t) {
                    ...
                    for (r = 0; r < t.length; ++r) {
                        var o = t[r];
                        if (P(o, Uint8Array) && (o = a.from(o)), !a.isBuffer(o)) throw TypeError('"list" argument must be an Array of Buffers');
                    ...
                    for (var o = i - n, f = r - e, u = Math.min(o, f), s = this.slice(n, i), l = t.slice(e, r), h = 0; h < u; ++h)
                        if (s[h] !== l[h]) {
                            o = s[h], f = l[h];
                            break
                        } return o < f ? -1 : +(f < o)
                    ...
                    for (var n = [], i = e; i < r;) {
                        ...
                        if (i + h <= r) switch (h) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                o = t[i + 1], f = t[i + 2], (192 & o) == 128 && (192 & f) == 128 && (u = (15 & s) << 12 | (63 & o) << 6 | 63 & f) > 2047 && (u < 55296 || u > 57343) && (l = u);
                                break;
                            case 4:
                                o = t[i + 1], f = t[i + 2], a = t[i + 3], (192 & o) == 128 && (192 & f) == 128 && (192 & a) == 128 && (u = (15 & s) << 18 | (63 & o) << 12 | (63 & f) << 6 | 63 & a) > 65535 && u < 1114112 && (l = u)
                        }
                ...
                a.prototype.write = function(t, e, r, n) {
                    ...
                    var i, o, f, a, u, s, l, h, c = this.length - e;
                    ...
                    for (var p = !1;;) switch (n) {
                        case "hex":
                            return function(t, e, r, n) {
                                ...
                                n > o / 2 && (n = o / 2);
                                for (var f = 0; f < n; ++f) {
                                    var a, u = parseInt(e.substr(2 * f, 2), 16);
                                    if ((a = u) != a) break;
                                    t[r + f] = u
                                }
                                return f
                        ...
                        case "utf8":
                        case "utf-8":
                            return i = e, o = r, L(S(t, this.length - i), this, i, o);
                        case "ascii":
                            return f = e, a = r, L(O(t), this, f, a);
                        case "latin1":
                        case "binary":
                            return function(t, e, r, n) {
                                return L(O(e), t, r, n)
                        ...
                        case "base64":
                            return u = e, s = r, L(T(t), this, u, s);
                        case "ucs2":
                        case "ucs-2":
                        case "utf16le":
                        case "utf-16le":
                            return l = e, h = r, L(function(t, e) {
                    ...
                    var o = 0,
                        f = 1,
                        a = 0;
                    for (this[e] = 255 & t; ++o < r && (f *= 256);) t < 0 && 0 === a && 0 !== this[e + o - 1] && (a = 1), this[e + o] = (t / f | 0) - a & 255;
                    return e + r
                    ...
                    var o = r - 1,
                        f = 1,
                        a = 0;
                    for (this[e + o] = 255 & t; --o >= 0 && (f *= 256);) t < 0 && 0 === a && 0 !== this[e + o + 1] && (a = 1), this[e + o] = (t / f | 0) - a & 255;
                    return e + r
            ...
            321: function(t, e) {
                e.read = function(t, e, r, n, i) {
                    ...
                    var f, a, u, s = 8 * o - i - 1,
                        ...
                        y = n ? 1 : -1,
                        d = +(e < 0 || 0 === e && 1 / e < 0);
                    for (isNaN(e = Math.abs(e)) || e === 1 / 0 ? (a = +!!isNaN(e), f = l) : (f = Math.floor(Math.log(e) / Math.LN2), e * (u = Math.pow(2, -f)) < 1 && (f--, u *= 2), f + h >= 1 ? e += c / u : e += c * Math.pow(2, 1 - h), e * u >= 2 && (f++, u /= 2), f + h >= l ? (a = 0, f = l) : f + h >= 1 ? (a = (e * u - 1) * Math.pow(2, i), f += h) : (a = e * Math.pow(2, h - 1) * Math.pow(2, i), f = 0)); i >= 8; t[r + p] = 255 & a, p += y, a /= 256, i -= 8);
                    for (f = f << i | a, s += i; s > 0; t[r + p] = 255 & f, p += y, f /= 256, s -= 8);
                    t[r + p - y] |= 128 * d
                }
            }
        },
    ...
    function u() {
        return a ? new a : new f
    }

    function s(t) {
        return a ? a.bind(t) : f.bind(t)
    }
    ...
    let f = (0, n.createContext)(null),
        a = (0, n.forwardRef)(function(t, a) {
            ...
            s && "hidden" === d && g("visible"), a = (0, o.useObjectRef)(a), (0, i.useLayoutEffect)(() => {
                let t = a.current,
                    e = m.current,
                    n = e[u],
                    i = null;
                if (t && s && n) {
                    ...
                    e[u] ? (delete e[u], (0, r.flushSync)(() => g("exiting")), Promise.all(t.getAnimations().map(t => t.finished)).then(() => g("hidden")).catch(() => {})) : g("hidden")
                });
                return () => {
    ...
    t.s(["SharedElement", 0, a, "SharedElementTransition", 0, function(t) {
        let e = (0, n.useRef)({});
    ...
    t.s(["SelectionIndicator", 0, s, "SelectionIndicatorContext", 0, u], 526788)
}, 78070, t => {
    "use strict";
