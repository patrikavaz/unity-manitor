(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 566993, 871726, t => {
    "use strict";
    var e = t.i(141932),
        i = t.i(175602),
        s = t.i(347248),
        ...
        return {
            ...
            velocity: function(t) {
                ...
                let e = t.length - 1,
                    i = null,
                    s = M(t);
                for (; e >= 0 && (i = t[e], !(s.timestamp - i.timestamp > (0, A.secondsToMilliseconds)(.1)));) e--;
                if (!i) return {
                    x: 0,
                    y: 0
                };
                let o = (0, A.millisecondsToSeconds)(s.timestamp - i.timestamp);
                if (0 === o) return {
                    x: 0,
                    y: 0
                };
    ...
    function tQ({
        ...
        return class {
            ...
            update() {
                ...
                if (this.animationId <= this.animationCommitId) return void this.nodes.forEach(t2);
                this.animationCommitId = this.animationId, this.isUpdating ? (this.isUpdating = !1, this.nodes.forEach(t4), this.nodes.forEach(t0), this.nodes.forEach(t1)) : this.nodes.forEach(t2), this.clearAllSnapshots();
                let t = tm.time.now();
            ...
            clearAllSnapshots() {
                this.nodes.forEach(t6), this.sharedNodes.forEach(ei)
            }
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "29f971b7-a4db-5502-a841-627f3f73f6b8")
    } catch (e) {}
}();
//# debugId=29f971b7-a4db-5502-a841-627f3f73f6b8