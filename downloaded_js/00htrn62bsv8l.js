(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 832931, e => {
    "use strict";
    var t = e.i(200241),
        r = e.i(210139);
    ...
    var to = function(e) {
        ...
        tc = "u" > typeof globalThis ? globalThis : e.g || self,
        td = function() {
        ...
        tf = function() {
            ...
            return e.prototype.start = function() {
                this.poller || (this.poller = tc.setInterval(this.action, this.ms), this.action())
            }, e.prototype.stop = function() {
                this.poller && (tc.clearInterval(this.poller), this.poller = void 0)
            }, e
        }(),
        tp = function() {
            function e() {}
    ...
    var tx = function(e, t) {
        ...
        try {
            for (var a = ty(["string", "number", "boolean", "undefined"]), o = a.next(); !o.done; o = a.next())
        ...
        if (s && l) {
            for (var u = 0; u < e.length; u++)
                if (!tx(e[u], t[u])) return !1
        } else {
            if (!tx(Object.keys(e).sort(), Object.keys(t).sort())) return !1;
            var c = !0;
    ...
    var tw = function() {
            ...
            return e.prototype.editIdentity = function() {
                var e = this,
                    t = tm({}, this.identity.userProperties),
                    r = tm(tm({}, this.identity), {
                        userProperties: t
                    });
                return {
                    ...
                    updateUserProperties: function(e) {
                        ...
                        try {
                            for (var u = ty(Object.entries(e)), c = u.next(); !c.done; c = u.next()) {
                                var d = tb(c.value, 2),
                                    h = d[0],
                                    f = d[1];
                                switch (h) {
                                    case "$set":
                                        try {
                                            for (var p = (n = void 0, ty(Object.entries(f))), v = p.next(); !v.done; v = p.next()) {
                                                var g = tb(v.value, 2),
                                                    m = g[0],
                                                    y = g[1];
                                                l[m] = y
                                    ...
                                    case "$unset":
                                        try {
                                            for (var b = (o = void 0, ty(Object.keys(f))), x = b.next(); !x.done; x = b.next()) {
                                                var m = x.value;
                                                delete l[m]
                                            }
                                        } catch (e) {
                ...
                return tm({}, this.identity)
            }, e.prototype.setIdentity = function(e) {
                var t = tm({}, this.identity);
                this.identity = tm({}, e), tx(t, this.identity) || this.listeners.forEach(function(t) {
                    t(e)
                })
        ...
        tk = "u" > typeof globalThis ? globalThis : e.g,
        tj = (function() {
            function e() {
                this.identityStore = new tw, this.eventBridge = new tg, this.applicationContextProvider = new tp
            }
            e.getInstance = function(t) {
                return tk.analyticsConnectorInstances || (tk.analyticsConnectorInstances = {}), tk.analyticsConnectorInstances[t] || (tk.analyticsConnectorInstances[t] = new e), tk.analyticsConnectorInstances[t]
            }
        }(), e.i(484404));
    ...
    var tA = function(e, t) {
            ...
            var r, i, n = tL(e, t),
                a = void 0,
                o = tc.document.cookie.split("; ");
            try {
                for (var s = tP(o), l = s.next(); !l.done; l = s.next()) {
                    var u = l.value,
                        c = tN(u.split("=", 2), 2),
                        d = c[0],
                        h = c[1];
        ...
        tM = function(e) {
            var t = tL(e, !0);
            try {
                var r = tc.localStorage.getItem(t);
                if (!r) return;
                var i = JSON.parse(r);
        ...
        tT = function(e) {
            var t = tL(e, !0);
            try {
                var r = tc.sessionStorage.getItem(t);
                if (!r) return;
                var i = JSON.parse(r);
                if ("object" != typeof i) return;
                return i
        ...
        tU = (function() {
            ...
            e.prototype.setup = function(e, t) {
                ...
                return !!(e || (e = tA(this.apiKey, !1)) || (e = tM(this.apiKey)) || (e = tT(this.apiKey))) && (this.commitIdentityToConnector(e), !0)
                ...
                return tC(this, void 0, void 0, function() {
                    ...
                    return tO(this, function(i) {
                        return (t = this.identityStore.getIdentity()).userId || t.deviceId ? [2] : [2, Promise.race([new Promise(function(e) {
                            ...
                            tc.setTimeout(r, e, "Timed out waiting for Amplitude Analytics SDK to initialize.")
                        })])]
                    })
                })
            }
        }(), tc.fetch || function(e, t) {
        ...
        tD = {
            request: function(e, t, r, i, n) {
                var a;
                return a = tC(void 0, void 0, void 0, function() {
                    var n, a;
    ...
    var tF = function(e) {
        ...
        tK = function() {
            function e(e, t) {
                ...
                this.queue = new tz(n), this.cache = new t$(n)
            }
        ...
        t$ = function() {
            function e(e) {
                this.isSessionStorageAvailable = tQ(), this.inMemoryCache = {}, this.identity = {}, this.storageKey = "EXP_sent_v3_".concat(e), this.isSessionStorageAvailable && (tc.sessionStorage.removeItem("EXP_sent_".concat(e)), tc.sessionStorage.removeItem("EXP_sent_v2_".concat(e)))
            }
            return e.prototype.shouldTrack = function(e, t) {
                ...
                this.inMemoryCache = {}, this.isSessionStorageAvailable && tc.sessionStorage.removeItem(this.storageKey)
                ...
                if (this.isSessionStorageAvailable) {
                    var e = tc.sessionStorage.getItem(this.storageKey);
                    this.inMemoryCache = e ? JSON.parse(e) : {}
                }
            }, e.prototype.storeCache = function() {
                if (this.isSessionStorageAvailable) try {
                    tc.sessionStorage.setItem(this.storageKey, JSON.stringify(this.inMemoryCache))
                } catch (e) {}
            }, e
        }(),
        tz = function() {
            ...
            return e.prototype.push = function(e) {
                ...
                var t = this;
                this.tracker = e, this.poller = tc.setInterval(function() {
                    t.loadFlushStore()
                ...
                if (this.tracker && 0 !== this.inMemoryQueue.length) {
                    ...
                    this.inMemoryQueue = this.inMemoryQueue.slice(e), 0 === this.inMemoryQueue.length && this.poller && (tc.clearInterval(this.poller), this.poller = void 0)
                }
            }, e.prototype.loadQueue = function() {
                if (this.isLocalStorageAvailable) {
                    var e = tc.localStorage.getItem(this.storageKey);
                    this.inMemoryQueue = e ? JSON.parse(e) : []
                }
            }, e.prototype.storeQueue = function() {
                this.isLocalStorageAvailable && (this.inMemoryQueue.length > this.maxQueueSize && (this.inMemoryQueue = this.inMemoryQueue.slice(this.inMemoryQueue.length - this.maxQueueSize)), tc.localStorage.setItem(this.storageKey, JSON.stringify(this.inMemoryQueue)))
        ...
        tG = function() {
            ...
            return e.prototype.error = function(e) {
                ...
                this.logLevel >= o.Error && (t = this.logger).error.apply(t, tI([e], tN(r), !1))
            }, e.prototype.warn = function(e) {
                for (var t, r = [], i = 1; i < arguments.length; i++) r[i - 1] = arguments[i];
                this.logLevel >= o.Warn && (t = this.logger).warn.apply(t, tI([e], tN(r), !1))
            }, e.prototype.info = function(e) {
                for (var t, r = [], i = 1; i < arguments.length; i++) r[i - 1] = arguments[i];
                this.logLevel >= o.Info && (t = this.logger).info.apply(t, tI([e], tN(r), !1))
            }, e.prototype.debug = function(e) {
                for (var t, r = [], i = 1; i < arguments.length; i++) r[i - 1] = arguments[i];
                this.logLevel >= o.Debug && (t = this.logger).debug.apply(t, tI([e], tN(r), !1))
            }, e.prototype.verbose = function(e) {
                for (var t, r = [], i = 1; i < arguments.length; i++) r[i - 1] = arguments[i];
                this.logLevel >= o.Verbose && (t = this.logger).verbose.apply(t, tI([e], tN(r), !1))
            }, e
        }(),
        tB = function() {
            function e() {}
            return e.prototype.error = function(e) {
                ...
                console.error.apply(console, tI([e], tN(t), !1))
            }, e.prototype.warn = function(e) {
                for (var t = [], r = 1; r < arguments.length; r++) t[r - 1] = arguments[r];
                console.warn.apply(console, tI([e], tN(t), !1))
            }, e.prototype.info = function(e) {
                for (var t = [], r = 1; r < arguments.length; r++) t[r - 1] = arguments[r];
                console.info.apply(console, tI([e], tN(t), !1))
            }, e.prototype.debug = function(e) {
                for (var t = [], r = 1; r < arguments.length; r++) t[r - 1] = arguments[r];
                console.debug.apply(console, tI([e], tN(t), !1))
            }, e.prototype.verbose = function(e) {
                for (var t = [], r = 1; r < arguments.length; r++) t[r - 1] = arguments[r];
                console.debug.apply(console, tI([e], tN(t), !1))
            }, e
        ...
        tW = function(e, t, r) {
            ...
            return new tZ("amp-exp-".concat(t, "-").concat(i), r, t0)
        },
        tJ = function(e, t, r) {
            void 0 === r && (r = new tH);
            var i = e.substring(e.length - 6);
        ...
        tY = function(e, t, r) {
            void 0 === r && (r = new tH);
            var i = e.substring(e.length - 6);
            return new tX("amp-exp-".concat(t, "-").concat(i, "-variants-options"), r)
        },
        tX = function() {
            function e(e, t) {
        ...
        tZ = function() {
            ...
            return e.prototype.get = function(e) {
                ...
                return tE({}, this.cache)
            }, e.prototype.put = function(e, t) {
                this.cache[e] = t
            }, e.prototype.putAll = function(e) {
                var t, r;
                try {
                    for (var i = tP(Object.keys(e)), n = i.next(); !n.done; n = i.next()) {
                        var a = n.value;
                        this.cache[a] = e[a]
                    }
                } catch (e) {
                ...
                var n = {};
                try {
                    for (var a = tP(Object.keys(r)), o = a.next(); !o.done; o = a.next()) {
                        var s = o.value;
                        try {
                            var l = void 0;
        ...
        t6 = function(e) {
            return !!t3(e) || e && 0 === Object.keys(e).length
        },
        t5 = function(e) {
            if (!e || "object" != typeof e) return {};
            var t, r, i = {};
            try {
                for (var n = tP(Object.entries(e)), a = n.next(); !a.done; a = n.next()) {
                    var o = tN(a.value, 2),
                        s = o[0],
                        l = o[1];
                    t3(l) || (i[s] = l)
            ...
            return e.prototype.start = function(e) {
                ...
                return tC(this, void 0, void 0, function() {
                    ...
                    return tO(this, function(n) {
                        return this.done || (this.timeoutHandle = tc.setTimeout(function() {
                            return tC(i, void 0, void 0, function() {
                                var i, n;
        ...
        t9 = function(e) {
            ...
            try {
                for (var l = tP(Object.keys(e.groups)), u = l.next(); !u.done; u = l.next()) {
                    var c = u.value,
                        d = e.groups[c];
                    if (d.length > 0 && d[0]) {
                        var h = d[0],
        ...
        ri = function() {
            function e(t, r) {
                ...
                this.engine = new eB, this.isRunning = !1, this.apiKey = t, r = t5(r), this.config = tE(tE(tE({}, tq), r), {
                ...
                }), this.logger = new tG(this.config.loggerProvider || new tB, e.getLogLevel(r));
                var u = null == (o = this.config) ? void 0 : o.internalInstanceNameSuffix;
                if (this.isWebExperiment = "web" === u, this.poller = new tf(function() {
                        return tC(l, void 0, void 0, function() {
                            var e;
                            return tO(this, function(t) {
                                switch (t.label) {
                                    case 0:
                    ...
                    for (var c in this.config.initialVariants) this.config.initialVariants[c] = t0(this.config.initialVariants[c]);
                this.config.userProvider && (this.userProvider = this.config.userProvider), this.config.analyticsProvider && (this.analyticsProvider = new rt(this.config.analyticsProvider)), this.config.exposureTrackingProvider && (this.userSessionExposureTracker = new rr(this.config.exposureTrackingProvider)), this.integrationManager = new tK(this.config, this);
                var d = new tR(this.config.httpClient || tD);
                ...
                s = this.isWebExperiment ? new t1 : new tH, this.variants = tW(this.apiKey, h, s), this.flags = tJ(this.apiKey, h, s), this.fetchVariantsOptions = tY(this.apiKey, h, s);
                try {
            ...
            return e.prototype.start = function(e) {
                ...
                return tC(this, arguments, void 0, function(e, t) {
                    var r;
                    return void 0 === e && (e = this.user), tO(this, function(i) {
                        switch (i.label) {
                            case 0:
                ...
                if (!this.apiKey) return {};
                var e = this.evaluate();
                for (var t in e) t4(this.flags.get(t)) || delete e[t];
                return tE(tE(tE({}, this.secondaryVariants()), this.sourceVariants()), e)
            }, e.prototype.clear = function() {
                this.variants.clear();
                try {
                    this.variants.store()
                ...
                if (null == (e = this.user) || !e.user_properties) return tE({}, this.user);
                var e, t = tE({}, this.user.user_properties);
                return tE(tE({}, this.user), {
                    user_properties: t
                })
                ...
                var t, r, i = this.addContext(this.user),
                    ...
                    s = {};
                try {
                    for (var l = tP(Object.keys(o)), u = l.next(); !u.done; u = l.next()) {
                        var c = u.value;
                        s[c] = re(o[c])
                    }
                } catch (e) {
                ...
                return (t4(i) || !r.variant && i) && (r = this.localEvaluationVariantAndSource(e, i, t)), r
                ...
                var c = t7(this.config.fallbackVariant),
                    d = {
                        variant: c,
                ...
                var s = t7(this.config.fallbackVariant),
                    u = {
                        variant: s,
                        source: l.FallbackConfig,
                        hasDefaultVariant: i.hasDefaultVariant
                ...
                return tC(this, void 0, void 0, function() {
                    ...
                    return tO(this, function(s) {
                        switch (s.label) {
                            ...
                            case 1:
                                return s.trys.push([1, 4, , 5]), [4, this.doFetch(e, t, tE({
                ...
                return tC(this, void 0, void 0, function() {
                    return tO(this, function(t) {
                        return this.fetchVariantsOptions.put(tE(tE({}, this.fetchVariantsOptions.get() || {}), {
                ...
                return tC(this, void 0, void 0, function() {
                    ...
                    return tO(this, function(c) {
                        switch (c.label) {
                            ...
                            case 1:
                                return e = c.sent(), e = this.cleanUserPropsForFetch(e), this.logger.debug("[Experiment] Fetch variants for user: ", e), [4, this.evaluationApi.getVariants(e, tE({
                                    timeoutMillis: t
                                }, r))];
                            case 2:
                                i = c.sent(), n = {};
                                try {
                                    for (o = (a = tP(Object.keys(i))).next(); !o.done; o = a.next()) n[s = o.value] = re(i[s])
                                } catch (e) {
                                    l = {
                                        error: e
                                    }
                ...
                return tC(this, void 0, void 0, function() {
                    var r = this;
                    return tO(this, function(i) {
                        return this.logger.debug("[Experiment] Retry fetch"), this.retriesBackoff = new t8(8, 500, 1e4, 1.5), this.retriesBackoff.start(function() {
                            return tC(r, void 0, void 0, function() {
                                return tO(this, function(r) {
                                    switch (r.label) {
                                        case 0:
                ...
                var t, r = null == (t = this.userProvider) ? void 0 : t.getUser(),
                    ...
                    n = tE(tE(tE({}, null == r ? void 0 : r.user_properties), i.user_properties), null == e ? void 0 : e.user_properties);
                return tE(tE(tE(tE({
                    library: "experiment-js-client/".concat(tV)
                }, r), i), e), {
                    user_properties: n
                })
                ...
                if (this.analyticsProvider) {
                    var l = t2(this.addContext(this.getUser()), e, t, r);
                    !tF(r) && (null == t ? void 0 : t.value) ? (null == t ? void 0 : t.value) && (null == (o = null == (a = this.analyticsProvider) ? void 0 : a.setUserProperty) || o.call(a, l), null == (s = this.analyticsProvider) || s.track(l)) : null == (n = null == (i = this.analyticsProvider) ? void 0 : i.unsetUserProperty) || n.call(i, l)
                }
        ...
        rn = function() {
            function e(e, t) {
                var r, i, n;
                this.globalScope = td(), this.userAgent = void 0 !== (null == (r = this.globalScope) ? void 0 : r.navigator) ? null == (i = this.globalScope) ? void 0 : i.navigator.userAgent : void 0, this.ua = new tj.UAParser(this.userAgent).getResult(), this.localStorage = new tH, this.sessionStorage = new t1, this.userProvider = e, this.apiKey = t, this.storageKey = "EXP_".concat(null == (n = this.apiKey) ? void 0 : n.slice(0, 10), "_DEFAULT_USER_PROVIDER")
            }
            return e.prototype.getUser = function() {
                ...
                if (this.globalScope) {
                    ...
                    try {
                        ...
                        try {
                            for (var a = tP(n.searchParams), o = a.next(); !o.done; o = a.next()) {
                                var s = tN(o.value, 2),
                                    l = s[0],
                                    u = s[1];
                                i[l] = tI(tI([], tN(null != (r = i[l]) ? r : []), !1), tN(u.split(",")), !1)
                            }
                        } catch (t) {
                            e = {
                                error: t
    ...
    tc.experimentInstances = {};
    var ra = tc.experimentInstances,
        ro = function(e, t) {
        ...
        rs = function(e, t, r) {
            var i = ro(e, t),
                n = ra[i];
            return n ? n : (n = new ri(e, tE(tE({}, t), {
                userProvider: new rn(null == t ? void 0 : t.userProvider, e)
            })), r && n.addPlugin(r()), ra[i] = n, n)
        };
    ...
    rl.prototype.getUser = function() {
        return {}
    }, rl.prototype.start = function(e) {
        return tC(this, void 0, void 0, function() {
            return tO(this, function(e) {
                return [2]
            })
        })
    }, rl.prototype.stop = function() {}, rl.prototype.setUser = function(e) {}, rl.prototype.fetch = function(e, t) {
        return tC(this, void 0, void 0, function() {
            return tO(this, function(e) {
                return [2, this]
            })
        })
    }, rl.prototype.getUserProvider = function() {
        return null
    }, rl.prototype.setUserProvider = function(e) {
        return this
    }, rl.prototype.variant = function(e, t) {
        return tq.fallbackVariant
    }, rl.prototype.all = function() {
        return {}
    }, rl.prototype.clear = function() {}, rl.prototype.exposure = function(e) {};
    let rd = (0, d.default)(() => e.A(191233), {
        loadableGenerated: {
            modules: [807973]
        },
        ssr: !1
            ...
            return (0, c.useEffect)(() => {
                ...
                return (async () => {
                    let {
                        deviceId: e,
                        userId: a
                    } = ru(), o = await Promise.all(t.map(async e => {
                        let t = await rc(e);
                        return [e, t]
                    }));
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "8b3b66a0-2a5d-5db9-9867-91343029e656")
    } catch (e) {}
}();
//# debugId=8b3b66a0-2a5d-5db9-9867-91343029e656