(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 389240, e => {
    ...
    e.s(["default", 0, ({
        ...
        let g = (0, a.useRef)(null),
            ...
            S = v ? j : p && !x,
            T = !!r?.src && !(w && N),
            R = o ? "string" == typeof o ? o : j ? o.playing : o.paused : "none",
            E = v ? () => L(!0) : void 0;
        return (0, t.jsxs)("div", {
            ref: g,
    ...
    j.Block = ({
        ...
        let [k, N] = (0, l.useState)(!1), [C, L] = (0, l.useState)(!1), S = (0, l.useRef)(null), T = (0, m.useInView)(S, {
            ...
            target: S
        }), z = (0, c.useTransform)(B, [E, y !== w - 1 ? E + M : 1], [0, 1], {
            ease: u.easeInOut
        }), A = (0, c.useTransform)(B, [E, y !== w - 1 ? E + M : 1], [100, 0], {
            ease: u.easeInOut
        }), I = -((S.current?.offsetHeight || 0) / w) * y;
        f(B, "change", e => {
            N(e >= E)
        });
        let D = (0, i.default)("object-cover transition-opacity duration-1000", {
                "opacity-0": C
            }),
            P = (0, t.jsx)("div", {
    ...
    function B(e) {
        return z(e, "defaultColor", [0, 0, 0, 0])
    }
    ...
    function A(e) {
        var t, a, l;
        return (t = e, "u" > typeof HTMLCanvasElement && t instanceof HTMLCanvasElement) ? "canvas" : (a = e, D && a instanceof OffscreenCanvas) ? "offscreencanvas" : P(e) ? "videoframe" : (l = e, "u" > typeof ImageBitmap && l instanceof ImageBitmap) ? "imagebitmap" : e.src
    }

    function I(e) {
        return "u" > typeof HTMLImageElement && e instanceof HTMLImageElement
    }
    var D = "u" > typeof OffscreenCanvas;
    ...
    var O = function() {
        ...
        return e.prototype.getColorAsync = function(e, t) {
            ...
            if (!e) {
                ...
                return _(u, t.silent), this.prepareResult(c, u)
            }
            var m = (a = function(e) {
                if (I(e)) {
            ...
            }(e), r = z(l = t, "left", 0), i = z(l, "top", 0), n = z(l, "width", a.width), s = z(l, "height", a.height), o = n, d = s, "precision" === l.mode || (n > s ? d = Math.round((o = 100) / (n / s)) : o = Math.round((d = 100) / (s / n)), (o > n || d > s || o < 10 || d < 10) && (o = n, d = s)), {
                srcLeft: r,
                srcTop: i,
                srcWidth: n,
                srcHeight: s,
            ...
            if (!m.srcWidth || !m.srcHeight || !m.destWidth || !m.destHeight) {
                var u = F('incorrect sizes for resource "'.concat(A(e), '"'));
                return _(u, t.silent), this.prepareResult(c, u)
            }
            if (!this.canvas && (this.canvas = H ? D ? new OffscreenCanvas(1, 1) : null : document.createElement("canvas"), !this.canvas)) {
            ...
            if (!this.ctx) {
                if (this.ctx = this.canvas.getContext("2d", {
                    ...
                    return _(u, t.silent), this.prepareResult(c)
                }
            ...
            try {
                ...
                var u = F("security error (CORS) for resource ".concat(A(e), ".\nDetails: https://developer.mozilla.org/en/docs/Web/HTML/CORS_enabled_image"));
                return _(u, t.silent), t.silent || console.error(a), this.prepareResult(c, u)
            }
    ...
    let el = {
            ...
            keyFigures: F.default,
            quote: T.default,
            statement: R.default,
            footnote: E.default,
            logosBank: B.default,
            featuresList: z.default,
            title: A.default,
            testimonialsBlock: I.default,
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "c4665014-6de7-5b5a-973b-b6b757ef3ee0")
    } catch (e) {}
}();
//# debugId=c4665014-6de7-5b5a-973b-b6b757ef3ee0