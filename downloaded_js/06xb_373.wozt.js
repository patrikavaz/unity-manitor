(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 480880, e => {
    ...
    e.s(["default", 0, () => {
        ...
        return {
            ...
            appendCommerceDataToPortableText: f,
    ...
    e.s(["useMTBanner", 0, function(e, r = []) {
        ...
        return {
            ...
            updatedBlocks: (i = e.blocks ?? [], s = e.machineTranslationDisclaimer, n = i.reduce((e, t, l) => ["hero", "alternateNavigation", "headliner"].includes(t._type) ? l : e, -1), d = [...i], o = d[n + 1]?._type === "alternateNavigationAnchor" || d[n + 1]?._type === "anchorButton" ? d[n + 2] : d[n + 1], c = o?.theme ?? null, u = {
                _type: "alert",
                text: s?.text,
                isContained: !0,
                spacing: {
    ...
    m.Actions = ({
        ...
        }), v = (e, l) => c?.asset.url ? (0, t.jsx)(a.default, {
            src: c.asset.url,
            alt: e,
            fill: !0,
        ...
        return (0, t.jsx)("div", {
            ...
            children: (c || u) && (0, t.jsxs)("div", {
                ...
                children: [(0, t.jsx)(o, {
                    ...
                    ref: h,
                    className: p,
                    children: [c?.asset.url && !u && v("Hero image", void 0), u && c?.asset.url && !m && v("Video thumbnail", "z-10"), u && (0, t.jsx)("div", {
        ...
        let P = o ?? void 0,
            ...
            O = e => {
                let t = e.link?.linkReference?.href?.current,
                    l = t ? (0, b.default)(t, S, e.extendLink) : t,
            ...
            I = i?.filter(e => !!e.operatingSystem && "Unknown" !== e.operatingSystem) || [];
        return (0, t.jsx)(t.Fragment, {
    ...
    e.s(["default", 0, ({
        ...
        let [b] = (0, l.useContext)(h.FiltersContext), {
            state: v
        } = (0, f.default)(), j = {
            ...v,
            ...
            _id: e
        }) => e === b.selectedCategory) || {}, _ = null != b.selectedSubcategory ? (N || []).find(({
            _id: e
        }) => e === b.selectedSubcategory) : null, L = !p || p.categories?.find(e => e._id === b.selectedCategory) != null && (null == _ || !p.subcategories || p.subcategories.some(({
            _id: e
        }) => e === b.selectedSubcategory)), R = n ? {
    ...
    let m = (0, l.forwardRef)(function({
        ...
        let w = (0, c.useObjectRef)(k),
            ...
            C = (0, r.clsx)("w-full transition-all duration-300 shrink-0 ", {
                "fill-gray-400": b
            }),
            T = (0, r.clsx)(C, {
            ...
            $ = (0, r.clsx)(C, "fill-black dark:fill-white");
        if (g) {
            let e = (0, o.mergeProps)(L, R, M);
    ...
    e.s(["useReducedMotion", 0, function() {
        a.hasReducedMotionListener.current || (0, l.initPrefersReducedMotion)();
    ...
    let n = ({
            ...
            let [u, m] = (0, l.useState)(!1), f = "relative block border-t border-solid border-gray-200 dark:border-gray-700", h = (0, t.jsxs)("div", {
    ...
    g.displayName = "DesktopNav", p.displayName = "MobileNav", e.s(["default", 0, ({
        ...
        let s = (0, u.default)(`(max-width: ${c.default.Large}px)`),
            ...
            _ = () => {
                let e;
                n.current && (n.current.offsetTop < window.scrollY ? j(!0) : j(!1)), w.current > window.scrollY && v ? b(!0) : w.current < window.scrollY && b(!1), w.current = window.scrollY, n.current && (n.current.offsetTop > window.innerHeight && !h ? k(!0) : k(!1)), e = null, m.forEach((t, l) => {
    ...
    e.s(["default", 0, ({
        ...
        className: (0, l.clsx)("md:px-auto w-full px-4 transition-colors", {
            ...
            "rounded-br-lg rounded-bl-lg": i && !s
        }, n),
        children: (0, t.jsxs)("div", {
    ...
    e.s(["default", 0, ({
        ...
        return f && f !== h ? null : (0, t.jsx)(t.Fragment, {
            ...
            children: (0, t.jsxs)("div", {
                ...
                children: [(0, t.jsxs)("div", {
                    ...
                    children: [i?.src && (0, t.jsxs)("div", {
                        ...
                        controls: !g,
                        config: w
                    }), o?.src?.includes("youtube.com") && (0, t.jsx)(m.default, {
                        blockedMessage: p,
                        consentButtonLabel: b
                    })]
                }), h && (0, t.jsx)("div", {
    ...
    e.s(["default", 0, ({
        ...
        let [f] = (0, l.useContext)(o.FiltersContext), {
            subcategories: h
        } = f.categories?.find(({
            _id: e
        }) => e === f.selectedCategory) || {}, x = null != f.selectedSubcategory ? (h || []).find(({
            _id: e
        }) => e === f.selectedSubcategory) : null, g = !m || m.categories?.find(e => e._id === f.selectedCategory) != null && (null == x || !m.subcategories || m.subcategories.some(({
            _id: e
        }) => e === f.selectedSubcategory)), p = (0, c.default)("dark:bg-black", {
        ...
        }), v = (0, c.default)("[&>*]:loco-text-body [&>*]:mb-4", {
    ...
    e.s(["default", 0, ({
        ...
        let {
            ...
            _id: e
        }) => e === R.selectedCategory) || {}, S = null != R.selectedSubcategory ? (A || []).find(({
            _id: e
        }) => e === R.selectedSubcategory) : null, C = !L || L.categories?.find(e => e._id === R.selectedCategory) != null && (null == S || !L.subcategories || L.subcategories.some(({
            _id: e
    ...
    let k = (0, i.default)(() => e.A(410979), {
        ...
        N = ({
            ...
            let [s, o] = (0, n.useState)(void 0), [c, u] = (0, n.useState)(void 0), [m, f] = (0, n.useState)(1), [h, g] = (0, n.useState)(0), [p, b] = (0, n.useState)(0), v = (0, n.useRef)(null), k = (0, n.useRef)(null), N = (0, n.useRef)(null), _ = (0, r.useReducedMotion)();
            (0, n.useEffect)(() => {
    ...
    let p = ({
            ...
            let R = (0, h.default)(`(min-width: ${u.default.Medium}px)`),
                ...
                $ = null;
            "youtube" === g ? $ = (0, o.default)(() => e.A(269100), {
                loadableGenerated: {
                    modules: [346003]
                },
                ssr: !1
            }) : "brandfolder" === g && ($ = (0, o.default)(() => e.A(410979), {
                loadableGenerated: {
                    modules: [942019]
                },
                ssr: !1
            ...
            }), E = (0, i.useTransform)(P, [0, 1], ["60%", "100%"]), O = (0, i.useTransform)(P, [0, 1], [1.75, 1]), B = (0, i.useTransform)(P, [0, 1], ["brightness(50%)", "brightness(100%)"]), I = () => {
                k && "brandfolder" === g && S(!0)
            }, z = () => {
                S(!0)
            }, U = (0, d.default)("top-0 left-0 h-full w-full absolute z-10 transition-opacity duration-500 object-cover", {
                "opacity-0 pointer-events-none": M && !T && C && y?.src
            });
            return (0, t.jsxs)("div", {
                ref: A,
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "1d1b3fd6-0596-5bf7-b73a-ef68f6597a1f")
    } catch (e) {}
}();
//# debugId=1d1b3fd6-0596-5bf7-b73a-ef68f6597a1f