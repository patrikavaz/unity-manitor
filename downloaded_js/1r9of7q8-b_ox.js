(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 722978, e => {
    "use strict";
    ...
    e.s(["createNavigation", 0, function(e) {
        let {
            ...
            function g(e) {
                ...
                return null == p ? "object" == typeof n ? (t = n.pathname, n.query && (t += E(n.query))) : t = n : t = function({
                        pathname: e,
                        locale: t,
                        params: r,
                        pathnames: n,
                        ...
                        function o(e) {
                            ...
                            }), o = new URL(o = o.replace(/\[\[\.\.\..+\]\]/g, ""), "http://l").pathname) : o = e, o = c(o), i && (o += E(i)), o
                        }
                ...
                return (0, r.useMemo)(() => {
                    function t(e) {
                        return function(t, r) {
                            ...
                            Object.keys(s).length > 0 && a.push(s), y(p.localeCookie, o, i, n), e(...a)
                        }
                    }
                    return {
                        ...e,
    ...
    function b(t) {
        var r;
        let n, i, o, [b, y] = (0, a.useOptimistic)(d.IDLE_LINK_STATUS),
            v = (0, a.useRef)(null),
            {
                href: T,
                as: P,
        ...
        n = H, O && ("string" == typeof n || "number" == typeof n) && (n = (0, s.jsx)("a", {
            children: n
        }));
        let D = a.default.useContext(u.AppRouterContext),
            x = !1 !== S,
            U = !1 === S ? "none" : !0 === S ? "full" : "auto",
            G = "none" !== U ? "auto" === U ? m.FetchStrategy.PPR : m.FetchStrategy.Full : m.FetchStrategy.PPR,
            K = "string" == typeof(r = P || T) ? r : (0, l.formatUrl)(r);
        if (O) {
        ...
        let V = O ? i && "object" == typeof i && i.ref : k,
            W, j = a.default.useCallback(e => (null !== D && (v.current = (0, d.mountLinkInstance)(e, K, D, G, x, y, W)), () => {
                v.current && ((0, d.unmountLinkForCurrentNavigation)(v.current), v.current = null), (0, d.unmountPrefetchableInstance)(e)
            }), [x, K, D, G, y, W]),
            $ = {
                ref: (0, c.useMergedRef)(j, V),
                onClick(t) {
                    O || "function" != typeof C || C(t), O && i.props && "function" == typeof i.props.onClick && i.props.onClick(t), !D || t.defaultPrevented || function(t, r, n, i, o, s, l, u = "none") {
                        if ("u" > typeof window) {
                            let c, {
                                nodeName: h
                            } = t.currentTarget;
                            if ("A" === h.toUpperCase() && ((c = t.currentTarget.getAttribute("target")) && "_self" !== c || t.metaKey || t.ctrlKey || t.shiftKey || t.altKey || t.nativeEvent && 2 === t.nativeEvent.which) || t.currentTarget.hasAttribute("download")) return;
                            if (!(0, g.isLocalURL)(r)) {
                            ...
                            a.default.startTransition(() => {
                                f(r, i ? "replace" : "push", !1 === o ? p.ScrollBehavior.NoScroll : p.ScrollBehavior.Default, n.current, l, u)
                            })
                        }
                    }(t, K, v, B, A, _, R, U)
                },
                onMouseEnter(e) {
                    O || "function" != typeof M || M(e), O && i.props && "function" == typeof i.props.onMouseEnter && i.props.onMouseEnter(e), D && x && (0, d.onNavigationIntent)(e.currentTarget, !0 === N)
                },
                onTouchStart: function(e) {
                    O || "function" != typeof I || I(e), O && i.props && "function" == typeof i.props.onTouchStart && i.props.onTouchStart(e), D && x && (0, d.onNavigationIntent)(e.currentTarget, !0 === N)
                }
            };
        return (0, h.isAbsoluteUrl)(K) ? $.href = K : O && !L && ("a" !== i.type || "href" in i.props) || ($.href = (0, f.addBasePath)(K)), o = O ? a.default.cloneElement(i, $) : (0, s.jsx)("a", {
            ...F,
            ...$,
            children: n
        }), (0, s.jsx)(E.Provider, {
    ...
    let E = (0, a.createContext)(d.IDLE_LINK_STATUS),
        y = () => (0, a.useContext)(E);
    ...
    "use strict";
    let t = e.i(409781).default.createContext({
        register: () => {}
    });
    ...
    let S = (e, t) => {
        ...
        t && i.removeEventListener("DOMContentLoaded", t), p.has(r) && (Reflect.defineProperty(r.HTMLElement.prototype, "focus", {
            ...
            writable: !0,
            value: p.get(r).focus
        }), i.removeEventListener("keydown", E, !0), i.removeEventListener("keyup", E, !0), i.removeEventListener("click", v, !0), r.removeEventListener("focus", T, !0), r.removeEventListener("blur", P, !1), "u" > typeof PointerEvent && (i.removeEventListener("pointerdown", y, !0), i.removeEventListener("pointermove", y, !0), i.removeEventListener("pointerup", y, !0)), p.delete(r))
    };
                ...
                let e = U.current,
                    ...
                    c = t => {
                        if (e.isPressed && e.target && P(t, e.target)) {
                            ...
                            j(H(e.target, t), "keyboard", n), n && J(t, e.target), K(), "Enter" !== t.key && T(e.target) && (0, o.nodeContains)(e.target, r) && !t[E] && (t[E] = !0, (0, h.openLink)(e.target, t, !1)), e.isPressed = !1, e.metaKeyEvents?.delete(t.key)
  ...
  [${v}] {
    ...
    function E(...e) {
        return 1 === e.length && e[0] ? e[0] : t => {
            ...
            if (r) return () => {
                n.forEach((t, r) => {
                    "function" == typeof t ? t() : y(e[r], null)
                })
            }
        }
    }
    ...
    e.s(["mergeProps", 0, function(...e) {
        ...
        for (let n = 1; n < e.length; n++) {
            ...
            for (let e in i) {
                let n = t[e],
                    o = i[e];
                "function" == typeof n && "function" == typeof o && "o" === e[0] && "n" === e[1] && e.charCodeAt(2) >= 65 && 90 >= e.charCodeAt(2) ? t[e] = (0, r.chain)(n, o) : ("className" === e || "UNSAFE_className" === e) && "string" == typeof n && "string" == typeof o ? t[e] = v(n, o) : "id" === e && n && o ? t.id = b(n, o) : "ref" === e && n && o ? t.ref = E(n, o) : t[e] = void 0 !== o ? o : n
            }
        }
        return t
    }], 429305)
                        ...
                        for (let r of e) {
                            ...
                            let n = function(e) {
                                ...
                                if ("E" === e[0] && "E" === e[1] ? (t = {
                                    ...
                                    let r = e.slice(0, 2);
                                    if ("+!" === r ? (t.signDisplay = "always", e = e.slice(2)) : "+?" === r && (t.signDisplay = "exceptZero", e = e.slice(2)), !E.test(e)) throw Error("Malformed concise eng/scientific notation");
