(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 720728, e => {
    "use strict";
    var t = e.i(259457),
        l = e.i(575414),
        i = e.i(429305),
    ...
    var t = e.i(419685),
        l = e.i(398824);
    e.s(["SelectionManager", 0, class e {
        constructor(e, t, l) {
    ...
    class s {
        build(e, t) {
            ...
            if (i.default.isValidElement(t) && t.type === i.default.Fragment) yield* this.iterateCollection({
                ...
                let e = [];
                i.default.Children.forEach(t, t => {
                    t && e.push(t)
                });
                let l = 0;
                for (let t of e)
        ...
        getChildState(e, t) {
            ...
            if (i.default.isValidElement(e.element) && e.element.type === i.default.Fragment) {
                let r = [];
                i.default.Children.forEach(e.element.props.children, e => {
                    r.push(e)
                });
                let n = e.index ?? 0;
            ...
            if (!o && e.value && t && t.renderer) {
                ...
                if (l && (!l.shouldInvalidate || !l.shouldInvalidate(this.context))) {
                    l.index = e.index, l.parentKey = s ? s.key : null, yield l;
                    return
                }
                o = t.renderer(e.value)
            }
            if (i.default.isValidElement(o)) {
                let i = o.type;
                ...
                for (; !u.done && u.value;) {
                    ...
                    e.index = c;
                    let a = i.key ?? null;
                    null == a && (a = i.element ? null : this.getKey(o, e, t, l));
                    ...
                    }, this.getChildState(t, i), l ? `${l}${o.key}` : o.key, s)];
                    for (let t of d) {
                        if (t.value = i.value ?? e.value ?? null, t.value && this.cache.set(t.value, t), e.type && t.type !== e.type) throw Error(`Unsupported type <${n(t.type)}> in <${n(s?.type??"unknown parent type")}>. Only <${n(e.type)}> is supported.`);
                        c++, yield t
                    }
                    u = r.next(d)
                }
    ...
    e.s(["useCollection", 0, function(e, t, l) {
        let r = (0, i.useMemo)(() => new s, []),
            {
                children: n,
                items: o,
                collection: c
            } = e;
        return (0, i.useMemo)(() => c || t(r.build({
            children: n,
            items: o
        }, l)), [r, n, o, c, l, t])
    }], 485286)
