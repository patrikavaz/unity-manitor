(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 740041, t => {
            ...
            230: function(t, e, r) {
                ...
                u.isBuffer = function(t) {
                    ...
                    for (r = 0; r < t.length; ++r) {
                        var o = t[r];
                        if (C(o, Uint8Array) && (o = u.from(o)), !u.isBuffer(o)) throw TypeError('"list" argument must be an Array of Buffers');
    ...
    var e = t.i(409781),
        r = t.i(785328);
    let n = (0, e.createContext)(void 0);
    t.s(["MangoThemeProvider", 0, function({
        theme: t,
        children: i
    }) {
        let o = (0, e.useContext)(n);
