(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 690019, e => {
    "use strict";
    var t = e.i(500783),
        a = e.i(722978);
    let l = {
    ...
    let u = (0, e.i(828083).default)(() => e.A(410979), {
        ...
        p = ({
            ...
            children: (0, t.jsx)(c.default, {
                disableAnimation: !0,
                iconComponent: a ? s.Pause : o.Play,
                iconWeight: "fill",
                variant: "secondary",
                size: h[e],
                onClick: l,
    ...
    e.s(["default", 0, ({
        ...
        let h = (0, a.useRef)(null),
            ...
            A = b ? y : x && !v,
            C = !!r?.src && !(k && L),
            H = d ? "string" == typeof d ? d : y ? d.playing : d.paused : "none",
            V = b ? () => M(!0) : void 0;
        return (0, t.jsxs)("div", {
            ref: h,
    ...
    j.Block = ({
        ...
        let [k, N] = (0, l.useState)(!1), [L, E] = (0, l.useState)(!1), M = (0, l.useRef)(null), A = (0, m.useInView)(M, {
            once: !0
        }), C = (0, f.useReducedMotion)(), H = 1 / w * y, V = .75 * H, {
            scrollYProgress: S
        } = (0, d.useScroll)({
            target: M
        }), T = (0, c.useTransform)(S, [H, y !== w - 1 ? H + V : 1], [0, 1], {
            ease: u.easeInOut
        }), P = (0, c.useTransform)(S, [H, y !== w - 1 ? H + V : 1], [100, 0], {
            ease: u.easeInOut
        }), R = -((M.current?.offsetHeight || 0) / w) * y;
        h(S, "change", e => {
            N(e >= H)
        });
        let Z = (0, n.default)("object-cover transition-opacity duration-1000", {
                "opacity-0": L
            }),
            F = (0, t.jsx)("div", {
            ...
            B = (0, n.default)("absolute h-full w-full", {
                        ...
                        case 5:
                            if (function(e, t, a) {
                                    var l = a[0],
                                        ...
                                        o = e[t + 3],
                                        d = A(o, i, s);
                                    return i ? !!(!o && d || A(e[t], l, s) && A(e[t + 1], r, s) && A(e[t + 2], n, s) && d) : d
                                }(e, t, a)) return !0;
                            break;
                        default:
                            return !1
    ...
    function P(e) {
        var t, a, l;
        return (t = e, "u" > typeof HTMLCanvasElement && t instanceof HTMLCanvasElement) ? "canvas" : (a = e, Z && a instanceof OffscreenCanvas) ? "offscreencanvas" : F(e) ? "videoframe" : (l = e, "u" > typeof ImageBitmap && l instanceof ImageBitmap) ? "imagebitmap" : e.src
    }

    function R(e) {
        return "u" > typeof HTMLImageElement && e instanceof HTMLImageElement
    }
    var Z = "u" > typeof OffscreenCanvas;
    ...
    var I = function() {
        ...
        return e.prototype.getColorAsync = function(e, t) {
            if (!e) return Promise.reject(D("call .getColorAsync() without resource"));
            if ("string" == typeof e) {
                if ("u" < typeof Image) return Promise.reject(D("resource as string is not supported in this environment"));
                var a = new Image;
                return a.crossOrigin = t && t.crossOrigin || "", a.src = e, this.bindImageEvents(a, t)
            }
            if (R(e) && !e.complete) return this.bindImageEvents(e, t);
            var l = this.getColor(e, t);
            return l.error ? Promise.reject(l.error) : Promise.resolve(l)
        }, e.prototype.getColor = function(e, t) {
            var a, l, r, n, i, s, o, d, c = S(t = t || {});
            if (!e) {
                var u = D("call .getColor() without resource");
                return O(u, t.silent), this.prepareResult(c, u)
            }
            var m = (a = function(e) {
                if (R(e)) {
            ...
            }(e), r = T(l = t, "left", 0), n = T(l, "top", 0), i = T(l, "width", a.width), s = T(l, "height", a.height), o = i, d = s, "precision" === l.mode || (i > s ? d = Math.round((o = 100) / (i / s)) : o = Math.round((d = 100) / (s / i)), (o > i || d > s || o < 10 || d < 10) && (o = i, d = s)), {
                srcLeft: r,
                srcTop: n,
                srcWidth: i,
                srcHeight: s,
            ...
            if (!m.srcWidth || !m.srcHeight || !m.destWidth || !m.destHeight) {
                var u = D('incorrect sizes for resource "'.concat(P(e), '"'));
                return O(u, t.silent), this.prepareResult(c, u)
            }
            if (!this.canvas && (this.canvas = B ? Z ? new OffscreenCanvas(1, 1) : null : document.createElement("canvas"), !this.canvas)) {
                var u = D("OffscreenCanvas is not supported in this browser");
                return O(u, t.silent), this.prepareResult(c, u)
            }
            if (!this.ctx) {
                if (this.ctx = this.canvas.getContext("2d", {
                    ...
                    var u = D("Canvas Context 2D is not supported in this browser");
                    return O(u, t.silent), this.prepareResult(c)
                }
            ...
            try {
                ...
                var u = D("security error (CORS) for resource ".concat(P(e), ".\nDetails: https://developer.mozilla.org/en/docs/Web/HTML/CORS_enabled_image"));
                return O(u, t.silent), t.silent || console.error(a), this.prepareResult(c, u)
            }
            ...
            switch (t.algorithm || "sqrt") {
                ...
                case "dominant":
                    ...
                    break;
                default:
                    throw D("".concat(t.algorithm, " is unknown algorithm"))
            }
            return a(e, r - r % 4, {
                defaultColor: n,
            ...
            return new Promise(function(l, r) {
                var n = function() {
                    ...
                    i = function() {
                        o(), r(D('Error loading image "'.concat(e.src, '"')))
                    },
                    s = function() {
                        o(), r(D('Image "'.concat(e.src, '" loading aborted')))
                    },
                    o = function() {
    ...
    let z = e => [parseInt(e.slice(1, 3), 16), parseInt(e.slice(3, 5), 16), parseInt(e.slice(5, 7), 16)],
        _ = (e, t) => {
            let a, l, r, [n, i, s] = z(e),
                        ...
                        children: [e.details && e.details.length > 0 && (0, t.jsx)("ul", {
                            ...
                            children: [e.description?.readMoreLabel && (0, t.jsx)(w.default, {
                                ...
                                children: (0, t.jsx)(w.default, {
                                    ...
                                    variant: "primary",
                                    icon: "arrow-right",
                                    "data-link-location": q.trackingLocation.deluxeAnnouncementBannerAction,
    ...
    e.s(["default", 0, ({
        ...
        return ((0, l.useEffect)(() => {
            ...
            children: c && (0, t.jsx)(G, {
                ...
                image: {
                    src: s ? (0, K.urlForImage)(s)?.fit("crop").width(1200).height(750).dpr(2).url() ?? "" : "",
                    alt: s?.alt ?? "",
    ...
    let x = (0, f.default)(() => e.A(410979), {
        ...
        v = ({
            ...
            let n = (0, i.useRef)(null),
                ...
                E = (0, m.useTransform)(y, [0, .9], [1, 0]),
                M = (0, m.useTransform)(y, [0, .9], [0, 1]),
                A = (0, m.useTransform)(y, [0, 1], ["5vh", "40vh"]),
                C = (0, p.default)("z-10 transition-opacity duration-500 object-cover brightness-50", {
    ...
    let U = {
        ...
        W = ({
            ...
            let [v, b] = (0, i.useState)(o), j = u ? U[u.toUpperCase()] || u : void 0, y = new Intl.DateTimeFormat(g, {
                month: "short",
                day: "numeric",
                timeZone: j
    ...
    let el = {
            ...
            footnote: H.default,
            logosBank: S.default,
            featuresList: T.default,
            title: P.default,
            testimonialsBlock: R.default,
            animatedFeaturesList: B.default,
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "6e0cb6ec-24ea-5bed-ac9c-7f7e8a216345")
    } catch (e) {}
}();
//# debugId=6e0cb6ec-24ea-5bed-ac9c-7f7e8a216345