(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 394225, e => {
    ...
    let ej = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,
        eC = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,
        eN = [p, h, b, N, E, T, I, P, eb, ev, ex, ek],
        eT = [...eN, /^[^\n]+(?:  \n|\n{2,})/, L, O];
    ...
    function e$(e, t, r) {
        ...
        return l.forEach(function(e, t) {
            "tableSeparator" === e.type ? 0 !== t && t !== l.length - 1 && a.push([]) : ("text" !== e.type || null != l[t + 1] && "tableSeparator" !== l[t + 1].type || (e.v = e.v.replace(U, "")), a[a.length - 1].push(e))
        }), a
    }
    ...
    function ez(e, t, r) {
        ...
        return n.cloneElement(function(e, t = {}) {
            ...
            function U(e, r, ...n) {
                ...
                return X((o = ez(a = t.overrides, e)) ? "function" == typeof o || "object" == typeof o && "render" in o ? o : ez(a, `${e}.component`, e) : e, l({}, r, s, {
...
`, {
                ...
                if (a.length > 1 || t.forceWrapper) r = a;
                    ...
                    if (1 === a.length) return "string" == typeof(r = a[0]) ? U("span", {
                        key: "outer"
                    }, r) : r;
                    r = null
                }
            ...
            function q(e) {
                ...
                return t ? t.reduce(function(e, t, r) {
                    ...
                    if (-1 !== l) {
                        var a, s, i;
                        let c, u = (-1 !== (a = t.slice(0, l)).indexOf("-") && null === a.match(H) && (a = a.replace(A, function(e, t) {
                            ...
                            }, {}) : "href" === u ? eA(i) : (i.match(S) && (i = i.slice(1, i.length - 1)), "true" === i || "false" !== i && i));
            ...
            let K = [],
                ...
                eo = {
                    ...
                    table: {
                        ...
                        h: (e, t, r) => U("table", {
                            key: r.k
                        }, U("thead", null, U("tr", null, e.L.map(function(n, l) {
                            return U("th", {
                                key: l,
                                style: eH(e, l)
                            }, t(n, r))
                        }))), U("tbody", null, e.A.map(function(n, l) {
                            return U("tr", {
                                key: l
                            }, n.map(function(n, l) {
                                return U("td", {
            ...
            let es = ((d = Object.keys(eo)).sort(function(e, t) {
                ...
                ec = Z(e);
            return K.length ? U("div", null, ec, U("footer", {
                key: "footer"
            }, K.map(function(e) {
                return U("div", {
                    id: t.slugify(e.j),
    ...
    e.s(["useTooltip", 0, function(e, t) {
        ...
        return {
            tooltipProps: (0, c.mergeProps)(r, n, {
                role: "tooltip"
            })
        }
    }], 929655);
    ...
    e.s(["useTooltipTrigger", 0, function(e, r, n) {
        let {
            isDisabled: l,
            trigger: a
        } = e, o = (0, f.useId)(), s = (0, t.useRef)(!1), i = (0, t.useRef)(!1), m = () => {
            (s.current || i.current) && r.open(i.current)
        }, g = e => {
            s.current || i.current || r.close(e)
        };
        (0, t.useEffect)(() => {
            let e = e => {
        ...
        let h = () => {
            ...
            },
            {
                ...
                isDisabled: l,
                onHoverStart: () => {
                    "focus" !== a && ("pointer" === (0, d.getInteractionModality)() ? s.current = !0 : s.current = !1, m())
                },
                onHoverEnd: () => {
                    "focus" !== a && (i.current = !1, s.current = !1, g())
                }
            }),
            {
                focusableProps: x
                ...
                isDisabled: l,
                onFocus: () => {
                    (0, d.isFocusVisible)() && (i.current = !0, m())
                },
                onBlur: () => {
                    i.current = !1, s.current = !1, g(!0)
                }
        ...
        return {
            triggerProps: {
                "aria-describedby": r.isOpen ? o : void 0,
                ...(0, c.mergeProps)(x, b, {
                    onPointerDown: h,
                    onKeyDown: h,
                    tabIndex: void 0
            ...
            c = new IntersectionObserver(e => {
                e.forEach(e => {
                    ...
                    if (!!t !== e.isIntersecting)
                        if (e.isIntersecting) {
                            let t = n(e.target, e);
                            "function" == typeof t ? i.set(e.target, t) : c.unobserve(e.target)
                        } else "function" == typeof t && (t(e), i.delete(e.target))
                })
            }, {
                root: l,
                rootMargin: a,
                threshold: "number" == typeof o ? o : r[o]
            });
    ...
    e.s(["useInView", 0, function(e, {
        ...
        return (0, t.useEffect)(() => {
            ...
            return (0, r.inView)(e.current, () => (c(!0), o ? void 0 : () => c(!1)), t)
        }, [n, e, l, o, a]), i
    }])
}, 210310, e => {
    "use strict";
    ...
    e.s(["default", 0, ({
        ...
        let [f, ...m] = e.rows.map(e => ({
            ...e,
            cells: (e.cells ?? []).map(e => "string" == typeof e ? e : "")
        })), g = `align-top text-heading-sm md:text-small-bold rounded-md bg-gray-100 text-gray-800 bg-gray-100 dark:bg-gray-700 md:dark:bg-gray-800 dark:text-gray-200 border-none ${u}`, h = "align-top rounded-md text-sm text-gray-800 dark:text-gray-200 border-none", b = (0, s.default)("w-full table-fixed border-separate border-spacing-2 break-words", c), x = (0, s.default)("h-full table-fixed border-separate border-spacing-1 break-words", c), y = (0, r.useCallback)(e => {
    ...
    e.s(["default", 0, ({
        ...
        return (0, t.jsxs)("div", {
            ...
            children: [(0, t.jsx)("div", {
                ...
                "data-link-location": `${o}-video-play`,
                "data-link-id": `${o}-accordion-toggle`,
                "data-link-type": "CTA",
                children: (0, t.jsxs)("div", {
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "45f15aef-dae8-571e-9687-b93892efc34c")
    } catch (e) {}
}();
//# debugId=45f15aef-dae8-571e-9687-b93892efc34c