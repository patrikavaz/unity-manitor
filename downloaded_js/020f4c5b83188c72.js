(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 950929, 475562, 320620, 960480, 533482, 936773, 529806, e => {
    "use strict";
    e.i(122963);
    var t, r = e.i(297124),
        i = e.i(672721),
    ...
    e.s(["LazyContext", () => o], 475562);
    let a = (0, i.createContext)({
        transformPagePoint: e => e,
        isStatic: !1,
        reducedMotion: "never"
    });
    e.s(["MotionConfigContext", () => a], 320620);
    ...
    let T = e => (t, r) => {
        ...
        A = T({
            scrapeMotionValuesFromProps: e.i(30897).scrapeMotionValuesFromProps,
            createRenderState: m
        }),
        L = T({
            scrapeMotionValuesFromProps: e.i(955953).scrapeMotionValuesFromProps,
            createRenderState: y
        });
    var O = e.i(345138),
        R = e.i(940263);
    ...
    e.s(["useIsomorphicLayoutEffect", () => j], 936773), e.s(["createMotionComponent", () => I], 529806), e.s(["createMotionProxy", () => B], 950929)
}, 538305, e => {
    "use strict";
    ...
    e.s(["isVariantLabel", () => t], 340844);
    let r = ["animate", "whileInView", "whileFocus", "whileHover", "whileTap", "whileDrag", "exit"],
        i = ["initial", ...r];
    e.s(["variantPriorityOrder", () => r, "variantProps", () => i], 500502)
}, 629370, e => {
    "use strict";
    var t = e.i(358670),
        r = e.i(340844),
    ...
    e.s(["buildSVGAttrs", () => o], 510889);
    let a = e => "string" == typeof e && "svg" === e.toLowerCase();
    e.s(["isSVGTag", () => a], 874680)
}, 314685, e => {
    "use strict";
    ...
    "use strict";
    let t = "data-" + (0, e.i(17808).camelToDash)("framerAppearId");
    e.s(["optimizedAppearDataAttribute", () => t])
}, 862462, e => {
    "use strict";
    let t = (0, e.i(672721).createContext)({});
    e.s(["LayoutGroupContext", () => t])
}, 212101, e => {
    "use strict";
    let t = (0, e.i(672721).createContext)(null);
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "f8245e43-359d-5000-92de-e352d2a1f134")
    } catch (e) {}
}();
//# debugId=f8245e43-359d-5000-92de-e352d2a1f134