(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 925511, 310954, 685099, 884580, t => {
...
}, 677278, 353649, 545268, 743959, 437946, 303197, 521581, 445257, 691360, 93763, 761391, 434362, 788879, 765158, 403316, 399116, 528951, 158186, 856040, 323795, 251287, 7837, 706365, 280166, 784863, 806861, 742327, 69164, 822691, 51229, 166154, 587791, 94412, 539218, 529956, t => {
    "use strict";
    let e, n, r, i, s, a, o;
    var c = t.i(925511),
        u = t.i(884580),
    ...
    t.s(["browserPerformanceTimeOrigin", () => K, "dateTimestampInSeconds", () => V, "timestampInSeconds", () => Y], 521581), t.s(["closeSession", () => X, "makeSession", () => W, "updateSession", () => q], 445257), t.s(["merge", () => Q], 691360), t.s(["generateSpanId", () => tt, "generateTraceId", () => Z], 93763);
    let te = "_sentrySpan";
    ...
    function t0(t) {
        let {
            ...
            traceId: n,
            isRemote: r
        } = t.spanContext(), i = r ? e : t8(t).parent_span_id, s = t$(t).scope;
        return {
            parent_span_id: i,
    ...
    function t3(t) {
        return "number" == typeof t ? t4(t) : Array.isArray(t) ? t[0] + t[1] / 1e9 : t instanceof Date ? t4(t.getTime()) : Y()
    }
    ...
    function t8(t) {
        ...
        if ((e = t).attributes && e.startTime && e.name && e.endTime && e.status) {
            ...
            return {
                ...
                start_timestamp: t3(i),
                timestamp: t3(a) || void 0,
                status: t9(o),
                op: e[tE],
                origin: e[tv],
                links: t2(c)
    ...
    t.s(["TRACE_FLAG_NONE", () => 0, "TRACE_FLAG_SAMPLED", () => 1, "addChildSpanToSpan", () => ee, "convertSpanLinksForEnvelope", () => t2, "getActiveSpan", () => es, "getRootSpan", () => ei, "getSpanDescendants", () => er, "getStatusMessage", () => t9, "removeChildSpanFromSpan", () => en, "showSpanDropWarning", () => ea, "spanIsSampled", () => t6, "spanTimeInputToSeconds", () => t3, "spanToJSON", () => t8, "spanToTraceContext", () => t0, "spanToTraceHeader", () => t1, "spanToTraceparentHeader", () => t5, "spanToTransactionTraceContext", () => tZ], 251287);
    let eo = "production";
    t.s(["DEFAULT_ENVIRONMENT", () => eo], 7837);
    let ec = "_frozenDsc";
    ...
    function ed(t) {
        ...
        let p = el(t.spanContext().traceId, e),
            d = i[tS],
            f = r.description;
        return "url" !== d && f && (p.transaction = f), tR() && (p.sampled = String(t6(n)), p.sample_rand = s?.get("sentry.sample_rand") ?? t$(n).scope?.getPropagationContext().sampleRand.toString()), o(p), e.emit("createDsc", p, n), p
    }
...
`), "string" == typeof n || n instanceof Uint8Array) i(n);
    ...
    function ew(t, e) {
        let n = ed(t[0]),
            ...
            c = o?.length ? t.filter(t => !eD(t8(t), o)) : t,
            u = t.length - c.length;
    ...
    class eB {
        ...
        updateName(t) {
            ...
            this._endTime || (this._endTime = t3(t), function(t) {
    ...
    function eJ({
        ...
        if (t && !n) s = function(t, e, n) {
            let {
                spanId: r,
                traceId: i
            } = t.spanContext(), s = !e.getScopeData().sdkProcessingMetadata[eP] && t6(t), a = s ? new eB({
                ...n,
                parentSpanId: r,
                traceId: i,
                sampled: s
        ...
        return ! function(t) {
            ...
            let {
                ...
                spanId: i
            } = t.spanContext(), s = t6(t), a = ei(t), o = a === t, c = `[Tracing] Starting ${s?"sampled":"unsampled"} ${o?"root ":""}span`, l = [`op: ${n}`, `name: ${e}`, `ID: ${i}`];
  ...
  ${l.join("\n  ")}`)
    ...
    function eH(t) {
        ...
        if (t.startTime) {
            ...
            return n.startTimestamp = t3(t.startTime), delete n.startTime, n
        }
        return e
    }
    ...
    function e3(t) {
        if (t) {
            var e;
            return (e = t) instanceof ti || "function" == typeof e || Object.keys(t).some(t => e4.includes(t)) ? {
                captureContext: t
            } : t
        }
    }
    ...
    let e4 = ["user", "level", "extra", "contexts", "tags", "fingerprint", "propagationContext"];

    function e8(t, e) {
        return tp().captureException(t, e3(e))
    }
    ...
    t.s(["parseEventHintOrCaptureContext", () => e3, "prepareEvent", () => e2], 529956), t.s(["addEventProcessor", () => nt, "captureEvent", () => e6, "captureException", () => e8, "captureSession", () => ni, "isEnabled", () => e7, "setContext", () => e9, "startSession", () => ne], 677278)
}]);
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "1daf3e00-23e0-5bb2-81c8-f7bece328405")
    } catch (e) {}
}();
//# debugId=1daf3e00-23e0-5bb2-81c8-f7bece328405