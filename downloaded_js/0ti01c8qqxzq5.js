(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 998569, e => {
    ...
    let f = (0, t.forwardRef)(function({
        ...
        let w = (0, o.useObjectRef)(y),
            ...
            E = (0, i.clsx)("w-full transition-all duration-300 shrink-0 ", {
                "fill-gray-400": b
            }),
            S = (0, i.clsx)(E, {
            ...
            P = (0, i.clsx)(E, "fill-black dark:fill-white");
        if (x) {
    ...
    e.s(["default", 0, ({
        ...
        let S = (0, a.default)("top-0 left-0 h-full w-full absolute z-10 transition-opacity duration-500 object-cover", {
            ...
            P = "horizontal" === p && x,
            T = (0, a.default)("flex flex-col", {
                "min-h-[14rem]": "stacked" === p || "column" === p,
                grow: "column" !== p && "horizontal" !== p,
                "min-h-[14rem] xl:min-h-[18rem] xl:flex-row xl:gap-4": "column" === p
            }),
            M = (0, a.default)("rounded-lg bg-gray-100 p-4 dark:bg-gray-900", {
                "h-full": "horizontal" !== p,
                "group h-full relative p-[1px] xl:flex-row xl:gap-6 cursor-pointer": "horizontal" === p && P,
                "h-full relative p-[1px] xl:flex-row xl:gap-6 cursor-auto": "horizontal" === p && !P
            }),
            ...
            I = (0, a.default)("cover absolute object-cover", {
                "transition-transform duration-400 group-hover:scale-110": "horizontal" === p && P
            }),
            $ = (0, l.jsxs)("div", {
                ref: L,
                className: M,
                children: ["horizontal" === p && P && (0, l.jsx)("div", {
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "e3e3fe00-3f28-5615-9975-f033f684221c")
    } catch (e) {}
}();
//# debugId=e3e3fe00-3f28-5615-9975-f033f684221c