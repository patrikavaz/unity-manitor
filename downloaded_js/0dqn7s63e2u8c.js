(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 120480, (e, t, i) => {
    ...
    let v = "function" == typeof c.default.useSyncExternalStore ? c.default.useSyncExternalStore : function(e, t, i) {
            ...
            return (0, g.useSyncExternalStore)(e, r)
        },
    ...
    function I({
        ...
        let t = (0, c.useContext)(S),
            i = (0, c.useMemo)(() => c.default.createElement(S.Provider, {
                value: null
            }, c.default.createElement(x.Provider, {
                value: !0
            }, e)), [e]);
    ...
    let s = (0, n.createContext)(null),
        o = (0, n.forwardRef)(function(e, o) {
            let {
                ...
                render: p,
                ...y
            } = e, [f, m] = (0, n.useState)(u ? "visible" : "hidden"), C = (0, n.useContext)(s);
            if (!C) throw Error("<SharedElement> must be rendered inside a <SharedElementTransition>");
            u && "hidden" === f && m("visible"), o = (0, r.useObjectRef)(o), (0, l.useLayoutEffect)(() => {
                let e = o.current,
                    t = C.current,
                    n = t[d],
                    l = null;
            ...
            let g = (0, t.useRenderProps)({
                children: a,
                className: h,
                style: c,
                render: p,
                values: {
                    isEntering: "entering" === f,
                    isExiting: "exiting" === f
                }
            });
            return "hidden" === f ? null : n.default.createElement(t.dom.div, {
                ...y,
                ...g,
                ref: o,
