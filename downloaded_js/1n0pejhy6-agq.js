(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 740041, e => {
    ...
    let r = t.forwardRef((e, r) => {
        ...
        return t.createElement("svg", {
            ...
            ...f
        }, !!n && t.createElement("title", null, n), u, l.get(a))
    });
    ...
    e.s(["useRender", 0, function(e, t, n, {
        ...
        let y = (u ?? (0, v.isSVGComponent)(e) ? function(e, t, n, i) {
            ...
            x = (0, r.useMemo)(() => (0, s.isMotionValue)(A) ? A.get() : A, [A]);
    ...
    e.s(["useIsomorphicLayoutEffect", 0, r], 809018)
}, 494004, 876009, e => {
    "use strict";
    let t = {
            current: null
    ...
    function x(e, {
        ...
        let L = C ? "svg" === C : (0, f.isSVGComponent)(e),
        ...
        function P(f, c) {
            let h, p = {
                ...
                x = (0, u.useCreateMotionContext)(f),
                C = M(f, y);
            if (!y && "u" > typeof window) {
                ...
                h = t.MeasureLayout, x.visualElement = function(e, t, r, i, u, l) {
                    let {
                        visualElement: f
                    } = (0, n.useContext)(s.MotionContext), c = (0, n.useContext)(o.LazyContext), h = (0, n.useContext)(v.PresenceContext), d = (0, n.useContext)(a.MotionConfigContext), p = d.reducedMotion, y = d.skipAnimations, g = (0, n.useRef)(null), x = (0, n.useRef)(!1);
                    i = i || c.renderer, !g.current && i && (g.current = i(e, {
                        ...
                        skipAnimations: y,
                        isSVG: l
                    }), x.current && g.current && (g.current.manuallyAnimateOnMount = !0));
                    let C = g.current,
                        E = (0, n.useContext)(b.SwitchLayoutGroupContext);
                    C && !C.projection && u && ("html" === C.type || "svg" === C.type) && function(e, t, r, n) {
                        let {
                            layoutId: i,
                            layout: o,
                            drag: a,
                    ...
                    return (0, A.useIsomorphicLayoutEffect)(() => {
                        x.current = !0, C && (S.current = !0, window.MotionIsMounted = !0, C.updateFeatures(), C.scheduleRenderMicrotask(), M.current && C.animationState && C.animationState.animateChanges())
                    }), (0, n.useEffect)(() => {
                ...
                }(e, C, p, S, t.ProjectionNode, L)
            }
            return (0, r.jsxs)(s.MotionContext.Provider, {
                value: x,
                children: [h && x.visualElement ? (0, r.jsx)(h, {
                    visualElement: x.visualElement,
                    ...p
                }) : null, (0, l.useRender)(e, f, (0, g.useMotionRef)(C, x.visualElement, c), C, y, t, L)]
            })
        }
        P.displayName = `motion.${"string"==typeof e?e:`create(${e.displayName??e.name??""})`}`;
        let T = (0, n.forwardRef)(P);
        return T[y.motionComponentSymbol] = e, T
    }
    ...
    function C(e, t) {
        ...
        return new Proxy((e, t) => n(e, t), {
            get: (i, o) => "create" === o ? n : (r.has(o) || r.set(o, x(o, void 0, e, t)), r.get(o))
        })
    }
            ...
            230: function(e, t, r) {
                ...
                s.prototype.write = function(e, t, r, n) {
                    ...
                    for (var d = !1;;) switch (n) {
                        ...
                        case "utf8":
                        case "utf-8":
                            return i = t, o = r, P(S(e, this.length - i), this, i, o);
                        case "ascii":
                            return a = t, s = r, P(L(e), this, a, s);
                        case "latin1":
                        case "binary":
                            return function(e, t, r, n) {
                                return P(L(t), e, r, n)
                        ...
                        case "base64":
                            return u = t, l = r, P(M(e), this, u, l);
                        case "ucs2":
                        case "ucs-2":
                        case "utf16le":
                        case "utf-16le":
                            return f = t, c = r, P(function(e, t) {
    ...
    o.ab = "/ROOT/node_modules/.pnpm/next@16.3.2_@babel+core@7.29.7_@opentelemetry+api@1.9.1_@playwright+test@1.61.1_@types+_024427f1e0060f1203107befccecc73f/node_modules/next/dist/compiled/buffer/", t.exports = o(230)
}, 379726, (e, t, r) => {
    "use strict";
    ...
    let n = (0, e.r(379726).createAsyncLocalStorage)()
}, 881466, (e, t, r) => {
    "use strict";
    Object.defineProperty(r, "__esModule", {
        value: !0
