(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 123714, 237483, e => {
        ...
        s = "function" == typeof t.default.useId ? function(e) {
            ...
            let n = (0, t.useContext)(r),
                i = function(e = !1) {
                    ...
                    if (null === i.current && !e) {
                        var s, a;
                        let e = null == (a = t.default.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) || null == (s = a.ReactCurrentOwner) ? void 0 : s.current;
                        if (e) {
                            let t = o.get(e);
                            null == t ? o.set(e, {
                                id: n.current,
    ...
    function c() {
        return "function" == typeof t.default.useSyncExternalStore ? t.default.useSyncExternalStore(l, a, u) : (0, t.useContext)(i)
    }
    ...
    function g(e) {
        d = !0, e.metaKey || !(0, r.isMac)() && e.altKey || e.ctrlKey || "Control" === e.key || "Shift" === e.key || "Meta" === e.key || (u = "keyboard", v("keyboard", e))
    }
    ...
    function E(e) {
        (0, i.isVirtualClick)(e) && (d = !0, u = "virtual")
    }

    function m(e) {
        e.target !== window && e.target !== document && !n.ignoreFocusEvent && e.isTrusted && (d || f || (u = "virtual", v("virtual", e)), d = !1, f = !1)
    }
    ...
    e.s(["getInteractionModality", 0, function() {
        ...
        h(), (0, s.useEffect)(() => {
            let t = (t, r) => {
                var i;
                let s, a, u, l, c;
                i = !!(null == n ? void 0 : n.isTextInput), s = (0, o.getOwnerDocument)(null == r ? void 0 : r.target), a = "u" > typeof window ? (0, o.getOwnerWindow)(null == r ? void 0 : r.target).HTMLInputElement : HTMLInputElement, u = "u" > typeof window ? (0, o.getOwnerWindow)(null == r ? void 0 : r.target).HTMLTextAreaElement : HTMLTextAreaElement, l = "u" > typeof window ? (0, o.getOwnerWindow)(null == r ? void 0 : r.target).HTMLElement : HTMLElement, c = "u" > typeof window ? (0, o.getOwnerWindow)(null == r ? void 0 : r.target).KeyboardEvent : KeyboardEvent, (i = i || s.activeElement instanceof a && !P.has(s.activeElement.type) || s.activeElement instanceof u || s.activeElement instanceof l && s.activeElement.isContentEditable) && "keyboard" === t && r instanceof c && !p[r.key] || e(w())
            };
            return l.add(t), () => {
                l.delete(t)
            }
    ...
    e.s(["useValueEffect", 0, function(e) {
        let [i, o] = (0, r.useState)(e), s = (0, r.useRef)(null), a = (0, t.useEffectEvent)(() => {
            if (!s.current) return;
            ...
            i === e.value ? a() : o(e.value)
        });
        (0, n.useLayoutEffect)(() => {
            s.current && a()
        });
        let u = (0, t.useEffectEvent)(e => {
            s.current = e(i), a()
        });
        return [i, u]
    }])
    ...
    function l(e) {
        ...
        if (t && t.register(d, c), a) {
            let e = u.get(c);
            e && !e.includes(l) ? e.push(l) : u.set(c, [l])
        }
        return (0, r.useLayoutEffect)(() => () => {
            t && t.unregister(d), u.delete(c)
        }, [c]), (0, o.useEffect)(() => {
            let e = l.current;
            return e && i(e), () => {
                e && (l.current = null)
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "53b3ecdc-370e-5e84-ad8d-6c5f95bf47b2")
    } catch (e) {}
}();
//# debugId=53b3ecdc-370e-5e84-ad8d-6c5f95bf47b2