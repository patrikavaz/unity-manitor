(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 108051, e => {
    ...
    e.s(["defaultShouldDehydrateQuery", 0, function(e) {
        ...
        c.forEach(({
            ...
            let m = u ? (0, t.tryResolveSync)(u) : void 0,
                p = void 0 === n.data ? m?.data : n.data,
                f = void 0 === p ? p : o(p),
                g = l.get(s),
                y = g?.state.status === "pending",
                v = g?.state.fetchStatus === "fetching";
            if (g) {
                let e = m && void 0 !== h && h > g.state.dataUpdatedAt;
            ...
            !u || m || y || v || void 0 !== h && !(h > g.state.dataUpdatedAt) || g.fetch(void 0, {
    ...
    function u(e) {
        let a, u = !1,
            ...
            m = () => r.focusManager.isFocused() && ("always" === e.networkMode || n.onlineManager.isOnline()) && e.canRun(),
            ...
            v = () => {
                ...
                Promise.resolve(a).then(f).catch(a => {
                    ...
                    u || !o ? g(a) : (h++, e.onFail?.(h, a), (0, t.sleep)(i).then(() => m() ? void 0 : y()).then(() => {
                        u ? g(a) : v()
                    }))
                })
            };
    ...
    var p = class extends d {
        ...
        removeObserver(e) {
            this.observers.includes(e) && (this.observers = this.observers.filter(t => t !== e), this.observers.length || (this.#u && (this.#d || this.#p() ? this.#u.cancel({
                revert: !0
        ...
        async fetch(e, a) {
                        ...
                        let n = e.options,
                            ...
                            u = async () => {
                                ...
                                if (i && s.length) {
                                    ...
                                    let e = r ?? s.length;
                                    do {
                                        let e = 0 === c ? l[0] ?? n.initialPageParam : m(n, o);
                                        if (c > 0 && null == e) break;
                                        o = await h(o, e), c++
                                    } while (c < e)
                                }
            ...
            h?.onFetch(o, this), this.#l = this.state, ("idle" === this.state.fetchStatus || this.state.fetchMeta !== o.fetchOptions?.meta) && this.#m({
                type: "fetch",
    ...
    e.s(["Query", 0, p, "fetchState", 0, f], 213278)
    ...
    e.s(["addConsumeAwareSignal", 0, function(e, t, a) {
        ...
        return "function" == typeof a.structuralSharing ? a.structuralSharing(e, t) : !1 !== a.structuralSharing ? function e(t, a, r = 0) {
            ...
            for (let c = 0; c < l; c++) {
                ...
                if (null === u || null === m || "object" != typeof u || "object" != typeof m) {
                    h[l] = m;
                    continue
                }
                let p = e(u, m, r + 1);
