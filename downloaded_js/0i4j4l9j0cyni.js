(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 121090, e => {
    ...
    e.s(["AnimatePresence", 0, ({
        ...
        let [b, y] = (0, m.usePresence)(p), w = (0, r.useMemo)(() => v(e), [e]), j = p && !b ? [] : w.map(g), C = (0, r.useRef)(!0), k = (0, r.useRef)(w), E = (0, i.useConstant)(() => new Map), P = (0, r.useRef)(new Set), [L, T] = (0, r.useState)(w), [R, N] = (0, r.useState)(w);
        (0, s.useIsomorphicLayoutEffect)(() => {
            C.current = !1, k.current = w;
            for (let e = 0; e < R.length; e++) {
                let t = g(R[e]);
                j.includes(t) ? (E.delete(t), P.current.delete(t)) : !0 !== E.get(t) && E.set(t, !1)
            }
        }, [R, j.length, j.join("-")]);
        let A = [];
        if (w !== L) {
            ...
            for (let t = 0; t < R.length; t++) {
                let r = R[t],
                    n = g(r);
                j.includes(n) || (e.splice(t, 0, r), A.push(r))
            }
    ...
    h.prototype.eos = function() {
        ...
        return void 0 == m && (m = function(e, t) {
            ...
            A(t || v.tags);
            for (var U = new h(e); !U.eos();) {
                if (m = U.pos, x = U.scanUntil(n))
                    for (var M = 0, I = x.length; M < I; ++M) ! function(e) {
                        return !o.call(a, e)
                    }(b = x.charAt(M)) ? (L = !0, j = !0, T += " ") : (E.push(k.length), T += b), k.push(["text", b, m, m + 1]), m += 1, "\n" === b && (N(), T = "", R = 0, j = !1);
                if (!U.scan(n)) break;
                if (P = !0, g = U.scan(f) || "name", U.scan(u), "=" === g ? (x = U.scanUntil(p), U.scan(p), U.scanUntil(s)) : "{" === g ? (x = U.scanUntil(l), U.scan(d), U.scanUntil(s), g = "&") : x = U.scanUntil(s), !U.scan(s)) throw Error("Unclosed tag at " + U.pos);
                if (y = ">" == g ? [g, x, m, U.pos, T, R, j] : [g, x, m, U.pos], R++, k.push(y), "#" === g || "^" === g) C.push(y);
                else if ("/" === g) {
                    if (!(w = C.pop())) throw Error('Unopened section "' + x + '" at ' + m);
                    if (w[1] !== x) throw Error('Unclosed section "' + w[1] + '" at ' + m)
                } else "name" === g || "{" === g || "&" === g ? L = !0 : "=" === g && A(x)
            }
            if (N(), w = C.pop()) throw Error('Unclosed section "' + w[1] + '" at ' + U.pos);
            return function(e) {
    ...
    let d = (0, r.forwardRef)(function({
        ...
        let L = (0, c.useObjectRef)(P),
            ...
            _ = (0, i.clsx)("right-arrow", "dark:fill-white", {
                "fill-black": "secondary" === f && !d,
                "fill-blue": "secondary" !== f && !d,
                "btn-disabled": d
            }),
            S = "string" == typeof e ? e : "";
