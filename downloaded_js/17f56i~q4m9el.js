(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 394225, e => {
    ...
    let ew = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,
        eN = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,
        eC = [f, x, h, C, L, T, M, P, eh, ev, eb, ek],
        eT = [...eC, /^[^\n]+(?:  \n|\n{2,})/, $, S];
    ...
    function eH(e, t, r) {
        ...
        return n.forEach(function(e, t) {
            "tableSeparator" === e.type ? 0 !== t && t !== n.length - 1 && a.push([]) : ("text" !== e.type || null != n[t + 1] && "tableSeparator" !== n[t + 1].type || (e.v = e.v.replace(X, "")), a[a.length - 1].push(e))
        }), a
    }
    ...
    function eG(e, t, r) {
        ...
        return l.cloneElement(function(e, t = {}) {
            var a;
            let u;
            t.overrides = t.overrides || {}, t.slugify = t.slugify || eL, t.namedCodesToUnicode = t.namedCodesToUnicode ? n({}, s, t.namedCodesToUnicode) : s;
            let V = t.createElement || l.createElement;

            function X(e, r, ...l) {
                var a;
                let i, s = eG(t.overrides, `${e}.props`, {});
                return V((i = eG(a = t.overrides, e)) ? "function" == typeof i || "object" == typeof i && "render" in i ? i : eG(a, `${e}.component`, e) : e, n({}, r, s, {
...
`, {
            ...
            function Z(e) {
                ...
                return t ? t.reduce(function(e, t, r) {
                    ...
                    if (-1 !== n) {
                        ...
                        "string" == typeof m && ($.test(m) || S.test(m)) && (e[f] = l.cloneElement(q(m.trim()), {
                            key: r
                        }))
            ...
            let K = [],
                ...
                ei = {
                    ...
                    table: {
                        ...
                        h: (e, t, r) => X("table", {
                            key: r.k
                        }, X("thead", null, X("tr", null, e.L.map(function(l, n) {
                            return X("th", {
                                key: n,
                                style: eO(e, n)
                            }, t(l, r))
                        }))), X("tbody", null, e.A.map(function(l, n) {
                            return X("tr", {
                                key: n
                            }, l.map(function(l, n) {
                                return X("td", {
            ...
            !0 !== t.disableParsingRawHTML && (ei.htmlBlock = {
                ...
                i: r.HIGH,
                l(e, t, r) {
                    let [, l] = e[3].match(en), n = RegExp(`^${l}`, "gm"), a = e[3].replace(n, ""), i = eT.some(e => e.test(a)) ? e_ : eF, s = e[1].toLowerCase(), c = -1 !== o.indexOf(s);
                    r.N = r.N || "a" === s;
                    let d = c ? e[3] : i(t, a, r);
                    return r.N = !1, {
                        O: Z(e[2]),
    ...
    e.s(["useTooltipTriggerState", 0, function(e = {}) {
        let {
            ...
            open: u,
            close: f
        } = (0, r.useOverlayTriggerState)(e), m = (0, t.useMemo)(() => `${++n}`, []), p = (0, t.useRef)(null), g = (0, t.useRef)(f), x = () => {
            l[m] = y
        }, h = () => {
            for (let e in l) e !== m && (l[e](!0), delete l[e])
        }, b = () => {
            p.current && clearTimeout(p.current), p.current = null, h(), x(), a = !0, u(), i && (clearTimeout(i), i = null), s && (clearTimeout(s), s = null)
        }, y = e => {
        ...
        return (0, t.useEffect)(() => {
            ...
            isOpen: d,
            open: e => {
                e || !(o > 0) || p.current ? b() : (h(), x(), d || i || a ? d || b() : i = setTimeout(() => {
                    i = null, a = !0, b()
                }, o))
            },
            close: y
    ...
    e.s(["inView", 0, function(e, l, {
        root: n,
        margin: a,
        amount: i = "some"
    } = {}) {
        let s = (0, t.resolveElements)(e),
            o = new WeakMap,
            c = new IntersectionObserver(e => {
                e.forEach(e => {
                    ...
                    if (!!t !== e.isIntersecting)
                        ...
                        } else "function" == typeof t && (t(e), o.delete(e.target))
                })
            }, {
                root: n,
                rootMargin: a,
                threshold: "number" == typeof i ? i : r[i]
            });
    ...
    e.s(["useInView", 0, function(e, {
        ...
        return (0, t.useEffect)(() => {
            ...
            return (0, r.inView)(e.current, () => (c(!0), i ? void 0 : () => c(!1)), t)
        }, [l, e, n, i, a]), o
    }])
}, 210310, e => {
    "use strict";
    ...
    let d = ({
        ...
        f = ({
            ...
            let [p, g] = (0, r.useState)(!1), [x, h] = (0, r.useState)(!1), b = (0, r.useRef)(null), y = (0, s.default)({
                "cursor-pointer relative": p
            }, f), v = (0, s.default)({
                "line-clamp-3": a
            });
            (0, r.useEffect)(() => {
            ...
            return (0, t.jsxs)(t.Fragment, {
                children: [(0, t.jsxs)("td", {
                    className: (0, s.default)(y, {
                        "bg-gray-50 p-3 dark:bg-gray-900": !m,
                        "h-full !p-0": m
                    }),
                    ...j,
                    children: [m ? e : (0, t.jsx)(o.default, {
                        className: v,
                        ref: b,
                        children: e
                    }), a && p && (0, t.jsx)(d, {
    ...
    e.s(["default", 0, ({
        ...
        let [m, ...p] = e.rows.map(e => ({
            ...e,
            cells: (e.cells ?? []).map(e => "string" == typeof e ? e : "")
        })), g = `align-top text-heading-sm md:text-small-bold rounded-md bg-gray-100 text-gray-800 bg-gray-100 dark:bg-gray-700 md:dark:bg-gray-800 dark:text-gray-200 border-none ${d}`, x = "align-top rounded-md text-sm text-gray-800 dark:text-gray-200 border-none", h = (0, s.default)("w-full table-fixed border-separate border-spacing-2 break-words", c), b = (0, s.default)("h-full table-fixed border-separate border-spacing-1 break-words", c), y = (0, r.useCallback)(e => {
            let [r, ...l] = e.split("\n"), n = l.splice(1).map((e, r) => {
                let l = e.split("|").filter(e => e).map(e => e.trim());
                return (0, t.jsx)("div", {
                    className: "flex grow",
                    children: l.map((e, l) => (0, t.jsx)(i.default, {
            ...
            return (0, t.jsxs)("div", {
                ...
                children: [(0, t.jsx)("div", {
                    ...
                    children: r.split("|").filter(e => e).map((e, r) => (0, t.jsx)(i.default, {
        ...
        }, []), v = (0, r.useMemo)(() => p.map(e => e.cells.reduce((e, r, s) => ({
            ...e,
            [`col${s+1}`]: {
                component: r.startsWith("|") ? y(r) : (0, t.jsx)(i.default, {
                    options: {
                        overrides: {
                            Button: {
                                component: l.default
        ...
        }), {})), [p, y]), k = (0, r.useMemo)(() => m.cells.map((e, r) => (0, t.jsx)("th", {
            scope: "col",
        ...
        }, `${r}-${e}`)), [m.cells]), j = (0, r.useMemo)(() => v.map((r, l) => {
            let n = Object.values(r),
                a = n[0];
            return (0, t.jsx)("tr", {
                className: "border-separate border-spacing-1",
                children: n.map((r, n) => (0, t.jsx)(f, {
        ...
        }), [k, v, g, e.tableTruncation]), w = (0, r.useMemo)(() => m.cells.map((e, r) => (0, t.jsx)("th", {
            scope: "col",
        ...
        }, `${r}-${e}`)), [m]), N = (0, r.useMemo)(() => v.map((e, r) => (0, t.jsx)("div", {
            className: "mb-4 min-w-full rounded-md bg-gray-100 align-middle dark:bg-gray-700",
            children: (0, t.jsxs)("table", {
                className: h,
                children: [m && m.cells.length > 0 && (0, t.jsx)("thead", {
                    className: "hidden",
                    children: (0, t.jsx)("tr", {
                        className: "border-separate border-spacing-1",
                        children: w
                    ...
                    children: Object.values(e).map((e, s) => e ? (0, t.jsx)("tr", {
                        ...
                        children: (0, t.jsxs)("td", {
                            className: 0 === s ? g : x,
                            children: [0 !== s && m && m.cells[s] && (0, t.jsx)(i.default, {
                                options: {
                                    overrides: {
                                        Button: {
                                            component: l.default
    ...
    f.Actions = ({
        ...
        let {
            image: d,
            video: u
        } = e || {}, [f, m] = (0, r.useState)(!1), p = (0, r.useRef)(null), g = "gdc2026" === i ? "object-cover" : "object-contain", x = (0, n.default)("relative flex grow", {
            "m-4 h-full": "gdc2026" !== i,
            "w-full h-[22rem] lg:h-full lg:w-auto lg:m-4": "gdc2026" === i
        }, a), h = (0, n.default)("relative h-full w-full overflow-hidden", {
    ...
    e.s(["default", 0, ({
        ...
        let C, T = -1 !== (C = window.navigator.userAgent).indexOf("Win") ? "Windows" : -1 !== C.indexOf("Mac") ? "Mac" : -1 !== C.indexOf("Linux") ? "Linux" : "Unknown",
            L = (0, r.useRef)(null),
            {
                state: $
            } = (0, h.default)(),
        ...
        let E = c ?? void 0,
            ...
            R = e => {
                ...
                r && (r.endsWith(".exe") || r.endsWith(".dmg") ? L.current && (L.current.href = r, L.current.download = "", L.current.target = n, L.current.click()) : "_blank" === n ? window.open(r, "_blank") : window.location.href = r), l && setTimeout(() => {
                    let e = l.replace(/^\//, "");
                    window.location.href = `/${a}/${e}`
                }, 1e3), e?.callback && e.callback()
            },
            P = a?.filter(e => !e.operatingSystem || e.operatingSystem === T) || [],
            F = a?.filter(e => !!e.operatingSystem && "Unknown" !== e.operatingSystem) || [];
        return (0, t.jsx)(t.Fragment, {
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "ad498191-920e-5689-96ce-a52d93bf148f")
    } catch (e) {}
}();
//# debugId=ad498191-920e-5689-96ce-a52d93bf148f