(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 447452, 667900, 2062, 676658, e => {
    ...
    e.s(["default", 0, ({
        ...
        let D = (0, j.default)(`(max-width: ${w.default.Large}px)`),
            M = (0, i.useRef)(null),
            [B, G] = (0, i.useState)(!1),
            _ = (0, E.useInView)(M, {
                once: !0
        ...
        let W = () => {
            ...
            X = (0, n.default)("relative", {
                ...
                "lg:py-14": K,
                "lg:py-24": !K && "default" === x && (!f || "16:9" === f) && "gdc2026" !== R,
            ...
            Q = (0, n.default)("relative col-span-12 px-5 text-center lg:pb-0 lg:text-left", {
                ...
                "lg:col-start-8": "left" === v && "gdc2026" !== R && (!f || "16:9" === f),
    ...
    function d(e, i, r = {}) {
        let [f, m, p] = (0, a.setupGesture)(e, r), h = e => {
        ...
        return f.forEach(e => {
            ((r.useGlobalTarget ? window : e).addEventListener("pointerdown", h, m), (0, t.isHTMLElement)(e)) && (e.addEventListener("focus", e => ((e, t) => {
    ...
    function m(e) {
        ...
        function x(i) {
            ...
            for (let c = 0; c < f; c++) {
                ...
                let u = d[c],
                    f = p[u],
                    m = void 0 !== r[u] ? r[u] : h[u],
                    E = (0, o.isVariantLabel)(m),
                    P = u === i ? f.isActive : null;
                !1 === P && (w = c);
                let k = m === h[u] && m !== r[u] && E;
                if (k && g && e.manuallyAnimateOnMount && (k = !1), f.protectedKeys = {
                        ...b
                ...
                for (let e in F) {
                    let t = L[e],
                        i = V[e];
                    if (!b.hasOwnProperty(e))((0, s.isKeyframesTarget)(t) && (0, s.isKeyframesTarget)(i) ? l(t, i) : t === i) ? void 0 !== t && y.has(e) ? I(e) : f.protectedKeys[e] = !0 : null != t ? I(e) : y.add(e)
                }
                f.prevProp = m, f.prevResolvedValues = L, f.isActive && (b = {
                    ...b,
                    ...L
                }), g && e.blockInitialAnimation && (S = !1);
                let O = k && N,
                    R = !O || C;
                S && R && x.push(...T.map(i => {
                    let r = {
            ...
            let E = !!x.length;
            return g && (!1 === r.initial || r.initial === r.animate) && !e.manuallyAnimateOnMount && (E = !1), g = !1, E ? m(x) : Promise.resolve()
        }
        return {
            animateChanges: x,
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "161270ed-999d-5bb0-9792-6b46ec0880e2")
    } catch (e) {}
}();
//# debugId=161270ed-999d-5bb0-9792-6b46ec0880e2