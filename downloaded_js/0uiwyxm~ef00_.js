                ...
                if (35 !== e && 39 !== e && 60 !== e && 123 !== e && 125 !== e) {
                    let e = function(e) {
                        ...
                        for (let i = 0; i < e.length;) {
                            ...
                            if (10 === n) t++, r = 1, i++;
                            else if (r++, n >= 55296 && n <= 56319 && i + 1 < e.length) {
                                let t = e.charCodeAt(i + 1);
                                i += t >= 56320 && t <= 57343 ? 2 : 1
                            } else i++
                        }
                        return {
                            offset: e.length,
                                        ...
                                        parsedOptions: this.shouldParseSkeletons ? (i = {}, o.replace(p, e => {
                                            ...
                                            switch (e[0]) {
                                                ...
                                                case "e":
                                                    ...
                                                    i.weekday = ["short", "long", "narrow", "short"][t - 3];
                                                    break;
                                                case "c":
    ...
    function G(e, t = {}) {
        ...
        return t?.captureLocation || function e(t) {
            t.forEach(t => {
                ...
                else 2 === t.type && P(t.style) || (3 === t.type || 4 === t.type) && A(t.style) ? delete t.style.location : 8 === t.type && e(t.children)
            })
        }(r.val), r.val
    }
        ...
        constructor(t, r = e.defaultLocale, i, s) {
            if (this.formatterCache = {
                    ...
                    for (let l of t) {
                        ...
                        if (3 === l.type) {
                            let e = "string" == typeof l.style ? n.date[l.style] : A(l.style) ? l.style.parsedOptions : void 0;
                            a.push({
                                type: 0,
                        ...
                        if (4 === l.type) {
                            let e = "string" == typeof l.style ? n.time[l.style] : A(l.style) ? l.style.parsedOptions : n.time.medium;
                            a.push({
                                type: 0,
                                value: i.getDateTimeFormat(r, e).format(u)
                            });
...
`, "MISSING_INTL_API", h);
    ...
    function E(t) {
        ...
        n = A, C && ("string" == typeof n || "number" == typeof n) && (n = (0, o.jsx)("a", {
            children: n
        }));
        let G = h.default.useContext(l.AppRouterContext),
            k = !1 !== S,
            x = !1 !== S ? null === (i = S) || "auto" === i ? b.FetchStrategy.PPR : b.FetchStrategy.Full : b.FetchStrategy.PPR,
