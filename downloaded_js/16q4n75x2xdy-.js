(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 848662, e => {
    ...
    let d = (0, a.forwardRef)(function({
        ...
        let S = (0, u.useObjectRef)(x),
            ...
            V = (0, n.clsx)("cursor-pointer inline-block items-center outline-hidden overflow-x-hidden", {
                "btn-disabled": d
            }, {
                primary: "btn-primary",
            ...
            P = (0, n.clsx)("btn-label transition-spacing flex duration-300 ease-in-out", {
                "btn-disabled": d
            }),
            k = (0, n.clsx)("right-arrow", "dark:fill-white", {
    ...
    f.prototype.eos = function() {
        ...
        return void 0 == m && (m = function(e, t) {
            ...
            L(t || v.tags);
            for (var O = new f(e); !O.eos();) {
                if (m = O.pos, y = O.scanUntil(r))
                    for (var j = 0, V = y.length; j < V; ++j) ! function(e) {
                        return !s.call(o, e)
                    }(b = y.charAt(j)) ? (S = !0, A = !0, F += " ") : (Z.push(H.length), F += b), H.push(["text", b, m, m + 1]), m += 1, "\n" === b && (T(), F = "", C = 0, A = !1);
                if (!O.scan(r)) break;
                if (x = !0, g = O.scan(p) || "name", O.scan(c), "=" === g ? (y = O.scanUntil(h), O.scan(h), O.scanUntil(i)) : "{" === g ? (y = O.scanUntil(l), O.scan(d), O.scanUntil(i), g = "&") : y = O.scanUntil(i), !O.scan(i)) throw Error("Unclosed tag at " + O.pos);
                if (w = ">" == g ? [g, y, m, O.pos, F, C, A] : [g, y, m, O.pos], C++, H.push(w), "#" === g || "^" === g) M.push(w);
                else if ("/" === g) {
                    if (!(E = M.pop())) throw Error('Unopened section "' + y + '" at ' + m);
                    if (E[1] !== y) throw Error('Unclosed section "' + E[1] + '" at ' + m)
                } else "name" === g || "{" === g || "&" === g ? S = !0 : "=" === g && L(y)
            }
            if (T(), E = M.pop()) throw Error('Unclosed section "' + E[1] + '" at ' + O.pos);
            return function(e) {
    ...
    let c = ({
        ...
        u = (0, a.forwardRef)(function(e, a) {
            let u = (0, o.useObjectRef)(a),
                ...
                Z = (0, n.default)("group outline-hidden", y),
                x = (0, n.default)("text-black dark:text-white group-hover:text-blue group-focus:text-blue dark:group-hover:text-blue transition duration-200", E && ({
