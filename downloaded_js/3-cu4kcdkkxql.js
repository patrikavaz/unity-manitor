(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 106984, t => {
    "use strict";
    var e = t.i(409781),
        r = t.i(848662);
    let n = new Map([
    ...
    t.s(["isRecord", 0, function(t) {
        ...
        return !0 === r || "auto" === r && (!(!Number.isNaN(Number(t)) || /[a-z]/i.test(t) && !/\d+(?:[-:\/]\d+){2}(?:T\d+(?:[-:\/]\d+){1,2}(\.\d+)?Z?)?/.test(t)) && Date.parse(t) || function(t) {
            ...
            return !0
        }(t)) ? t : `${t}${function(t){let e=JSON.stringify(t),r=new TextEncoder().encode(e),o="";for(let t=0;t<r.length;t++){let e=r[t];o+=n[e>>6&3]+n[e>>4&3]+n[e>>2&3]+n[3&e]}return a+o}(e)}`
    }])
}, 477846, (t, e, r) => {
    t.e, e.exports = function() {
        ...
        var a = [
            ...
            i = ["top", "bottom", "left", "right", "center", "focalpoint", "entropy"],
            l = ["format"],
            s = function() {
                function s(t, r) {
                ...
                return c.withOptions = function(r) {
                    ...
                    for (var i in r) r.hasOwnProperty(i) && (o[function(e) {
                    ...
                    if (-1 === i.indexOf(t)) throw Error('Invalid crop mode "' + t + '"');
                    return this.withOptions({
                        crop: t
                    })
                    ...
                    return function(t) {
                        ...
                        if (!l) {
                            if (i && "object" == typeof i && null !== i && i._upload && (!i.asset || !i.asset._ref)) return "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8HwQACfsD/QNViZkAAAAASUVORK5CYII=";
                            throw Error("Unable to resolve image URL from source (" + JSON.stringify(i) + ")")
                        }
                        var s = function(t) {
                                var e = t.split("-"),
                                    n = e[1],
                                    a = e[2],
                                    o = e[3];
                                if (!n || !a || !o) throw Error("Malformed asset _ref '" + t + "'. Expected an id like \"" + r + '".');
                                var i = a.split("x"),
                                    l = i[0],
                                    s = i[1],
                                    c = +l,
                        ...
                        return o.rect || o.focalPoint || o.ignoreImageParams || o.crop || (o = e({}, o, function(t, e) {
                                ...
                                if (o.width / o.height > l) {
                                    var s = Math.round(o.height),
                                        ...
                                        h = Math.max(0, Math.round(Math.round((i.right - i.left) / 2 + i.left) - c / 2));
                                    ...
                                    var p = o.width,
                                        ...
                                        m = Math.max(0, Math.round(Math.round((i.bottom - i.top) / 2 + i.top) - f / 2));
                                    m < o.top ? m = o.top : m + f > o.top + o.height && (m = o.top + o.height - f), r = {
                                        left: d,
                                        top: m,
                                        width: p,
                                        height: f
                            ...
                            function(t) {
                                ...
                                if (t.rect) {
                                    var l = t.rect,
                                        ...
                                        u = l.width,
                                        h = l.height;
                                    (0 !== s || 0 !== c || h !== t.asset.height || u !== t.asset.width) && i.push("rect=" + s + "," + c + "," + u + "," + h)
                                }
    ...
    "function" == typeof SuppressedError && SuppressedError, t.s(["__assign", () => r, "__asyncGenerator", 0, function(t, e, r) {
        ...
        function s(t, e) {
            try {
                var r;
                (r = o[t](e)).value instanceof a ? Promise.resolve(r.value.v).then(c, u) : h(i[0][2], r)
            } catch (t) {
                h(i[0][3], t)
            }
        }
        ...
        function a(r) {
            e[r] = t[r] && function(e) {
                return new Promise(function(n, a) {
                    var o, i, l;
                    o = n, i = a, l = (e = t[r](e)).done, Promise.resolve(e.value).then(function(t) {
                        o({
                            value: t,
                            done: l
                        })
        ...
        try {
            for (;
                (void 0 === e || e-- > 0) && !(n = o.next()).done;) i.push(n.value)
        } catch (t) {
            a = {
                error: t
            }
    ...
    var e = t.i(785328),
        ...
        c = t.i(291158),
        u = t.i(78070);
    let h = (0, t.i(425314).default)(() => t.A(104688), {
            loadableGenerated: {
                modules: [425687]
            },
            ssr: !1
        ...
        g = ({
            ...
            let p = (0, a.default)("absolute inset-0 transition-opacity duration-500", i ? "opacity-100 z-10" : "pointer-events-none opacity-0"),
    ...
    t.s(["default", 0, ({
        ...
        let d = (0, r.useRef)(null),
            ...
            H = w ? A : y && !b,
            Z = !!a?.src && !(x && M),
            I = c ? "string" == typeof c ? c : A ? c.playing : c.paused : "none",
            P = w ? () => V(!0) : void 0;
        return (0, e.jsxs)("div", {
            ref: d,
