(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 123468, e => {
    ...
    j.Block = ({
        ...
        let [k, N] = (0, l.useState)(!1), [E, M] = (0, l.useState)(!1), A = (0, l.useRef)(null), L = (0, m.useInView)(A, {
            once: !0
        }), C = (0, f.useReducedMotion)(), H = 1 / w * y, S = .75 * H, {
            scrollYProgress: V
        } = (0, d.useScroll)({
            target: A
        }), O = (0, c.useTransform)(V, [H, y !== w - 1 ? H + S : 1], [0, 1], {
            ease: u.easeInOut
        }), P = (0, c.useTransform)(V, [H, y !== w - 1 ? H + S : 1], [100, 0], {
            ease: u.easeInOut
        }), T = -((A.current?.offsetHeight || 0) / w) * y;
        h(V, "change", e => {
            N(e >= H)
        });
                        ...
                        case 5:
                            if (function(e, t, a) {
                                    var l = a[0],
                                        ...
                                        o = e[t + 3],
                                        d = V(o, i, s);
                                    return i ? !!(!o && d || V(e[t], l, s) && V(e[t + 1], r, s) && V(e[t + 2], n, s) && d) : d
                                }(e, t, a)) return !0;
                            break;
                        default:
                            return !1
    ...
    function O(e, t, a) {
        ...
        var h = s[0],
            ...
            x = s[3],
            b = s[4];
        return x ? [Math.round(h / x), Math.round(p / x), Math.round(g / x), Math.round(x / b)] : a.defaultColor
    }
    ...
    function T(e, t, a) {
        for (var l = 0, r = 0, n = 0, i = 0, s = 0, o = a.ignoredColor, d = a.step, c = 0; c < t; c += d) {
            var u = e[c],
                ...
                f = e[c + 2],
                h = e[c + 3];
            !(o && S(e, c, o)) && (l += u * u * h, r += m * m * h, n += f * f * h, i += h, s++)
        }
    ...
    function R(e) {
        var t, a, l;
        return (t = e, "u" > typeof HTMLCanvasElement && t instanceof HTMLCanvasElement) ? "canvas" : (a = e, I && a instanceof OffscreenCanvas) ? "offscreencanvas" : B(e) ? "videoframe" : (l = e, "u" > typeof ImageBitmap && l instanceof ImageBitmap) ? "imagebitmap" : e.src
    }
    ...
    var U = function() {
        ...
        return e.prototype.getColorAsync = function(e, t) {
            ...
            if (!this.canvas && (this.canvas = z ? I ? new OffscreenCanvas(1, 1) : null : document.createElement("canvas"), !this.canvas)) {
    ...
    let x = (0, f.default)(() => e.A(410979), {
        ...
        b = ({
            ...
            let n = (0, i.useRef)(null),
                ...
                A = (0, m.useTransform)(y, [0, .9], [0, 1]),
                L = (0, m.useTransform)(y, [0, 1], ["5vh", "40vh"]),
                C = (0, p.default)("z-10 transition-opacity duration-500 object-cover brightness-50", {
                    "opacity-0": v && !b && f && r.src
                });
    ...
    let q = {
        ...
        W = ({
            ...
            let [b, v] = (0, i.useState)(o), j = u ? q[u.toUpperCase()] || u : void 0, y = new Intl.DateTimeFormat(g, {
                month: "short",
                day: "numeric",
                timeZone: j
    ...
    var K = e.i(200241),
        ...
        ei = e.i(518256),
        es = e.i(291158);
    let eo = "mango-text-heading-lg text-white",
        ed = ({
            card: e,
            withArrow: a
        }) => a ? (0, t.jsxs)("a", {
            href: e.href,
            className: "flex flex-1 min-w-0 items-center gap-4 rounded-lg border border-mango-gray-500 bg-mango-gray-800 px-4 py-[18px] text-mango-gray-300 outline-none focus:outline-none focus-visible:outline-none hover:border-mango-gray-300",
            children: [(0, t.jsxs)("div", {
                className: "flex min-w-0 flex-1 flex-col justify-center gap-1",
                children: [(0, t.jsx)("p", {
                    className: "mango-text-body-base font-medium",
                    children: e.title
                }), (0, t.jsx)("p", {
                    className: "mango-text-body-sm",
                    children: e.description
                })]
            }), (0, t.jsx)("span", {
                "aria-hidden": "true",
                className: "shrink-0",
                children: (0, t.jsx)(es.default, {
                    as: ei.CaretRight,
                    size: "1.25rem",
                    className: "fill-mango-gray-300"
                })
            })]
        }) : (0, t.jsx)("a", {
            href: e.href,
            className: "flex flex-1 min-w-0 rounded-lg border border-transparent bg-gray-900 p-4 outline-none focus:outline-none focus-visible:outline-none hover:[background:linear-gradient(#141414,#141414)_padding-box,linear-gradient(to_bottom,#727272,#141414)_border-box]",
            children: (0, t.jsxs)("div", {
        ...
        ec = ({
            ...
            children: (0, t.jsx)("div", {
                ...
                children: (0, t.jsxs)("div", {
                    ...
                    children: [(0, t.jsx)("h2", {
                        className: (0, p.default)(eo, "text-center lg:w-[271px] lg:shrink-0 lg:text-left"),
                        children: e
                    }), (0, t.jsx)("div", {
                        className: "flex w-full flex-col gap-2 lg:flex-1 lg:flex-row",
                        children: a.map((e, a) => (0, t.jsx)(ed, {
                            card: e,
                            withArrow: l
                        }, `${e.href}-${a}`))
                    })]
        ...
        eu = ({
            ...
            let s = (0, i.useRef)(null),
                ...
                m = (0, i.useId)(),
                f = (0, c.useReducedMotion)(),
                h = .2 * !f;
            return (0, t.jsx)(ea.Overlay, {
                        ...
                        children: [(0, t.jsx)(o.m.div, {
                            ...
                            children: (0, t.jsx)("div", {
                                ...
                                children: (0, t.jsxs)(o.m.div, {
                                    ...
                                    children: [(0, t.jsx)("h2", {
                                        id: m,
                                        className: (0, p.default)(eo, "text-center"),
                                        children: a
                                    }), (0, t.jsx)("div", {
                                        className: "flex w-full flex-col gap-2 lg:flex-row",
                                        children: l.map((e, a) => (0, t.jsx)(ed, {
                                            card: e,
                                            withArrow: r
                                        }, `${e.href}-${a}`))
                                    }), n && (0, t.jsx)("button", {
        ...
        em = ({
            ...
            let s = (0, er.useOverlayTriggerState)({
                isOpen: r,
                onOpenChange: e => {
                    e || n?.()
                }
            });
            return s.isOpen ? (0, t.jsx)(eu, {
                state: s,
                title: e,
                cards: a,
                withArrow: l,
    ...
    let ep = {
            ...
            footnote: H.default,
            logosBank: V.default,
            featuresList: O.default,
            title: P.default,
            testimonialsBlock: T.default,
            animatedFeaturesList: R.default,
            mangoDeluxeAnnouncementBanner: eh.default,
            media: I.default,
            richText: B.default,
            events: ({
                upcomingEvents: e,
    ...
    e.s(["default", 0, function({
        ...
        let {
            ...
            updatedBlocks: l
        } = (0, ev.useMTBanner)(e, eb.L1_PAGES_NO_MT_BANNER);
        return (0, t.jsxs)(t.Fragment, {
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "97aea0e4-2699-59bd-8ea6-a36f9bd76333")
    } catch (e) {}
}();
//# debugId=97aea0e4-2699-59bd-8ea6-a36f9bd76333