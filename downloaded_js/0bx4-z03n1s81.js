(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 34734, e => {
    ...
    let i = {
        ...
        a = {
            ...
            vn: {
                pageTitle: "Không tìm thấy trang - Unity",
                pageDescription: "Unity là nền tảng phát triển trò chơi toàn diện. Sử dụng Unity để xây dựng các trò chơi 3D và 2D chất lượng cao, triển khai trên thiết bị di động, máy tính để bàn, VR/AR, máy chơi game hoặc Web, đồng thời kết nối với những người chơi và khách hàng trung thành, nhiệt huyết.",
                title: "Không tìm thấy / 404",
                statement1: "Trang này không còn khả dụng.",
                statement2: "Bạn có thể tìm thấy trang mình đang tìm kiếm bằng cách duyệt qua các liên kết trong menu phía trên."
            }
        };
