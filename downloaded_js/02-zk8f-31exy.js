(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 480880, e => {
    ...
    }, "usePageCommerce", 0, l], 641077);
    var s = e.i(544923);
    let u = (e, t) => t?.country ? e?.country?.toLowerCase().localeCompare(t?.country.toLowerCase()) || 0 : -1,
        c = {
            currency: "USD"
        },
        f = e => e?.text !== null && e?.text !== void 0 || (e?.children ? e.children.every(f) : !!Array.isArray(e) && e.every(f));
    e.s(["default", 0, () => {
        let {
            state: e
        } = (0, n.default)(), {
            products: o
        } = l(), [i] = (0, s.default)("location", "US"), a = t => {
            let r = t?.variantPrices.sort(u),
                n = e => r?.find(t => t.currency?.toLowerCase() === e?.currency?.toLowerCase() && (t.country?.toLowerCase() === i?.toLowerCase() || !t.country))?.price;
            return n(e) ? [n(e), !1] : [n(c), !0]
        }, d = e => {
            if (!e) return {};
            let {
                productVariants: t,
        ...
        return {
            ...
            appendPageCommerceDataToPortableText: e => m(e, void 0, e => h(e, o))
        }
    }], 326388)
    ...
    function A(e, {
                    ...
                    ! function(e, t = e, r) {
                        ...
                        let {
                            ...
                            let r = {
                                ...
                                n = e;
                            for (; n && n !== t;)
                                if ((0, z.isHTMLElement)(n)) r.x += n.offsetLeft, r.y += n.offsetTop, n = n.offsetParent;
                        ...
                        c && (t[i].interpolate = (0, L.interpolate)(t[i].offset, (0, j.defaultOffset)(n), {
                            clamp: !1
                        }), t[i].interpolatorOffsets = [...t[i].offset]), t[i].progress = (0, C.clamp)(0, 1, t[i].interpolate(t[i].current))
                    }(e, r, n)
                },
                notify: () => t(r)
            }
        ...
        return l.frame.read(u, !1, !0), () => {
            ...
            let t = M.get(n);
            M.delete(n), t && (V(n).removeEventListener("scroll", t), T.get(n)?.(), window.removeEventListener("resize", t))
        }
    }
    let $ = new Map;
    ...
    e.s(["useScroll", 0, function({
        ...
        let n = (0, R.useConstant)(F),
            ...
            c = (0, i.useCallback)(() => (l.current = function(e, {
                ...
                return "function" == typeof e ? (o = e, i = u, 2 === o.length ? A(e => {
                    o(e[i.axis].progress, e)
                }, i) : s(o, B(i))) : (l = B(u), e.attachTimeline({
    ...
    e.s(["useMotionValue", 0, I], 997413), e.s(["useTransform", 0, function(e, t, r, o) {
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "c188b7c9-adf0-5929-bf53-652f766f8991")
    } catch (e) {}
}();
//# debugId=c188b7c9-adf0-5929-bf53-652f766f8991