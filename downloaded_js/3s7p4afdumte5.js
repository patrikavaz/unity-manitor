(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 641077, e => {
    "use strict";
    var t = e.i(785328),
        r = e.i(409781);
...
`, {
                ...
                return t ? t.reduce(function(e, t, r) {
                    ...
                    if (-1 !== o) {
                        ...
                        let u, c = (-1 !== (l = t.slice(0, o)).indexOf("-") && null === l.match(M) && (l = l.replace(z, function(e, t) {
                            ...
                            }, {}) : "href" === c ? ez(s) : (s.match(L) && (s = s.slice(1, s.length - 1)), "true" === s || "false" !== s && s));
                        "string" == typeof d && (C.test(d) || A.test(d)) && (e[f] = n.cloneElement(K(d.trim()), {
                            key: r
                        }))
    ...
    let f = ({
            ...
            return (0, r.useEffect)(() => {
                e.isOpen && a.current?.querySelector("div")?.focus()
