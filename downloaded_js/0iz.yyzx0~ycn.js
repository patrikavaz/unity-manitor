(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 507546, e => {
    ...
    e.s(["calculatePosition", 0, function(e) {
        ...
        return "HTML" === A.tagName && "BODY" === S.tagName && (I.scroll.top = 0, I.scroll.left = 0),
            function(e, t, r, n, a, u, d, f, h, y, v, b, P, w, k, x) {
                var S, M, O, R, C, D, A, E, L, K, T, z, j, B;
                let I, F, N, H = p(e),
                    {
                        size: W,
                        crossAxis: U,
                ...
                let X = {},
                    ...
                    et = k / 2 + x,
                    el = "left" === s[U] ? (null != (S = a.left) ? S : 0) + (null != (M = a.right) ? M : 0) : (null != (O = a.top) ? O : 0) + (null != (R = a.bottom) ? R : 0),
                    es = r[V] - el - k / 2 - x,
            ...
            }(v, K, T, j, z, k, x, B, I, F, M, O, !!L && "static" !== L, R, C, D)
    }])
}, 506275, e => {
    "use strict";
    var t = e.i(3931);
    ...
    e.s(["useOverlayPosition", 0, function(e) {
        ...
        } = e, [R, C] = (0, s.useState)(null), D = [k, h, m.current, g.current, f.current, y, v, b, P, w, x, c, M, O, p], A = (0, s.useRef)(null == i ? void 0 : i.scale);
        (0, s.useEffect)(() => {
            x && (A.current = null == i ? void 0 : i.scale)
        }, [x]);
        let E = (0, s.useCallback)(() => {
            var e, l, s, o, r, n;
            if (!1 === k || !x || !m.current || !g.current || !b || (null == i ? void 0 : i.scale) !== A.current) return;
            let a = null;
            if (f.current && f.current.contains(document.activeElement)) {
                ...
                (a = {
                    type: "top",
                    offset: (null != (l = null == t ? void 0 : t.top) ? l : 0) - o.top
                }).offset > o.height / 2 && (a.type = "bottom", a.offset = (null != (s = null == t ? void 0 : t.bottom) ? s : 0) - o.bottom)
            }
            let u = m.current;
            ...
            if (d.position) {
                if (u.style.top = "", u.style.bottom = "", u.style.left = "", u.style.right = "", Object.keys(d.position).forEach(e => u.style[e] = d.position[e] + "px"), u.style.maxHeight = null != d.maxHeight ? d.maxHeight + "px" : "", a && document.activeElement && f.current) {
                    let e = document.activeElement.getBoundingClientRect(),
                        t = f.current.getBoundingClientRect(),
                        l = e[a.type] - t[a.type];
                    f.current.scrollTop += l - a.offset
                }
                C(d)
            }
        }, D);
        (0, o.useLayoutEffect)(E, D), d = E, (0, o.useLayoutEffect)(() => (window.addEventListener("resize", d, !1), () => {
        ...
        return (0, l.useCloseOnScroll)({
            ...
            overlayProps: {
                style: {
                    ...
                    maxHeight: null != (a = null == R ? void 0 : R.maxHeight) ? a : "100vh"
                }
            },
            placement: null != (u = null == R ? void 0 : R.placement) ? u : null,
            arrowProps: {
                "aria-hidden": "true",
                role: "presentation",
                style: {
                    left: null == R ? void 0 : R.arrowOffsetLeft,
                    top: null == R ? void 0 : R.arrowOffsetTop
                }
            },
            updatePosition: E
        }
    ...
    let D = ({
        ...
        return (0, t.jsxs)(R.Overlay, {
            ...
            children: [(0, t.jsx)("div", {
                ...
                children: [(0, t.jsx)(O.DismissButton, {
                    onDismiss: s.close
                }), e, (0, t.jsx)(O.DismissButton, {
                    onDismiss: s.close
                })]
            })]
        })
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "13c4cb90-d9ba-515f-a989-b83a267d392c")
    } catch (e) {}
}();
//# debugId=13c4cb90-d9ba-515f-a989-b83a267d392c