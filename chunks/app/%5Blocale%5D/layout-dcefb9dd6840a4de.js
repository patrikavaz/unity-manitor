! function() {
    ...
    [98450], {
        ...
        47641: (e, t, r) => {
            ...
            function U({
                ...
                let [s, l] = (0, n.useState)(null), [u, m] = (0, n.useState)(!1), h = (0, i.usePathname)(), g = (0, n.useRef)(null), x = (0, n.useRef)(null), f = o ? o.filter(e => "string" != typeof e) : [];
                return (0, n.useEffect)(() => {
                        ...
                        children: u && (0, a.jsx)(S.Uu, {
                            ...
                            children: (0, a.jsxs)("div", {
                                ...
                                children: [e.map((e, t) => (0, a.jsx)(P, {
                                    ...
                                    setActive: l,
                                    index: t
                                }, `search-modal-search-result-${e.title}-${t}`)), f.length > 0 ? f.map((e, t) => (0, a.jsx)(c.A, {
            ...
            let M = ({
                ...
                let [y, v] = (0, n.useState)(null), [b, k] = (0, n.useState)(!1), j = (0, i.usePathname)(), w = (0, n.useRef)(null), N = (0, n.useRef)([]), A = (0, n.useRef)(null), E = (0, n.useRef)([]), S = e?.map(e => e.panel)?.filter(e => !!e) || [], _ = {
                    search: e => (0, a.jsx)(L, {
                        ref: x,
                        onClick: P,
                        onMouseEnter: s,
                        ...
                        children: [b && (0, a.jsx)("div", {
                            ...
                            children: [(0, a.jsxs)("div", {
                                ...
                                children: [(0, a.jsx)(h, {
                                    ...
                                    onKeyDown: e => {
                                        "Escape" === e.key && b && (e.preventDefault(), k(!1), v(null), null !== y && N.current[y]?.focus())
                                    },
                                    children: [(0, a.jsx)("nav", {
                                        children: (0, a.jsx)("ul", {
                                            ...
                                            children: e.map((t, r) => (0, a.jsx)("li", {
                                                children: (0, a.jsx)(l.N_, {
                                                    ...
                                                    className: `mango-text-heading-5xs text-mango-white hover:bg-mango-gray-950 block rounded-xl px-3 py-2 ${y===r?"bg-mango-gray-950":""}`,
                                                    href: t.link?.href,
                                                    target: t.link?.target === "_blank" ? "_blank" : void 0,
                                                    onMouseEnter: () => v(r),
                                                    onKeyDown: t => ((t, r) => {
                                                        let a = e[r]?.panel;
                                                        "ArrowDown" === t.key && a && (t.preventDefault(), v(r), k(!0), setTimeout(() => {
                                                            let e = D(r);
                                                            e[0]?.focus()
                                                        }, 100))
                                                    })(t, r),
                                                    "aria-haspopup": t.panel ? "true" : void 0,
                                                    "aria-expanded": t.panel && y === r && b ? "true" : "false",
                                        ...
                                        onKeyDown: e => {
                                            if ("Escape" === e.key) {
                                                e.preventDefault(), e.stopPropagation(), k(!1), v(null), null !== y && N.current[y]?.focus();
                                                return
                                            }
                                            if ("Tab" === e.key && b && null !== y) {
                                                let t = null === y ? [] : D(y);
                                                ...
                                                let r = t[0],
                                                    ...
                                                    n = t.indexOf(a);
                                                if (-1 === n) return;
                                                e.shiftKey ? 0 === n && (e.preventDefault(), k(!1), v(null), N.current[y]?.focus()) : n === t.length - 1 && (e.preventDefault(), r.focus())
                                            }
                                        },
                                ...
                                className: "flex items-center gap-3",
                                children: [p ? p.map((e, t) => ((e, t) => "string" == typeof e ? _[e]?.(t) ?? null : (0, a.jsx)(c.A, {
            ...
            let V = ({
                ...
                Y = (0, o.default)(() => Promise.all([r.e(87885), r.e(8111), r.e(43360)]).then(r.bind(r, 43360)), {
                    loadableGenerated: {
                        webpack: () => [43360]
                    },
                    ssr: !1
  ...
  `, R = {
    ...
    e => {
        e.O(0, [95265, 20943, 37507, 80361, 53501, 96520, 42681, 21762, 14234, 51465, 54232, 67536, 87604, 94649, 57149, 91669, 77358], () => e(e.s = 25705)), _N_E = e.O()
    }
]);