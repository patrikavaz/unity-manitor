                ...
                h = ({
                    ...
                    let _ = (0, s.A)("top-0 left-0 h-full w-full absolute z-10 transition-opacity duration-500 object-cover", {
                        ...
                        B = (0, s.A)("rounded-lg bg-gray-100 p-4 dark:bg-gray-900", {
                            "h-full": "horizontal" !== f,
                            "group h-full relative p-[1px] xl:flex-row xl:gap-6 ": "horizontal" === f
                        }),
                        ...
                        T = (0, s.A)("cover absolute object-cover", {
                            "transition-transform duration-400 group-hover:scale-110": "horizontal" === f
                        }),
                        M = "horizontal" === f && h?.href,
                        R = (0, l.jsxs)("div", {
                            ref: k,
                            className: B,
                            children: ["horizontal" === f && (0, l.jsx)("div", {
