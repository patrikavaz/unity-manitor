    ...
    [58889], {
        ...
        62870: (e, t, l) => {
            ...
            function C(e) {
                ...
                } = e, [O, z] = (0, w.useState)(null), V = [L, x, d.current, c.current, C.current, k, M, B, F, A, I, s, R, N, u], H = (0, w.useRef)(null == P ? void 0 : P.scale);
                (0, w.useEffect)(() => {
                        ...
                        return "HTML" === B.tagName && "BODY" === E.tagName && (O.scroll.top = 0, O.scroll.left = 0),
                            function(e, t, l, n, s, u, c, d, f, v, m, b, K, w, S, D) {
                                ...
                                let k = p(e),
                                    ...
                                    I = g(t, d, l, k, m, b, v, K, S, D),
                                    T = m,
                                    R = y(d, v, t, s, u + m, k);
                                if (c && n[M] > R) {
                                    let e = p(`${r[A]} ${L}`),
                                        n = g(t, d, l, e, m, b, v, K, S, D);
                                    y(d, v, t, s, u + m, e) > R && (k = e, I = n, T = m)
                                }
                                let N = "bottom";
                                ...
                                w && w < z && (z = w), l.height = Math.min(l.height, z), O = h(B, (I = g(t, d, l, k, T, b, v, K, S, D))[B], l[F], d, f, u, v), I[B] += O;
                                let V = {},
                                    H = t[B] + .5 * t[F] - I[B] - s[o[B]],
                                    U = S / 2 + D,
                                    j = "left" === o[B] ? (null != (E = s.left) ? E : 0) + (null != (P = s.right) ? P : 0) : (null != (C = s.top) ? C : 0) + (null != (x = s.bottom) ? x : 0),
                                    W = l[F] - j - S / 2 - D,
                            ...
                            }(c, L, I, R, T, S, D, N, O, z, P, C, !!A && "static" !== A, x, k, M)
                    }({
                        placement: (w = x, "rtl" === s ? w.replace("start", "right").replace("end", "left") : w.replace("start", "left").replace("end", "right")),
