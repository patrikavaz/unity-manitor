...
Error:`, t)
                ...
                let e6 = [],
                    ...
                    e8 = ({
                        ...
                        let t = eG(e.value);
                        if (t > 60) return;
                        let r = e.entries.find(t => t.duration === e.value && e7[t.name]);
                        if (!r) return;
                        let {
                            interactionId: n
                        } = r, a = e7[r.name], o = eG((0, y.k3)() + r.startTime), i = (0, _.Bk)(), s = i ? (0, _.zU)(i) : void 0, l = null != n ? e4.get(n) : void 0, u = l?.span || s, f = u ? (0, _.et)(u).description : (0, c.o5)().getScopeData().transactionName, p = eX({
                            ...
                            afterAllSetup(e) {
                                ...
                                M && (tn.jf.document ? tn.jf.document.addEventListener("visibilitychange", () => {
                                        ...
                                        function t(e) {
                                            ...
                                            if (e9.set(n, r), e9.size > 50) {
                                                let e = e9.keys().next().value;
                                                void 0 !== e && e9.delete(e)
                                            }
                                        }
...
let e4 = /^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i,
    e9 = /^\s*at (?:(.+?\)(?: \[.+\])?|.*?) ?\((?:address at )?)?(?:async )?((?:<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
    e7 = /\((\S*)(?::(\d+))(?::(\d+))\)/,
    e8 = /at (.+?) ?\(data:(.+?),/,
    te = [30, e => {
        let t = e.match(e8);
...
function tk(e) {
    ...
    let t = {
        ...
        release: "b936c23af9f43aa85505d4cf01a6d50273aa3e08",
        ...e
    };
    ! function(e) {
...
id: "b936c23af9f43aa85505d4cf01a6d50273aa3e08"
