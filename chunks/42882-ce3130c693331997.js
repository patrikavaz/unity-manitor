try {
    let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
        t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "efbde664-f382-4d15-966f-3e244633d35a", e._sentryDebugIdIdentifier = "sentry-dbid-efbde664-f382-4d15-966f-3e244633d35a")
} catch (e) {}
"use strict";
    ...
    [42882], {
        ...
        62318: (e, t, n) => {
            ...
            v.prototype.eos = function() {
                    ...
                    for (var V = new v(e); !V.eos();) {
                        if (a = V.pos, y = V.scanUntil(n))
                            for (var A = 0, D = y.length; A < D; ++A) ! function(e) {
                                return !c.call(u, e)
                            }(w = y.charAt(A)) ? (j = !0, C = !0, U += " ") : (T.push(x.length), U += w), x.push(["text", w, a, a + 1]), a += 1, "\n" === w && (S(), U = "", I = 0, C = !1);
                        if (!V.scan(n)) break;
                        if (_ = !0, p = V.scan(g) || "name", V.scan(l), "=" === p ? (y = V.scanUntil(h), V.scan(h), V.scanUntil(r)) : "{" === p ? (y = V.scanUntil(o), V.scan(d), V.scanUntil(r), p = "&") : y = V.scanUntil(r), !V.scan(r)) throw Error("Unclosed tag at " + V.pos);
                ...
                return c
            }, w.prototype.renderSection = function(e, t, n, r, s) {
                var a = this,
                    c = "",
                    u = t.lookup(e[1]);
                if (u) {
