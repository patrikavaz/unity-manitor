...
`
            ...
            let x = ["boolean", "string", "number"],
                I = {};
            "u" > typeof globalThis ? I = globalThis : "u" > typeof window ? I = window : "u" > typeof global ? I = global : "u" > typeof self && (I = self);
            var A = I;
            let O = (e = {}) => {
...
${function(e,t,r){let n=e.split(ev),{start:i,end:s,markerLines:o}=function(e,t){let r={...e.start},n={...r,...e.end},i=r.line??-1,s=r.column??0,o=n.line,a=n.column,u=Math.max(i-3,0),c=Math.min(t.length,o+3);-1===i&&(u=0),-1===o&&(c=t.length);let l=o-i,h={};if(l)for(let e=0;e<=l;e++){let r=e+i;if(s)if(0===e){let e=t[r-1].length;h[r]=[s,e-s+1]}else if(e===l)h[r]=[0,a];else{let n=t[r-e].length;h[r]=[0,n]}else h[r]=!0}else s===a?s?h[i]=[s,0]:h[i]=!0:h[i]=[s,a-s];return{start:u,end:c,markerLines:h}}({start:ew(t.start,n),end:t.end?ew(t.end,n):void 0},n),a=`
            ...
            function eI(e, t = {}) {
                return ((e = [], t = m) => (function e(t, r) {
                    ...
                    processOptions: e => {
                        let t = e.body;
                        return !t || "function" == typeof t.pipe || $(t) || -1 === x.indexOf(typeof t) && !Array.isArray(t) && ! function(e) {
                            if (!1 === _(e)) return !1;
                            let t = e.constructor;
                ...
                return (0, M.v)(() => {
                    ...
                    return r = e, n = t, new k.c(e => {
                        ...
                        function s(t) {
                            if ("data" in t) {
                                let [r, n] = e7(t);
                                e.error(r ? new e4("Unable to parse EventSource error message", {
                                    cause: n
                        ...
                        function a(t) {
                            let [n, i] = e7(t);
                            if (n) return void e.error(new e4("Unable to parse EventSource message", {
                                cause: n
                            }));
                            ...
                            if ("disconnect" === t.type) return void e.error(new e2(`Server disconnected client: ${i.data?.reason||"unknown error"}`));
                            e.next({
                                type: t.type,
                                id: t.lastEventId,
                                ...i.data ? {
...
${t}`)
            ...
            function th(e, t, n, i, s = {}, o = {}) {
                ...
                }((0, z.H)(r.e(81984).then(r.bind(r, 81984)).then(function(e) {
            ...
            function td(e, t, r, n = {}) {
                ...
                return tI(e, t, i).pipe((0, eg.p)(tc), (0, es.T)(e => {
            ...
            function tT(e, t, r, n, i = {}) {
                ...
                return tI(e, t, b).pipe((0, eg.p)(tc), (0, es.T)(tl), (0, es.T)(e => {
                    if (!s) return e;
                    let t = e.results || [];
            ...
            let t_ = e => void 0 !== e.config().dataset && void 0 !== e.config().projectId || void 0 !== e.config()["~experimental_resource"],
                tx = (e, t) => t_(e) && t.startsWith(tO(e, "query"));

            function tI(e, t, r) {
                var n;
                let i = r.url || r.uri,
                    s = e.config(),
                    o = typeof r.canUseCdn > "u" ? ["GET", "HEAD"].indexOf(r.method || "GET") >= 0 && (i.startsWith("/data/") || tx(e, i) || t_(e) && i.startsWith(tO(e, "mutate")) || t_(e) && i.startsWith(tO(e, "doc", "")) || t_(e) && i.startsWith(tO(e, "listen")) || t_(e) && i.startsWith(tO(e, "history", ""))) : r.canUseCdn,
            ...
            function tA(e, t, r) {
                return tI(e, t, r).pipe((0, eg.p)(e => "response" === e.type), (0, es.T)(e => e.body))
            }
            ...
            function tL(e, t, r, n, i = {}) {
                ...
                return g && (m.sourceId = g.id, m.sourceName = g.name, m.sourceUrl = g.url), tI(e, t, {
                    tag: l,
                    method: "POST",
                    timeout: c.timeout || 0,
                    uri: function(e, t) {
            ...
            let tV = (0, M.v)(() => r.e(58212).then(r.t.bind(r, 58212, 19))).pipe((0, es.T)(({
                default: e
            }) => e), (0, W.t)(1));
            ...
            let t9 = ((e, t = 21) => ((e, t, r) => {
                ...
                t4 = (e, t) => t ? (0, em.ct)(e, t) : (0, em.T4)(e);
            ...
            class rn {
                ...
                constructor(e, t = eZ) {
                    ...
                    }, this.projects = new t2(this, this.#u), this.users = new rt(this, this.#u), this.agent = {
        ...
        54021: (e, t, r) => {
            ...
            var n = new(r(19283)).c(function(e) {
                return e.complete()
            })
        },
        58131: (e, t, r) => {
