try {
    let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
        t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "98e257df-19db-41d4-a4eb-ce6c0d6897ad", e._sentryDebugIdIdentifier = "sentry-dbid-98e257df-19db-41d4-a4eb-ce6c0d6897ad")
} catch (e) {}
"use strict";
    ...
    [42405], {
        1592: (e, t, r) => {
            ...
            function M(e, t, r, n) {
                ...
                let u = n - l;
                i.velocity = u > 50 ? 0 : (0, C.f)(i.current - a, u)
            }
            var W = r(17392),
                H = r(11572),
                O = r(8695),
            ...
            let R = [0, 0],
                ...
                B = new WeakMap,
                D = new WeakMap,
                S = e => e === document.scrollingElement ? window : e;
            ...
            function z(e, {
                ...
                let s = function(e, t, r, n = {}) {
                    return {
                        measure: t => {
                            ...
                            }(e, n.target, r), M(e, "x", r, t), M(e, "y", r, t), r.time = t, (n.offset || n.target) && function(e, t, r) {
                                let {
                                    offset: n = T.All
                                } = r, {
                                    target: i = e,
                                ...
                                for (let e = 0; e < f; e++) {
                                    let r = function(e, t, r, n) {
                                        let i = Array.isArray(e) ? e : R,
                                            o = 0;
                                        return "number" == typeof e ? i = [e, e] : "string" == typeof e && (i = (e = e.trim()).includes(" ") ? e.split(" ") : [e, I[e] ? e : "0"]), (o = G(i[0], r, n)) - G(i[1], t)
                                    }(n[e], u[s], l[s], a[o]);
                                    c || r === t[o].interpolatorOffsets[e] || (c = !0), t[o].offset[e] = r
                                }
                                c && (t[o].interpolate = (0, W.G)(t[o].offset, (0, H.Z)(n), {
                                    clamp: !1
                ...
                return u.Gt.read(a, !1, !0), () => {
                    ...
                    let r = A.get(t);
                    A.delete(t), r && (S(t).removeEventListener("scroll", r), B.get(t)?.(), window.removeEventListener("resize", r))
                }
            }
            let _ = new Map;
            ...
            function j({
                ...
                e && (t = e);
                let i = _.get(t) ?? new Map;
                _.set(t, i);
                let o = r.target ?? "self",
                    s = i.get(o) ?? {},
                    a = n + (r.offset ?? []).join(",");
                return s[a] || (s[a] = !r.target && (0, f.J)() ? new ScrollTimeline({
                    source: t,
                    axis: n
                }) : function(e) {
                    let t = {
            ...
            function V({
                ...
                let n = (0, q.M)(F),
                    ...
                    u = (0, a.useCallback)(() => (i.current = function(e, {
                        ...
                        return "function" == typeof e ? (i = e, o = s, 2 === i.length ? z(e => {
                            i(e[o.axis].progress, e)
                        }, o) : c(i, j(o))) : function(e, t) {
                            let r = j(t);
        ...
        35149: (e, t, r) => {
                                ...
                                case 5:
                                    if (function(e, t, r) {
                                            var n = r[0],
                                                ...
                                                u = e[t + 3],
                                                c = s(u, a, l);
                                            return a ? !!(!u && c || s(e[t], n, l) && s(e[t + 1], i, l) && s(e[t + 2], o, l) && c) : c
                                        }(e, t, r)) return !0;
                                    break;
                                default:
                                    return !1
            ...
            function a(e, t, r) {
                for (var n = {}, i = r.dominantDivider || 24, s = r.ignoredColor, a = r.step, l = [0, 0, 0, 0, 0], u = 0; u < t; u += a) {
                    var c = e[u],
                        ...
                        h = e[u + 3];
                    if (!(s && o(e, u, s))) {
                        var g = Math.round(c / i) + "," + Math.round(f / i) + "," + Math.round(d / i);
                        n[g] ? n[g] = [n[g][0] + c * h, n[g][1] + f * h, n[g][2] + d * h, n[g][3] + h, n[g][4] + 1] : n[g] = [c * h, f * h, d * h, h, 1], l[4] < n[g][4] && (l = n[g])
                    }
                }
                var v = l[0],
                    p = l[1],
            ...
            function l(e, t, r) {
                for (var n = 0, i = 0, s = 0, a = 0, l = 0, u = r.ignoredColor, c = r.step, f = 0; f < t; f += c) {
                    var d = e[f + 3],
                        h = e[f] * d,
                        g = e[f + 1] * d,
                        v = e[f + 2] * d;
                    !(u && o(e, f, u)) && (n += h, i += g, s += v, a += d, l++)
                }
            ...
            function u(e, t, r) {
                for (var n = 0, i = 0, s = 0, a = 0, l = 0, u = r.ignoredColor, c = r.step, f = 0; f < t; f += c) {
                    var d = e[f],
                        ...
                        g = e[f + 2],
                        v = e[f + 3];
                    !(u && o(e, f, u)) && (n += d * d * v, i += h * h * v, s += g * g * v, a += v, l++)
                }
            ...
            var w = function() {
                ...
                return e.prototype.getColorAsync = function(e, t) {
                    ...
                    }(e), i = f(n = t, "left", 0), o = f(n, "top", 0), s = f(n, "width", r.width), a = f(n, "height", r.height), l = s, u = a, "precision" === n.mode || (s > a ? u = Math.round((l = 100) / (s / a)) : l = Math.round((u = 100) / (a / s)), (l > s || u > a || l < 10 || u < 10) && (l = s, u = a)), {
                        srcLeft: i,
                        srcTop: o,
                        srcWidth: s,
                        srcHeight: a,
                    ...
                    try {
                        ...
                        var C = this.ctx.getImageData(0, 0, E.destWidth, E.destHeight).data;
                        return this.prepareResult(this.getColorFromArray4(C, t))
                    } catch (r) {
        ...
        51317: (e, t, r) => {
            ...
            function c(e, t, r, i) {
                ...
                return Array.isArray(e) ? f(e, o) : f([e], ([e]) => o(e))
            }
