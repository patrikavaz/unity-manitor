try {
    let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
        t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "212b1a60-170f-4261-8a95-599e3e6d377e", e._sentryDebugIdIdentifier = "sentry-dbid-212b1a60-170f-4261-8a95-599e3e6d377e")
} catch (e) {} {
    let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
        ...
        19229: (e, t, r) => {
            ...
            function s(e, t, r) {
                for (var n = {}, i = r.dominantDivider || 24, a = r.ignoredColor, s = r.step, d = [0, 0, 0, 0, 0], u = 0; u < t; u += s) {
                    var c = e[u],
                        ...
                        f = e[u + 3];
                    if (!(a && o(e, u, a))) {
                        var g = Math.round(c / i) + "," + Math.round(h / i) + "," + Math.round(l / i);
                        n[g] ? n[g] = [n[g][0] + c * f, n[g][1] + h * f, n[g][2] + l * f, n[g][3] + f, n[g][4] + 1] : n[g] = [c * f, h * f, l * f, f, 1], d[4] < n[g][4] && (d = n[g])
                    }
                }
                var v = d[0],
                    p = d[1],
                    ...
                    y = d[3],
                    b = d[4];
                return y ? [Math.round(v / y), Math.round(p / y), Math.round(m / y), Math.round(y / b)] : r.defaultColor
            }
            ...
            function u(e, t, r) {
                for (var n = 0, i = 0, a = 0, s = 0, d = 0, u = r.ignoredColor, c = r.step, h = 0; h < t; h += c) {
                    var l = e[h],
                        ...
                        g = e[h + 2],
                        v = e[h + 3];
                    !(u && o(e, h, u)) && (n += l * l * v, i += f * f * v, a += g * g * v, s += v, d++)
                }
            ...
            var b = function() {
                ...
                return e.prototype.getColorAsync = function(e, t) {
                    ...
                    if (f(e) && !e.complete) return this.bindImageEvents(e, t);
                    ...
                    if (!e) {
                        var w = m("call .getColor() without resource");
                        return y(w, t.silent), this.prepareResult(b, w)
                    }
                    var M = (r = function(e) {
                        if (f(e)) {
                    ...
                    if (!M.srcWidth || !M.srcHeight || !M.destWidth || !M.destHeight) {
                        var w = m('incorrect sizes for resource "'.concat(l(e), '"'));
                        return y(w, t.silent), this.prepareResult(b, w)
                    }
                    if (!this.canvas && (this.canvas = p ? g ? new OffscreenCanvas(1, 1) : null : document.createElement("canvas"), !this.canvas)) {
                        var w = m("OffscreenCanvas is not supported in this browser");
                        return y(w, t.silent), this.prepareResult(b, w)
                    }
                    if (!this.ctx) {
                        if (this.ctx = this.canvas.getContext("2d", {
                            ...
                            var w = m("Canvas Context 2D is not supported in this browser");
                            return y(w, t.silent), this.prepareResult(b)
                        }
                    ...
                    try {
                        ...
                        var C = this.ctx.getImageData(0, 0, M.destWidth, M.destHeight).data;
                        return this.prepareResult(this.getColorFromArray4(C, t))
                    } catch (r) {
                        var w = m("security error (CORS) for resource ".concat(l(e), ".\nDetails: https://developer.mozilla.org/en/docs/Web/HTML/CORS_enabled_image"));
                        return y(w, t.silent), t.silent || console.error(r), this.prepareResult(b, w)
                    }
