            ...
            function s(e, t, r) {
                for (var n = {}, i = r.dominantDivider || 24, a = r.ignoredColor, s = r.step, d = [0, 0, 0, 0, 0], u = 0; u < t; u += s) {
                    var c = e[u],
                        ...
                        f = e[u + 3];
                    if (!(a && o(e, u, a))) {
                        var v = Math.round(c / i) + "," + Math.round(h / i) + "," + Math.round(l / i);
                        n[v] ? n[v] = [n[v][0] + c * f, n[v][1] + h * f, n[v][2] + l * f, n[v][3] + f, n[v][4] + 1] : n[v] = [c * f, h * f, l * f, f, 1], d[4] < n[v][4] && (d = n[v])
                    }
                }
                var g = d[0],
                    p = d[1],
            ...
            function u(e, t, r) {
                for (var n = 0, i = 0, a = 0, s = 0, d = 0, u = r.ignoredColor, c = r.step, h = 0; h < t; h += c) {
                    var l = e[h],
                        ...
                        v = e[h + 2],
                        g = e[h + 3];
                    !(u && o(e, h, u)) && (n += l * l * g, i += f * f * g, a += v * v * g, s += g, d++)
                }
