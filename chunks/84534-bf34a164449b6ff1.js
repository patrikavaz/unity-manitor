try {
    let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
        t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "ca1a3dee-3b4e-4a90-8d0a-e839e64941ee", e._sentryDebugIdIdentifier = "sentry-dbid-ca1a3dee-3b4e-4a90-8d0a-e839e64941ee")
} catch (e) {}
"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [84534], {
        ...
        42089: (e, t, r) => {
            ...
            var n = new(r(61991)).c(function(e) {
                return e.complete()
            })
        },
        46567: (e, t, r) => {
...
${function(e,t,r){let n=e.split(ev),{start:i,end:s,markerLines:o}=function(e,t){let r={...e.start},n={...r,...e.end},i=r.line??-1,s=r.column??0,o=n.line,a=n.column,u=Math.max(i-3,0),c=Math.min(t.length,o+3);-1===i&&(u=0),-1===o&&(c=t.length);let l=o-i,h={};if(l)for(let e=0;e<=l;e++){let r=e+i;if(s)if(0===e){let e=t[r-1].length;h[r]=[s,e-s+1]}else if(e===l)h[r]=[0,a];else{let n=t[r-e].length;h[r]=[0,n]}else h[r]=!0}else s===a?s?h[i]=[s,0]:h[i]=!0:h[i]=[s,a-s];return{start:u,end:c,markerLines:h}}({start:ew(t.start,n),end:t.end?ew(t.end,n):void 0},n),a=`
            ...
            let e1 = (e, t) => {
                ...
                i.withCredentials && u && (eG(), i.withCredentials = !1), o && a && u && !0 !== i.ignoreBrowserTokenWarning ? eX() : typeof i.useCdn > "u" && eB(), s && (e => {
                    ...
                    })(i.projectId), i.dataset && eP(i.dataset), "requestTagPrefix" in i && (i.requestTagPrefix = i.requestTagPrefix ? eM(i.requestTagPrefix).replace(/\.+$/, "") : void 0), i.apiVersion = `${i.apiVersion}`.replace(/^v/, ""), i.isDefaultApi = i.apiHost === eZ.apiHost, !0 === i.useCdn && i.withCredentials && eH(), i.useCdn = !1 !== i.useCdn && !i.withCredentials,
                    function(e) {
                        if ("1" === e || "X" === e) return;
                        let t = new Date(e);
            ...
            let e4 = ["channelError", "disconnect"];

            function e8(e, t) {
                return (0, U.v)(() => {
                    let t = e();
                    return t && (t instanceof k.c || (0, N.T)(t.lift) && (0, N.T)(t.subscribe)) ? t : L(t)
                }).pipe((0, V.Z)(e => {
                    var r, n;
                    return r = e, n = t, new k.c(e => {
                        ...
                        function s(t) {
                            if ("data" in t) {
                                ...
                                e.error(r ? new e5("Unable to parse EventSource error message", {
                                    cause: n
                                }) : new e2((n?.data).message, n));
                                return
                            }
                            r.readyState === r.CLOSED ? e.error(new e9("EventSource connection failed")) : i && e.next({
                                type: "reconnect"
                            })
                        }
                        ...
                        function a(t) {
                            ...
                            if ("disconnect" === t.type) return void e.error(new e3(`Server disconnected client: ${i.data?.reason||"unknown error"}`));
                            e.next({
                                type: t.type,
                                id: t.lastEventId,
                                ...i.data ? {
                        ...
                        let u = [...new Set([...e4, ...n])].filter(e => "error" !== e && "open" !== e && "reconnect" !== e);
...
${t}`)
            ...
            function th(e, t, n, i, s = {}, o = {}) {
                ...
                }((0, z.H)(r.e(22292).then(r.bind(r, 22292)).then(function(e) {
            ...
            function tm(e, t, r, n, i) {
                return ek("createVersion", r), eU("createVersion", r), eQ(), tq(e, t, {
            ...
            function tC(e, t, r, n) {
                return ek("replaceVersion", r), eU("replaceVersion", r), tq(e, t, {
            ...
            let tV = (0, U.v)(() => r.e(80296).then(r.t.bind(r, 80296, 19))).pipe((0, es.T)(({
                default: e
            }) => e), (0, W.t)(1));
            ...
            function tH() {
                return function(e) {
                    return e.pipe(Y((e, t) => {
                        var r;
                        return e instanceof e9 ? function() {
                            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                            return (0, Q.U)(1)((0, z.H)(e, (0, M.lI)(e)))
                        }(L({
                            type: "reconnect"
            ...
            function tJ(e, t, r = {}) {
                ...
                let d = c.events ? c.events : ["mutation"],
                    p = {};
                return s && (p.withCredentials = !0), (i || a) && (p.headers = {}, i && (p.headers.Authorization = `Bearer ${i}`), a && Object.assign(p.headers, a)), e8(() => (typeof EventSource > "u" || p.headers ? tV : L(EventSource)).pipe((0, es.T)(e => new e(h, p))), d).pipe(tH(), (0, eg.p)(e => d.includes(e.type)), (0, es.T)(e => ({
                    type: e.type,
                    ..."data" in e ? e.data : {}
                })))
            }
            ...
            class tG {
                ...
                events({
                    ...
                    let m = `${f.href}::${JSON.stringify(g)}`,
                        b = tY.get(m);
                    if (b) return b;
                    let v = e8(() => (typeof EventSource > "u" || g.headers ? tV : L(EventSource)).pipe((0, es.T)(e => new e(f.href, g))), ["message", "restart", "welcome", "reconnect", "goaway"]),
                        w = (n = f, i = {
                            method: "OPTIONS",
                            mode: "cors",
            ...
            let t2 = ((e, t = 21) => ((e, t, r) => {
                ...
                t5 = (e, t) => t ? (0, em.ct)(e, t) : (0, em.T4)(e);
            ...
            class rn {
                ...
                listen = tJ;
                constructor(e, t = eZ) {
                    this.config(t), this.#u = e, this.assets = new tM(this, this.#u), this.datasets = new tQ(this, this.#u), this.live = new tG(this), this.mediaLibrary = {
                        video: new t0(this, this.#u)
                    }, this.projects = new t3(this, this.#u), this.users = new rt(this, this.#u), this.agent = {
                        action: new tU(this, this.#u)
                    }, this.releases = new t7(this, this.#u)
                }
                clone() {
            ...
            class ri {
                ...
                constructor(e, t = eZ) {
                    ...
                    }, this.projects = new t6(this, this.#u), this.users = new rr(this, this.#u), this.agent = {
