try {
    let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
        t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "e3e7a4c6-6060-417b-b7f8-f429cde254af", e._sentryDebugIdIdentifier = "sentry-dbid-e3e7a4c6-6060-417b-b7f8-f429cde254af")
} catch (e) {}
"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [85974], {
        ...
        16943: (e, t, r) => {
            ...
            var n = new(r(83729)).c(function(e) {
                return e.complete()
            })
        },
        18043: (e, t, r) => {
                ...
                return (0, U.v)(() => {
                    ...
                    return r = e, n = t, new k.c(e => {
                        ...
                        function s(t) {
                            if ("data" in t) {
                                let [r, n] = e4(t);
                                e.error(r ? new e7("Unable to parse EventSource error message", {
                                    cause: n
                                }) : new e8((n?.data).message, n));
                                return
                            }
                        ...
                        function a(t) {
                            let [n, i] = e4(t);
                            if (n) return void e.error(new e7("Unable to parse EventSource message", {
                                cause: n
                            }));
                            ...
                            if ("disconnect" === t.type) return void e.error(new e9(`Server disconnected client: ${i.data?.reason||"unknown error"}`));
                            e.next({
                                type: t.type,
                                id: t.lastEventId,
                                ...i.data ? {
...
${t}`)
            ...
            function th(e, t, n, i, s = {}, o = {}) {
                ...
                }((0, z.H)(r.e(12310).then(r.bind(r, 12310)).then(function(e) {
            ...
            let tV = (0, U.v)(() => r.e(60270).then(r.t.bind(r, 60270, 19))).pipe((0, es.T)(({
                default: e
            }) => e), (0, W.t)(1));
            ...
            function tJ(e, t, r = {}) {
                ...
                let d = c.events ? c.events : ["mutation"],
                    p = {};
                return s && (p.withCredentials = !0), (i || a) && (p.headers = {}, i && (p.headers.Authorization = `Bearer ${i}`), a && Object.assign(p.headers, a)), e2(() => (typeof EventSource > "u" || p.headers ? tV : L(EventSource)).pipe((0, es.T)(e => new e(h, p))), d).pipe(tH(), (0, eg.p)(e => d.includes(e.type)), (0, es.T)(e => ({
                    type: e.type,
                    ..."data" in e ? e.data : {}
                })))
            }
            ...
            class tG {
                ...
                events({
                    ...
                    let m = `${f.href}::${JSON.stringify(g)}`,
                        b = tY.get(m);
                    if (b) return b;
                    let v = e2(() => (typeof EventSource > "u" || g.headers ? tV : L(EventSource)).pipe((0, es.T)(e => new e(f.href, g))), ["message", "restart", "welcome", "reconnect", "goaway"]),
                        w = (n = f, i = {
                            method: "OPTIONS",
                            mode: "cors",
            ...
            let t8 = ((e, t = 21) => ((e, t, r) => {
                ...
                t7 = (e, t) => t ? (0, em.ct)(e, t) : (0, em.T4)(e);
            ...
            class rn {
                ...
                constructor(e, t = eZ) {
                    ...
                    }, this.projects = new t9(this, this.#u), this.users = new rt(this, this.#u), this.agent = {
