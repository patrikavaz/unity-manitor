    ...
    [39853], {
        ...
        96599: (t, e, r) => {
            ...
            function s(t, {
                ...
                y.transform && (g.transform = y.transform, delete y.transform), (g.transform || y.transformOrigin) && (g.transformOrigin = y.transformOrigin ?? "50% 50%", delete y.transformOrigin), g.transform && (g.transformBox = m?.transformBox ?? "fill-box", delete y.transformBox), void 0 !== e && (y.x = e), void 0 !== r && (y.y = r), void 0 !== s && (y.scale = s), void 0 !== l && function(t, e, r = 1, n = 0, s = !0) {
                    t.pathLength = 1;
                    let l = s ? o : i;
            ...
            function V(t, {
                ...
                function S(r, S) {
                    ...
                    if (!P && B.B) {
                        ...
                        j = e.MeasureLayout, W.visualElement = function(t, e, r, n, o) {
                            let {
                                visualElement: u
                            ...
                            (0, a.useInsertionEffect)(() => {
                                m && g.current && m.update(r, d)
                            });
                            let v = r[R.n],
                                h = (0, a.useRef)(!!v && !window.MotionHandoffIsComplete?.(v) && window.MotionHasOptimisedAnimation?.(v));
                            return (0, _.E)(() => {
                                m && (g.current = !0, window.MotionIsMounted = !0, m.updateFeatures(), m.scheduleRenderMicrotask(), h.current && m.animationState && m.animationState.animateChanges())
                            }), (0, a.useEffect)(() => {
                                ...
                                }), h.current = !1), m.enteringChildren = void 0)
                            }), m
                        }(t, O, T, c, e.ProjectionNode)
                    }
                    return (0, n.jsxs)(l.Provider, {
                        value: W,
                        children: [j && W.visualElement ? (0, n.jsx)(j, {
                            ...
                            let s = ((0, C.Q)(t) ? function(t, e, r, n) {
                                    let o = (0, a.useMemo)(() => {
                                        let r = h();
                                        return (0, v.B)(r, e, (0, x.n)(n), t.transformTemplate, t.style), {
                                            ...r.attrs,
                                            style: {
                                                ...r.style
                                            }
                                    ...
                                    let r = {},
                                        n = function(t, e) {
                                            let r = t.style || {},
                                                n = {};
                                            return g(n, r, t), Object.assign(n, function({
                                                transformTemplate: t
                                            }, e) {
                                                return (0, a.useMemo)(() => {
                                                    let r = y();
                        ...
                        }(t, r, (E = W.visualElement, (0, a.useCallback)(t => {
                            t && O.onMount && O.onMount(t), E && (t ? E.mount(t) : E.unmount()), S && ("function" == typeof S ? S(t) : (0, X.X)(S) && (S.current = t))
                        }, [E])), O, P, e)]
                    })
                }
                S.displayName = `motion.${"string"==typeof t?t:`create(${t.displayName??t.name??""})`}`;
                let E = (0, a.forwardRef)(S);
                return E[A] = t, E
            }
        },
        97904: (t, e, r) => {
